...
<head>
    ...
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1000 M3, Кызылорда, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1000 M3 инфракрасные купить в Кызылорде по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
