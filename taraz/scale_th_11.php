...
<head>
    ...
    <title>Весы MK_ТН11 купить в Таразе | Товарные напольные весы</title>
    <!--/tags -->
    ...
    <meta name="description" content="Весы MK_ТН11 купить в Таразе. Огромный выбор электронных весов. Купить высококачественные товарные весы Масса-К в Таразе.">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            ...
                            <li><a href="scale_th_11.php">Тараз</a></li>
