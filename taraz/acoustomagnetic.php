...
<head>
    ...
    <title>Противокражные системы в Таразе | Противокражные ворота акустомагнитные купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="противокражные системы, противокражные ворота, акустомагнитные, для магазина, купить, Тараз, цена, продажа." />
    <meta name="description" content="Купить противокражные ворота для магазина в Таразе по низким ценам. У нас имеется широкий ассортимент высококачественных противокражных систем.">
    <!--//tags -->
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            ...
                            <li><a href="acoustomagnetic.php">Тараз</a></li>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Противокражные системы в Таразе</h1>
            <!--//w3_short-->
        </div>
    </div>
