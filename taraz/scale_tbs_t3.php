...
<head>
    ...
    <title>Весы ТВ-S_T3 купить в Таразе | Товарные напольные весы</title>
    <!--/tags -->
    ...
    <meta name="description" content="Весы ТВ-S_T3 купить в Таразе. Огромный выбор электронных весов. Купить высококачественные товарные напольные весы Масса-К в Таразе.">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            ...
                            <li><a href="scale_tbs_t3.php">Тараз</a></li>
