...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        ...
        <meta name="keywords" content=" купить системный блок, AMD, CORE, купить, Актобе, цена, продажа." />
        <meta name="description" content="Купить Системный блок  в Актобе по низким ценам. Осуществляем продажу игровых системных блоков.">
        <!--//tags -->
        ...
        <div class="header-bot" id="home">
            ...
            <div class="header-bot_inner_wthreeinfo_header_mid">
                <div class="fond">
                    ...
                    <div iddiv="box_2" class="mymagicoverbox"> <i class="fa fa-map-marker" aria-hidden="true"></i> Актобе <i class="fa fa-caret-down " aria-hidden="true"></i> </div>
