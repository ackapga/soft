...
<title>Принтер чеков купить в Алматы - Pos терминалы </title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="принтер чеков, кассовый аппарат, кассовое оборудование, кассовый терминал, алматы, астана, казахстан, купить, цена, продажа." />
<meta name="description" content="Компактный ринтер чеков для печати на 80 мм термаленте. Купить принтер чеков в Алматы по низким ценам.">
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.html"><span>Soft</span>Gr<img src="images/globe.png">up</a></h1>
			</div>
        <!-- header-bot -->
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" active menu__item menu__item--current"><a class="menu__link" href="products.html">Каталог товаров<span class="sr-only">(current)</span></a></li>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Товары <span>для автоматизации  </span></h3>
			<!--/w3_short-->
	...
	<div class="services-breadcrumb">
						<div class="agile_inner_breadcrumb">
						   ...
						   <ul class="w3_short">
								...
								<li><a href="products.html">Продукты</a><i>/</i></li>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Принтер чеков 5802</h3>
					<hr>
					<p class="code-products">Код товара: 3001</p>
					<p><span class="item_price">15 225  тг. </span></p>
					<div class="rating1">
						<span class="starRatingg">
					...
					<div class="description">
						<p><b>Принтер чеков</b> 5802, оборудованный специальным автоотрезчиком обладает высоким уровнем обслуживания. Принтер чеков имеет компактные размеры корпуса и предназначен для печати на 58мм термоленте.</p>
					...
					<button id ="fly" class="add_item " data-id="16" data-title="Принтер чеков 5802" data-price="15225" data-quantity="1" data-img="https://softgroup.kz/images/thermalprinter/1.jpg" data-count="100500"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
						...
						<div class="tab2">
							...
							<div class="single_page_agile_its_w3ls">
								<div class="bootstrap-tab-text-grids">
									...
									<img src="images/thermalprinter/1111.JPG">
										<div class="clearfix"> </div>
						             </div>
			...
			<div class="ll"><h3 class="wthree_text_info">Похожие <span>товары</span></h3></div>	
					 <div class="col-md-3 product-men single">
								<div class="men-pro-item">
									<a href="pos_3071.php">	<div class="men-thumb-item"><img src="images/p1.jpg" alt="" class="pro-image-front">
										<img src="images/p1.jpg" alt="" class="pro-image-back">
											 
											<span class="product-new-top">New</span></div></a>
									<div class="item-info-product ">
										<h4><a href="pos_3071.php">Сенсорный моноблок 3071</a></h4>
					   ...
					   <div class="col-md-3 product-men single">
								<div class="men-pro-item">
									<a href="thermalprinter_8030.php">	<div class="men-thumb-item"><img src="images/thermalprinter/2.jpg" alt="" class="pro-image-front">
										<img src="images/thermalprinter/2.jpg" alt="" class="pro-image-back">
		...
		<div class="coupons-grids text-center">
			<div class="w3layouts_mail_grid">
				...
				<div class="col-md-3 w3layouts_mail_grid_left">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>Огромный выбор товара</h3>
						<p>У нас есть все виды продукции для автоматизации любого вида торговли</p>
					</div>
				</div>
					<div class="col-md-3 w3layouts_mail_grid_left">
					<div class="w3layouts_mail_grid_left1 hvr-radial-out">
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><span>Soft</span>Gr<img src="images/globe.png">up</a></h2>
			<p>Softgroup - является ведущим поставщиком кассовых терминалов для автоматизации торговли, магазинов, супермаркетов и сферы обслуживания. У нас имеется огромный ассортимент торгового оборудования. Поставляемые pos терминалы высокого качества ведущих зарубежных производителей. </p>
		</div>
		...
		<p class="copy-right">&copy 2010-2018 SoftGroup</p>
	</div>
</div>
<!-- //footer -->
...
<script type="text/javascript">
    (function () {
        var options = {
            whatsapp: "+7 (701) 101-83-88", // WhatsApp number
            viber: "+7 (701) 101-83-88", // Viber number
            telegram: "+7 (701) 101-83-88", // Telegram bot username
            email: "+7 (701) 266-77-00", // Email
            sms: "+7 (701) 101-83-88", // Sms phone number
            call: "8 (727) 344-99-00", // Call phone number
            company_logo_url: "//softgroup.kz/images/logobutton.jpg", // URL of company logo (png, jpg, gif)
            greeting_message: "Здравствуйте, чем могу вам помочь?", // Text of greeting message
            call_to_action: "Если у вас есть вопросы, напишите нам.", // Call to action
            button_color: "#FF6550", // Color of button
            position: "right", // Position may be 'right' or 'left'
            order: "whatsapp,viber,telegram,sms,call,email", // Order of buttons
        };
