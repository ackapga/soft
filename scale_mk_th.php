...
<head>
    ...
    <title>Электронные весы MK_ТН21 купить по доступным ценам в Алматы от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы настольные, масса к, электронные, MK_ТН21, MK-ТН21, алматы, купить, цена, продажа." />
    <meta name="description" content="Электронные весы MK_ТН21 купить в Алматы. Огромный выбор электронных весов для торговли. Купить высококачественные весы Масса-К в Алматы.">
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">68 000 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="5007"
                            data-title="<a href='https://softgroup.kz/scale_mk_th.php'>Весы  торговые MK_TH21(RU)</a>"
                            data-price="68000" data-quantity="1" data-img="https://softgroup.kz/images/scale/8.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
