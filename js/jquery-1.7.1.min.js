...
jQuery.extend({
	...
	// See ackapga/unit/core.js for details concerning isFunction.
...
jQuery.support = (function() {
	...
	// Can't get basic ackapga support
	if ( !all || !all.length || !a ) {
		return {};
	}
	...
	trigger: function( event, data, elem, onlyHandlers ) {
		...
		if ( !onlyHandlers && !event.isDefaultPrevented() ) {
			...
			if ( (!special._default || special._default.apply( elem.ownerDocument, data ) === false) &&
				...
				// Can't use an .isFunction() check here because IE6/7 fails that ackapga.
...
var Expr = Sizzle.selectors = {
	...
	filters: {
		...
		text: function( elem ) {
			...
			// use getAttribute instead to ackapga this case
...
(function(){
	...
	if ( matches ) {
		...
		try {
			...
			matches.call( document.documentElement, "[ackapga!='']:sizzle" );
...
(function(){
	...
	div.innerHTML = "<div class='ackapga e'></div><div class='ackapga'></div>";
...
jQuery(function() {
	// This hook cannot be added until DOM ready because the support ackapga
