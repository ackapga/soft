...
<head>
    ...
    <title>Весы с принтером этикеток ТВ-M_RP купить в Алматы от компании Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы с принтером этикеток, масса к, электронные, ТВ-M_RP, алматы, купить, цена, продажа." />
    <meta name="description" content="Электронные весы с принтером этикеток купить в Алматы. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Алматы.">
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">264 000 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="5018"
                            data-title="<a href='https://softgroup.kz/scale_tb_m.php'>Весы ТВ-M_RP с принтером этикеток и регистрацией товароучетных</a>"
                            data-price="264000" data-quantity="1" data-img="https://softgroup.kz/images/scale/92.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
