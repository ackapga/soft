...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner6600G
   ...
   else $res=mysqli_query($db,"insert into scanner6600G (date, theme_id, login, message, rating)
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            ...
                            <li><a href="../taraz/scanner_1880.php">Тараз</a></li>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/6600G/ava1.jpg">
                                <div class="thumb-image" id="thumb-image"> <img src="../images/6600G/ava1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/6600G/2.jpg">
                                <div class="thumb-image"> <img src="../images/6600G/2.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/6600G/3.jpg">
                                <div class="thumb-image"> <img src="../images/6600G/3.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Беспроводной сканер штрих кода 6600 G</h1>
                <hr>
                <p class="code-products">Код товара: 5312</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">21 855 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Беспроводной сканер штрих кода</b> обладает высокой производительностью. Имеет три вида сканирования: Штрих-код, QR-код, DATA Matrix. Ударопрочный сканер имеет возможность работать "на расстоянии". Может использоваться непрерывно
                        в течение более 20 часов без зарядки. Главным преимуществом сканера является - автоматическое хранение на расстоянии.</p>
                    <br>
                    ...
                    <button id="fly" class="add_item" data-id="5312" data-title="<a href='https://softgroup.kz/scanner_6600G.php'>Сканер штрих кода 6600 G</a>" data-price="21855" data-quantity="1" data-img="https://softgroup.kz/images/6600G/1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        <div class="container">
                            ...
                            <p style="line-height:normal; text-align: center;">Данный модель стационарного сканера может может сканировать штрих-кодов с дисплеев разных устройств.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                	...
                	<div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px; margin-top:20px">
                        ...
                        <div class="container">
                            ...
                            <p style="line-height:normal; text-align:  center;">Данный модель беспроводного сканера имеет три вида сканирования: Штрих-код, QR-код, DATA Matrix.
                            </p>
                            <div class="clearfix"> </div>
...
$res=mysqli_query($db,"SELECT * FROM scanner6600G
