...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner1200
   ...
   else $res=mysqli_query($db,"insert into scanner1200 (date, theme_id, login, message, rating)
...
<title>Лазерный сканер для считывания штрих кодов купить в Усть-Каменогорске </title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Лазерный сканер для считывания штрих кодов, штрих кода, кассовый аппарат, кассовое оборудование, кассовый терминал, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
<!--//tags -->
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
	     ...
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/scanner/6.jpg">
							<div class="thumb-image"> <img src="../images/scanner/6.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/scanner/66.jpg">
							<div class="thumb-image"> <img src="../images/scanner/66.jpg"  class="img-responsive"> </div>
						</li>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Сканер штрих кода 1200</h3>
					<hr>
					<p class="code-products">Код товара: 2006</p>
					<p><span class="item_price">29 990  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p><b>Лазерный сканер штрих кода</b> 1200 с подставкой и режимом считывания в подставке считывает любые штрих-коды. Применяется в розничной торговли, легкой промышленности, документообороте, а также в сфере банковских и коммунальных услуг.</p>
					...
					<button id ="fly" class="add_item" data-id="9" data-title="<a href='scanner_1200.php'>Сканер штрих кода 1200</a>"  data-price="29990" data-quantity="1" data-img="../images/scanner/6.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
		      </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
...
$res=mysqli_query($db,"SELECT * FROM scanner1200
