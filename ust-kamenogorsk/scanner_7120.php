...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner7120
   ...
   else $res=mysqli_query($db,"insert into scanner7120 (date, theme_id, login, message, rating)
...
<title>Настольный, стационарный сканер штрих кода купить в Усть-Каменогорске</title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="настольный, стационарный, сканер штрих кода, штрих кодов, кассовый аппарат, кассовое оборудование, кассовый терминал, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
	     ...
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/scanner/5.jpg">
							<div class="thumb-image"> <img src="../images/scanner/5.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h1>Сканер штрих кода 7120</h1>
					<hr>
					<p class="code-products">Код товара: 2004</p>
					<p><span class="item_price">74 890  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p><b>Настольный стационарный лазерный сканер штрих-кода</b> максимально удобен и эффективен в работе. Сканер предназначен для предприятий розничной торговли, желающих иметь недорогое и эстетичное сканирующее устройство.</p>
						<br>
					...
					<button id ="fly" class="add_item" data-id="12" data-title="<a href='scanner_7120.php'>Сканер штрих кода 7120</a>"  data-price="74890" data-quantity="1" data-img="../images/scanner/5.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
		      </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
...
$res=mysqli_query($db,"SELECT * FROM scanner7120
