...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors1250
   ...
   else $res=mysqli_query($db,"insert into dors1250 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детекторы банкнот инфракрасные Dors 1250 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1250, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1250 инфракрасные купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_1250.php">Актау</a></li>
                            <li><a href="../aktobe/dors_1250.php">Актобе</a></li>
                            <li><a href="../dors_1250.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_1250.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_1250.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_1250.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_1250.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_1250.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_1250.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_1250.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_1250.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_1250.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_1250.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_1250.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_1250.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_1250.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_1250.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_1250.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_1250.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_1250.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детекторы банкнот инфракрасные</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Инфракрасные детекторы банкнот DORS 1250</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/8.jpg">
                                <div class="thumb-image"> <img src="../images/detector/8.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/88.jpg">
                                <div class="thumb-image"> <img src="../images/detector/88.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/888.jpg">
                                <div class="thumb-image"> <img src="../images/detector/888.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Инфракрасные детекторы банкнот DORS 1250</h2>
                <hr>
                <p class="code-products">Код товара: 9008</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">100 968 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <p>• экспертный уровень проверки банкнот при минимальных габаритах прибора;
                        <br>• большой (12, 7 см.) высококонтрастный ЖК дисплей;
                        <br>• сенсорное управление;
                        <br>• возможность одновременного контроля по ИК и УФ;
                        <br>• восемь видов контроля защитных признаков банкнот и ценных бумаг;
                        <br>• мощное УФ, верхнее и нижнее белого цвета излучение;
                        <br>• комплексный контроль банкнот и документов до формата А4;
                        <br>• возможность регулировки функции автовыключения дисплея.
                    </p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_1250.php'>Инфракрасные детекторы банкнот DORS 1250</a>" data-price="100968" data-quantity="1" data-img="https://softgroup.kz/images/detector/8.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
...
$res=mysqli_query($db,"SELECT * FROM dors1250
