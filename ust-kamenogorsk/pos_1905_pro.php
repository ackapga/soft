        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Сенсорный монитор 1905, белый</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/1905/logo.png">
                                    <div class="thumb-image"> <img src="../images/1905/logo.png" id="target" class="img-responsive"> </div>
                                    <li data-thumb="../images/1905/2.png">
                                        <div class="thumb-image"> <img src="../images/1905/2.png" class="img-responsive"> </div>
                                        <li data-thumb="../images/1905/5.png">
                                            <div class="thumb-image"> <img src="../images/1905/5.png" class="img-responsive"> </div>
                                        </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Сенсорный монитор 1905 PRO</h1>
                    <hr>
                    <p class="code-products">Код товара: 5149</p>
                    <p><span class="item-price-indicator">Цена: </span> <span class="item_price">162 540 тг.</span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p><b>Сенсорный монитор</b> 1905 PRO белый имеет новый компактный дизайн, сенсорный монитор с высокой чувствительностью. Идеально подойдет для автоматизации любой торговли: супермаркетов, магазинов, кафе или же аптек.</p>
                        <br>
                        <h3><b>В состав cенсорного монитор входит:</b></h3>
                        <p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800;</p>
                        <p><i class="fa fa-check"></i> Сенсорный экран кассира с 15-дюймовым диагональю экрана;</p>
                        <p><i class="fa fa-check"></i> Дисплей клиента: 1 строка, 8 символов;</p>
                        <img src="../images/monitor/icon2.png">
                        <div><button id="fly" class="add_item" data-id="5149" data-title="<a href='https://softgroup.kz/pos_1905.php'>Сенсорный монитор 1905 PRO</a>" data-price="162540" data-quantity="1" data-img="https://softgroup.kz/images/1905/logo.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
            ...
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grids">
                    <div class="bootstrap-tab-text-grid" style="padding-bottom:20px; background-color: #e5f6f8;">
                        <div class="container">
                            ...
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/1905/12.png" style="text-align:center; "></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="padding-bottom:20px; background-color: #e5f6f8;">
                        <div class="container">
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/1905/9.png" style="text-align:center; margin-top:20px"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="padding-bottom:20px; background-color: #e5f6f8;">
                        <div class="container">
                            ...
                            <p style="line-height:normal">Все интерфейсные разъёмы расположены в нижней части устройства: разъём питания, 2 СОМ порта для передачи данных, VGA порт для подключения мониторов, PS/2 порты для подключения клавиатуры и мыши, LPT порт для подключения различных
                                периферийных устройств, четыре разъёма USB порта (2 из них последняя версия стандарта USB 3.0), RJ порт для подключения локальной сети и два разъёма для передачи аудиосигнала.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
