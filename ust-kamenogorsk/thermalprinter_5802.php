    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/thermalprinter/1.jpg">
                                <div class="thumb-image" id="thumb-image"> <img src="../images/thermalprinter/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/11.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/11.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/111.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Принтер чеков 5802</h1>
                <hr>
                <p class="code-products">Код товара: 3001</p>
                ...
                <div class="description">
                    <p><b>Принтер чеков 5802</b> с термопечатью обладает высоким уровнем обслуживания в любых сферах. Принтер чеков имеет компактные размеры корпуса и предназначен для печати на 58 мм термоленте.
                    </p>
                    ...
                    <button id="fly" class="add_item " data-id="16" data-title="<a href='https://softgroup.kz/thermalprinter_5802.php'>Принтер чеков 5802</a>" data-price="15120" data-quantity="1" data-img="https://softgroup.kz/images/thermalprinter/1.jpg" data-count="100500"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/thermalprinter/58.png"></div>
