...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner6100CG
   ...
   else $res=mysqli_query($db,"insert into scanner6100CG (date, theme_id, login, message, rating)
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/6100CG/ava1.jpg">
                                <div class="thumb-image" id="thumb-image"> <img src="../images/6100CG/ava1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/6100CG/2s.jpg ">
                                <div class="thumb-image "> <img src="../images/6100CG/3.jpg " class="img-responsive "> </div>
                            </li>
                            <li data-thumb="../images/6100CG/3s.jpg ">
                                <div class="thumb-image "> <img src="../images/6100CG/2.jpg" class="img-responsive "> </div>
                            </li>
                        </ul>
                        <div class="clearfix "></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem ">
                <h1>Беспроводной сканер штрих кода 6100 CG</h1>
                <hr>
                <p class="code-products ">Код товара: 5311</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price ">20 304 тг. </span></p>
                <div class="rating1 ">
                ...
                <div class="description ">
                    ...
                    <button id="fly " class="add_item " data-id="5311 " data-title="<a href='https://softgroup.kz/scanner_6100CG.php'>Сканер штрих кода 6100 CG</a>" data-price="20304" data-quantity="1" data-img="https://softgroup.kz/images/template.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scanner/shtrih3.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0">Чтение штрих-кодов</p>
                        <p style="line-height:normal">Сканер уверенно распознает и считывает штрих код. Модель имеет более широкий угол сканирования и нулевые частоты ошибок.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-top:20px; margin-top:20px">
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/6100CG/codes.png" style="width: 300px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Виды сканирования:

                        </p>
                        <p style="line-height:normal; text-align: center;">Данный модель беспроводного сканера имеет три вида сканирования: Штрих-код, QR-код, DATA Matrix. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/6100CG/3o.png" style="width: 40%;"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Сканирование штрих кода с экрана</p>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/6100CG/1o.png" style="width: 40%;"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/6100CG/2o.png" style="width: 40%;"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>ручное считывание,<br> постоянное считывание, <br> индукционное считывание, <br> мигающее считывание </td>
                    </tr>
                    <tr>
                        <td>Расстояние передачи прямой линии:</td>
                        <td>50-100 метров</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> Угол 30 ° Угол возвышения 60 ° Угол отклонения 60 °</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scanner6100CG
