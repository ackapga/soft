...
<head>
    ...
    <title>Весы с принтером этикеток ТВ-M_RP купить в Усть-Каменогорске от компании Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы с принтером этикеток, масса к, электронные, ТВ-M_RP, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Электронные весы с принтером этикеток купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы ТВ-M_RP с принтером этикеток</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/92.jpg">
                                <div class="thumb-image"> <img src="../images/scale/92.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/922.jpg">
                                <div class="thumb-image"> <img src="../images/scale/922.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/9222.jpg">
                                <div class="thumb-image"> <img src="../images/scale/9222.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы ТВ-M_RP с принтером этикеток</h2>
                <hr>
                <p class="code-products">Код товара: 5018</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">189 967 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_tb_m.php'>Весы ТВ-M_RP с принтером этикеток и регистрацией товароучетных</a>" data-price="189967" data-quantity="1" data-img="https://softgroup.kz/images/scale/92.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg6.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Диапазон взвешивания</p>
                        <p style="line-height:normal">Главным преимуществом оборудования является высокая точность измерений. Максимальный предел взвешивания - 600 кг. Устройства широко применяются в быту, в сфере продаж (подходят для магазинов любого формата), на предприятиях общественного питания, на складах, в фармацевтических компаниях и т. д. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/scale/p6.png" style="text-align:center; margin-top:20px"></div>
