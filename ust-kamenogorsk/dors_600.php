...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors600
   ...
   else $res=mysqli_query($db,"insert into dors600 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот светодиодный Dors 600 М2 купить по низким ценам в Усть-Каменогорске </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, светодиодные, dors, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот Dors 600 М2 светодиодные купить в Усть-Каменогорске. Огромный выбор счетчиков для банкнот. Купить счетчики банкнот в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_600.php">Актау</a></li>
                            <li><a href="../aktobe/dors_600.php">Актобе</a></li>
                            <li><a href="../dors_600.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_600.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_600.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_600.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_600.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_600.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_600.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_600.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_600.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_600.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_600.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_600.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_600.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_600.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_600.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_600.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_600.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_600.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Счетчик банкнот светодиодный Dors</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики банкнот светодиодные DORS 600 М2</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/3.png">
                                <div class="thumb-image"> <img src="../images/schetchiki/3.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/33.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/33.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/333.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/333.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот светодиодные DORS 600 М2</h2>
                <hr>
                <p class="code-products">Код товара: 8003</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">106 907 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Счетчик банкнот DORS 600М2 обладает повышенной надежностью и большим ресурсом работы и рекомендуется для пересчета однородной по номиналу денежной массы в местах с большим оборотом наличных средств.
                        <br>• Высокая надежность и стабильность работы
                        <br>• Пересчет банкнот с одновременной проверкой геометрических размеров
                        <br>• Бережный пересчет банкнот различной степени изношенности
                        <br>• Пыле- и влагоустойчивая панель управления
                        <br>• Остановка пересчета и вывод на дисплей кода ошибки при обнаружении цепочки банкнот, сдвоенных, слипшихся, замятых, банкнот с большим отсутствующим фрагменто
                        <br>• Приемный карман и часть элементов конструкции выполнены из ударопрочного пластика с добавлением карбонового волокна
                        <br>• Удобная ручка для переноса счетчика</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_600.php'>Счетчик банкнот DORS 600М2</a>" data-price="106907" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/3.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Дисплей: </td>
                        <td>светодиодный, красного свечения</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> мин. 100х50 мм; макс. 165х85 мм; толщина – 0,05 - 0,2 мм</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>роликовый, фрикционного типа, с верхней загрузкой банкнот</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Детекция: </td>
                        <td>на сдвоенность</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры, (ШхГхВ): </td>
                        <td>261x238x232 мм</td>
                    </tr>
                </tbody>
            </table>
            <div class="models">
...
$res=mysqli_query($db,"SELECT * FROM dors600
