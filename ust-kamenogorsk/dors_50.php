...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors50
   ...
   else $res=mysqli_query($db,"insert into dors50 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детекторы банкнот ультрафиолетовые Dors 50 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, ультрафиолетовые, dors, 50, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 50 ультрафиолетовые купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_50.php">Актау</a></li>
                            <li><a href="../aktobe/dors_50.php">Актобе</a></li>
                            <li><a href="../dors_50.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_50.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_50.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_50.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_50.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_50.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_50.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_50.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_50.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_50.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_50.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_50.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_50.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_50.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_50.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_50.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_50.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_50.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детекторы банкнот ультрафиолетовые</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Ультрафиолетовые детекторы банкнот DORS 50</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/1.jpg">
                                <div class="thumb-image"> <img src="../images/detector/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/11.jpg">
                                <div class="thumb-image"> <img src="../images/detector/11.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/111.jpg">
                                <div class="thumb-image"> <img src="../images/detector/111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Ультрафиолетовые детекторы банкнот DORS 50</h2>
                <hr>
                <p class="code-products">Код товара: 9001</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">5 345 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Ультрафиолетовые просмотровые детекторы DORS 50 предназначены для визуального определения подлинности банкнот различных валют, ценных бумаг, документов, акцизных и специальных марок.
                        Детекторы DORS 50 являются массовыми приборами, в которых удачно соединились последние достижения дизайна и высочайшее качество.</p>
                    <p>• существенно увеличивается срок службы ламп благодаря их плавному пуску;
                        <br>• включение ламп происходит моментально;
                        <br>• лампы светят на полную паспортную мощность;
                        <br>• температурная защита электронного балласта предохраняет приборы от перегрева при работе в жарких условиях.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_50.php'>Ультрафиолетовые детекторы банкнот DORS 50</a>" data-price="5345" data-quantity="1" data-img="https://softgroup.kz/images/detector/1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
...
$res=mysqli_query($db,"SELECT * FROM dors50
