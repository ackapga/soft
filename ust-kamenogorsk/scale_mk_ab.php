...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalemkab
   ...
   else $res=mysqli_query($db,"insert into scalemkab (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы влагозащищенные MK_AB11 купить по доступным ценам в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы настольные, масса к, электронные, MK_AB, MK-AB, влагозащищенные, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Весы влагозащищенные Масса-К MK_AB11 купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_mk_ab.php">Актау</a></li>
                            <li><a href="../aktobe/scale_mk_ab.php">Актобе</a></li>
                            <li><a href="../scale_mk_ab.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_mk_ab.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_mk_ab.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_mk_ab.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_mk_ab.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_mk_ab.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_mk_ab.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_mk_ab.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_mk_ab.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_mk_ab.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_mk_ab.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_mk_ab.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_mk_ab.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_mk_ab.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_mk_ab.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_mk_ab.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_mk_ab.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_mk_ab.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы влагозащищенные MK_AB11 </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/4.jpg">
                                <div class="thumb-image"> <img src="../images/scale/4.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/44.jpg">
                                <div class="thumb-image"> <img src="../images/scale/44.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы влагозащищенные MK_AB11 </h2>
                <hr>
                <p class="code-products">Код товара: 5003</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">61 660 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_mk_ab.php'>Весы влагозащищенные MK_AB11</a>" data-price="61660" data-quantity="1" data-img="https://softgroup.kz/images/scale/4.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg11.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel7.png"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> сетевой адаптер - 1шт,- защитный чехол со стяжкой;</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scalemkab
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                ...
                <div class="models">
                    <h3>Причины купить влагозащищенные весы у нас</h3>
                    <hr>
                </div>
