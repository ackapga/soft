...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into thermalprinter8250
   ...
   else $res=mysqli_query($db,"insert into thermalprinter8250 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Принтер печатающий чеки купить в Усть-Каменогорске - Доступные цены на принтеры чеков </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="принтер печатающий чеки, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Купить принтер печатающий чеки в Усть-Каменогорске по доступным ценам. Осуществляем продажу принтера чеков для магазина в широком ассортименте от Softgroup">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/thermalprinter_8250.php">Актау</a></li>
                            <li><a href="../aktobe/thermalprinter_8250.php">Актобе</a></li>
                            <li><a href="../thermalprinter_8250.php">Алматы</a></li>
                            <li><a href="../atyrau/thermalprinter_8250.php">Атырау</a></li>
                            <li><a href="../janaozen/thermalprinter_8250.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/thermalprinter_8250.php">Жезказган</a></li>
                            <li><a href="../karaganda/thermalprinter_8250.php">Караганда</a></li>
                            <li><a href="../kokshetau/thermalprinter_8250.php">Кокшетау</a></li>
                            <li><a href="../kostanai/thermalprinter_8250.php">Костанай</a></li>
                            <li><a href="../kyzylorda/thermalprinter_8250.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/thermalprinter_8250.php">Астана</a></li>
                            <li><a href="../pavlodar/thermalprinter_8250.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/thermalprinter_8250.php">Петропавловск</a></li>
                            <li><a href="../semei/thermalprinter_8250.php">Семей</a></li>
                            <li><a href="../taldykorgan/thermalprinter_8250.php">Талдыкорган</a></li>
                            <li><a href="../taraz/thermalprinter_8250.php">Тараз</a></li>
                            <li><a href="../turkestan/thermalprinter_8250.php">Туркестан</a></li>
                            <li><a href="../uralsk/thermalprinter_8250.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/thermalprinter_8250.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/thermalprinter_8250.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/thermalprinter/5.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/5.jpg" id="target" class="img-responsive"> </div>
                            </li>

                            <li data-thumb="../images/thermalprinter/555.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/555.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/55.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/55.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Принтер печатающий чеки 8250</h1>
                <hr>
                <p class="code-products">Код товара: 3007</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">62 700 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Принтер печатающий чеки 8250</b> с привлекательным внешним видом и стабильной производительностью, станет вашим лучшим выбором. Принтер чека с автоотрезчиком применятся в розничной торговли или кафе.</p>
                    ...
                    <button id="fly" class="add_item" data-id="19" data-title="<a href='https://softgroup.kz/thermalprinter_8250.php'>Принтер чеков 8250</a>" data-price="62700" data-quantity="1" data-img="https://softgroup.kz/images/thermalprinter/5.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
        </div>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/thermalprinter/80_3.png"></div>
                    <div class="wthree_text_info">
                        <h2>Высокая скорость печати принтера чеков</h2>
                    </div>
                    <p style="line-height:normal">Принтер чеков с автоотрезчиком печатает чеки на термобумаге шириной до 80 миллиметров со скоростью 230 миллиметров в секунду. Данное устройство отличается эргономичным дизайном и простотой в эксплуатации.</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM thermalprinter8250
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить принтера печатающего чеков у нас:</h3>
                    <hr>
                </div>
