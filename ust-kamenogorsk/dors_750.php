...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors750
   ...
   else $res=mysqli_query($db,"insert into dors750 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот жидкокристалический Dors 750 купить по низким ценам в Усть-Каменогорске</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, жидкокристалические, dors, 750, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот Dors 750 жидкокристалические с автоматическим распознаванием валюты купить в Усть-Каменогорске. Огромный выбор счетчиков для банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_750.php">Актау</a></li>
                            <li><a href="../aktobe/dors_750.php">Актобе</a></li>
                            <li><a href="../dors_750.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_750.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_750.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_750.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_750.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_750.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_750.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_750.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_750.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_750.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_750.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_750.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_750.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_750.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_750.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_750.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_750.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_750.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Счетчик банкнот жидкокристалический Dors</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики монохромные жидкокристаллические DORS 750</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/4.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/4.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/44.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/44.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/444.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/444.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики монохромные жидкокристаллические DORS 750</h2>
                <hr>
                <p class="code-products">Код товара: 8004</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">351 107 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Dors 750 — это счетчик банкнот, оснащенный системой автоматического определения типа валюты, номинала и надежным блоком детекции подлинности. Высокая скорость счета, безотказность и емкие карманы обеспечивают Dors 750 производительностью.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_750.php'>Счетчики монохромные жидкокристаллические DORS 750</a>" data-price="351107" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/4.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Дисплей: </td>
                        <td>монохромный жидкокристаллический</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> 117-180 мм (ширина), 58-90 мм (длина), 0,05-0,2 мм (толщина)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Детекция: </td>
                        <td> ИК и видимый образ, оптическая плотность, УФ, размер</td>
                    </tr>
                    <tr>

                        <td>Опции:</td>
                        <td> Внешний дисплей (DORS 85 или DORS 90), система видеонаблюдения ЧЕКТВ БАНК с автоматической или ручной выгрузкой данных</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры, (ШхГхВ): </td>
                        <td>270х290х240 мм</td>
                    </tr>
                </tbody>
            </table>
            <div class="models">
...
$res=mysqli_query($db,"SELECT * FROM dors750
