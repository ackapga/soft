...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into postd30
   ...
   else $res=mysqli_query($db,"insert into postd30 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Pos системы в Усть-Каменогорске | Цены на POS системы для автоматизации - Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="pos система, для автоматизации, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Предлагаем вам купить POS систему со сканером и принтером чеков в Усть-Каменогорске по низким ценам. POS системы в широком ассортименте от Softgroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/pos_td_35.php">Актау</a></li>
                            <li><a href="../aktobe/pos_td_35.php">Актобе</a></li>
                            <li><a href="../pos_td_35.php">Алматы</a></li>
                            <li><a href="../atyrau/pos_td_35.php">Атырау</a></li>
                            <li><a href="../janaozen/pos_td_35.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/pos_td_35.php">Жезказган</a></li>
                            <li><a href="../karaganda/pos_td_35.php">Караганда</a></li>
                            <li><a href="../kokshetau/pos_td_35.php">Кокшетау</a></li>
                            <li><a href="../kostanai/pos_td_35.php">Костанай</a></li>
                            <li><a href="../kyzylorda/pos_td_35.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_td_35.php">Астана</a></li>
                            <li><a href="../pavlodar/pos_td_35.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/pos_td_35.php">Петропавловск</a></li>
                            <li><a href="../semei/pos_td_35.php">Семей</a></li>
                            <li><a href="../taldykorgan/pos_td_35.php">Талдыкорган</a></li>
                            <li><a href="../taraz/pos_td_35.php">Тараз</a></li>
                            <li><a href="../turkestan/pos_td_35.php">Туркестан</a></li>
                            <li><a href="../uralsk/pos_td_35.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/pos_td_35.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/pos_td_35.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/20.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/20.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/202.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/202.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/2022.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/2022.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Pos-система TD-35</h1>
                <hr>
                <p class="code-products">Код товара: 1014</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">140 300 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Pos-система TD-35 представляет собой универсальное решение, в состав которого входит принтер чека 58 мм, моноблок 12-дюймовым экраном, pos клавиатура, дисплей покупателя. Pos-система имеет все необходимые настройки для подключения любой POS-периферии.</p>
                    <br>
                    <h3><b>POS система состоит из:</b></h3>
                    <p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800;</p>
                    <p><i class="fa fa-check"></i> Монитор кассира с 12-дюймовым диагональю экрана;</p>
                    <p><i class="fa fa-check"></i> Принтер чека 58 мм;</p>
                    <p><i class="fa fa-check"></i> Клавиатура KB-105F;</p>
                    <p><i class="fa fa-check"></i> Дисплей покупателя.</p>
                    <button id="fly" class="add_item" data-id="5" data-title="<a href='https://softgroup.kz/pos_td_35.php'>Pos-система TD-35</a>" data-price="140300" data-quantity="1" data-img="https://softgroup.kz/images/monitor/20.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/vfd5.jpg" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/keyboard1.png" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/printer2.jpg"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Интерфейс:</td>
                        <td>6 USB <br> 1 PS/2 клавиатура <br> 1 PS/2 мышь <br> 1 LAN port<br> 1 LPT-порт<br> 1 VGA port <br> 2 COM port<br>1 RJ11 <br> 1 Audio Input / 1 Output</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Экранная панель на спине</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
$res=mysqli_query($db,"SELECT * FROM postd30
