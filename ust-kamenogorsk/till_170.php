...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into till170
   ...
   else $res=mysqli_query($db,"insert into till170 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Денежный ящик для кассы купить в Усть-Каменогорске с автоматическим открыванием для денег</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="денежный ящик, для денег, для монет, купюр, с автоматическим открыванием, с замком, кассовый аппарат, кассовое оборудование, кассовый терминал, для кассы, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Денежный ящик со съемными отделениями для купюр и для монет в Усть-Каменогорске. Денежный ящик для кассы для надежного хранения денег, чеков. ">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/till_405a.php">Актау</a></li>
                            <li><a href="../aktobe/till_405a.php">Актобе</a></li>
                            <li><a href="../till_405a.php">Алматы</a></li>
                            <li><a href="../atyrau/till_405a.php">Атырау</a></li>
                            <li><a href="../janaozen/till_405a.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/till_405a.php">Жезказган</a></li>
                            <li><a href="../karaganda/till_405a.php">Караганда</a></li>
                            <li><a href="../kokshetau/till_405a.php">Кокшетау</a></li>
                            <li><a href="../kostanai/till_405a.php">Костанай</a></li>
                            <li><a href="../kyzylorda/till_405a.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/till_405a.php">Астана</a></li>
                            <li><a href="../pavlodar/till_405a.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/till_405a.php">Петропавловск</a></li>
                            <li><a href="../semei/till_405a.php">Семей</a></li>
                            <li><a href="../taldykorgan/till_405a.php">Талдыкорган</a></li>
                            <li><a href="../taraz/till_405a.php">Тараз</a></li>
                            <li><a href="../turkestan/till_405a.php">Туркестан</a></li>
                            <li><a href="../uralsk/till_405a.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/till_405a.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/till_405a.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li><a href="till.html">Денежные ящики</a><i>/</i></li>
                        <li style="color: #ffffff65;">Денежный ящик 170</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/till/with.jpg">
                                <div class="thumb-image"> <img src="../images/till/with.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/till/170_2.jpg">
                                <div class="thumb-image"> <img src="../images/till/170_2.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/till/170_3.jpg">
                                <div class="thumb-image"> <img src="../images/till/170_3.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Денежный ящик 170</h1>
                <hr>
                <p class="code-products">Код товара: 5305</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">29 925 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Денежный ящик</b> со съемными 6 отделениями для купюр с прижимными лапками, 8 для монет предназначен для надежного хранения денег, чеков и остальной документации. Ящик идет с уникальным замком и с функцией блокировки.</p>
                    ...
                    <button id="fly" class="add_item" data-id="5305" data-title="<a href='https://softgroup.kz/till_405a.php'>Денежный ящик 170</a>" data-price="29925" data-quantity="1" data-img="https://softgroup.kz/images/till/2.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center; margin-top:20px">
                            <img src="../images/till/auto.png"></div>
                        <div class="wthree_text_info">
                            <h2>Автоматическое открытие денежного ящика через Порт-RJ11</h2>
                        </div>
                        <p style="line-height:normal">В денежном ящике реализована функция автоматического открывания денежного ящика во время печати чека. Для этого денежный ящик подключается к терминалу кассира. Автоматическое открывание ускоряет процесс расчета кассира с людьми.</p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/till/with2.jpg"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Отделения для монет и купюр</p>
                        <p style="line-height:normal">Кассета для финансовых средств съемная. Она имеет 5 отделения с прижимными лапками для размещения купюр различного номинала и 8 для хранения монет. Отсеки можно регулировать.</p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center; margin-top:20px">
                            <img src="../images/till/locktill3.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">3-х позиционный режим закрывания</p>
                        <p style="line-height:normal">Индивидуальный замок с функцией блокировки имеет 3-х позиционный режим закрывания: блокировка, ручное и электронное открытие. </p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center; margin-top:20px">
                            <img src="../images/till/box-lock-wm.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Встраиваемый денежный ящик</p>
                        <p style="line-height:normal; text-align: center;">Данный денежный ящик интегрируется во все популярные модели кассовых боксов и кассовых столов. Во избежание трудностей для кассира при открытии кассового ящика была создана специально разработанная конструкция кассового ящика. Денежный ящик находится прямо перед кассой.</p>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            <td>Замок:</td>
                            <td>Электронный+механический</td>
                        </tr>
                        <tr>

                            <td>Особенности:</td>
                            <td>Ручка для переноса внутреннего ящика, щель для документов, 4 - отверстия снизу денежного ящика для крепления к столу
                            </td>
                        </tr>
                        <tr>

                            <td>Лотков под купюры:</td>
                            <td>6</td>
                        </tr>
                        <tr>

                            <td>Лотков под монеты:</td>
                            <td>8</td>
                        </tr>
...
$res=mysqli_query($db,"SELECT * FROM till170
        ...
        <div class="coupons">
            <div class="coupons-grids text-center">
                <div class="w3layouts_mail_grid">
                    <div class="models">
                        <h3>Причины купить денежные ящики у нас:</h3>
                        <hr>
                    </div>
