...
$secret = "6LdFXoQaAAAAAD7SpCPVmUPYkFLXsrfE-k427Kix";

$response = null;

$reCaptcha = new ReCaptcha($secret);
if (!empty($_POST)) {   //отправлен комментарий
...
<head>
    ...
    <title>Микрокиоск Zebra MK500 купить в Усть-Каменогорске | Сенсорные прайс чекеры цена</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="микрокиоск, zebra, mk500, прайс чекер, для проверки цен, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Купить Микрокиоск Zebra MK500 в Усть-Каменогорске для проверки цен по доступным ценам. Широкий выбор сенсорных прайс чекеров Zebra от компании Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_mk_500.php">Астана</a></li>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">197 750 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <div> <button id="fly" class="add_item" data-id="8" data-title="<a href='https://softgroup.kz/pos_t8.php'>Микрокиоск Zebra MK500</a>" data-price="197750" data-quantity="1" data-img="https://softgroup.kz/images/monitor/23.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
...
echo '<div class="rating1" style="margin-left:0px; margin-top:10px;">Ваша оценка:';
					echo '	<span class="starRating">';
						...
						echo '</span>';
					echo '</div>';
echo '<div class="g-recaptcha" data-sitekey="6LdFXoQaAAAAADZqfZm4F-9oypEvCc7qo8iLVMwt"></div>';
