...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into till410b
   ...
   else $res=mysqli_query($db,"insert into till410b (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Кассовый ящик для хранения денег купить в Усть-Каменогорске для магазинов, супермаркетов</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="кассовый ящик, для денег, для монет, купюр, с автоматическим открыванием, с замком, кассовый аппарат, кассовое оборудование, кассовый терминал, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Кассовый ящик со съемными отделениями для купюр и для монет в Усть-Каменогорске. Кассовый ящик для кассы с автоматическим открыванием для чеков, денег">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/till_410b.php">Актау</a></li>
                            <li><a href="../aktobe/till_410b.php">Актобе</a></li>
                            <li><a href="../till_410b.php">Алматы</a></li>
                            <li><a href="../atyrau/till_410b.php">Атырау</a></li>
                            <li><a href="../janaozen/till_410b.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/till_410b.php">Жезказган</a></li>
                            <li><a href="../karaganda/till_410b.php">Караганда</a></li>
                            <li><a href="../kokshetau/till_410b.php">Кокшетау</a></li>
                            <li><a href="../kostanai/till_410b.php">Костанай</a></li>
                            <li><a href="../kyzylorda/till_410b.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/till_410b.php">Астана</a></li>
                            <li><a href="../pavlodar/till_410b.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/till_410b.php">Петропавловск</a></li>
                            <li><a href="../semei/till_410b.php">Семей</a></li>
                            <li><a href="../taldykorgan/till_410b.php">Талдыкорган</a></li>
                            <li><a href="../taraz/till_410b.php">Тараз</a></li>
                            <li><a href="../turkestan/till_410b.php">Туркестан</a></li>
                            <li><a href="../uralsk/till_410b.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/till_410b.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/till_410b.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/till/1.jpg">
                                <div class="thumb-image"> <img src="../images/till/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/till/11.jpg">
                                <div class="thumb-image"> <img src="../images/till/11.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/till/111.jpg">
                                <div class="thumb-image"> <img src="../images/till/111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Кассовый ящик 410В</h1>
                <hr>
                <p class="code-products">Код товара: 6001</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">16 748 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Кассовый ящик</b> со съемными 7 отделениями для купюр с прижимными лапками и 4 отделениями для монет предназначен для надежного хранения денег, чеков и остальной документации. Ящик комплектуется уникальным замком с функцией блокировки. </p>
                    ...
                    <button id="fly" class="add_item" data-id="23" data-title="<a href='https://softgroup.kz/till_410b.php'>Кассовый ящик 410В</a>" data-price="16748" data-quantity="1" data-img="https://softgroup.kz/images/till/1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    <div class="container">
                        ...
                        <div class="wthree_text_info">
                            <h2>Автоматическое открытие кассового ящика через Порт-RJ11</h2>
                        </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/till/till_b.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Отделения для монет и купюр</p>
                        <p style="line-height:normal">Кассета для финансовых средств съемная. Она имеет 7 отделения с прижимными лапками для размещения купюр различного номинала и 4 для хранения монет. Отсеки можно регулировать.</p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center; margin-top:20px">
                            <img src="../images/till/position.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0">3-х позиционный режим закрывания</p>
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Особенности замка:</td>
                            <td>3 позиции блокировки замка</td>
                        </tr>
                        <tr>
...
$res=mysqli_query($db,"SELECT * FROM till410b
    WHERE theme_id='".$theme_id."' ORDER BY id");
$number=mysqli_num_rows($res);

if ($number>0) {
 echo '<div style="padding-top:10px;">';
 echo '<div style="float:none;font-size:26px; font-weight:bold;padding: 10px 0px 10px; color: #0ba98b; ">Отзывы</div>';
        ...
        <div class="coupons">
            <div class="coupons-grids text-center">
                <div class="w3layouts_mail_grid">
                    <div class="models">
                        <h3>Причины купить кассовые ящики у нас:</h3>
                        <hr>
                    </div>
