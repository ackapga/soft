...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into acoustomagnetic_bottle
   ...
   else $res=mysqli_query($db,"insert into acoustomagnetic_bottle (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Акустомагнитная бирка Bottle tag в Усть-Каменогорске | Противокражные ворота акустомагнитные купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Акустомагнитная бирка, Bottle tag,  для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить акустомагнитную бирку Bottle tag для магазина в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных противокражных систем.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/acoustomagnetic_bottle.php">Актау</a></li>
                            <li><a href="../aktobe/acoustomagnetic_bottle.php">Актобе</a></li>
                            <li><a href="../acoustomagnetic_bottle.php">Алматы</a></li>
                            <li><a href="../atyrau/acoustomagnetic_bottle.php">Атырау</a></li>
                            <li><a href="../janaozen/acoustomagnetic_bottle.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/acoustomagnetic_bottle.php">Жезказган</a></li>
                            <li><a href="../karaganda/acoustomagnetic_bottle.php">Караганда</a></li>
                            <li><a href="../kokshetau/acoustomagnetic_bottle.php">Кокшетау</a></li>
                            <li><a href="../kostanai/acoustomagnetic_bottle.php">Костанай</a></li>
                            <li><a href="../kyzylorda/acoustomagnetic_bottle.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/acoustomagnetic_bottle.php">Астана</a></li>
                            <li><a href="../pavlodar/acoustomagnetic_bottle.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/acoustomagnetic_bottle.php">Петропавловск</a></li>
                            <li><a href="../semei/acoustomagnetic_bottle.php">Семей</a></li>
                            <li><a href="../taldykorgan/acoustomagnetic_bottle.php">Талдыкорган</a></li>
                            <li><a href="../taraz/acoustomagnetic_bottle.php">Тараз</a></li>
                            <li><a href="../turkestan/acoustomagnetic_bottle.php">Туркестан</a></li>
                            <li><a href="../uralsk/acoustomagnetic_bottle.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/acoustomagnetic_bottle.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/acoustomagnetic_bottle.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Акустомагнитная бирка Bottle tag</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/13.png">
                                <div class="thumb-image"> <img src="../images/eas/13.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/133.png">
                                <div class="thumb-image"> <img src="../images/eas/133.png" class="img-responsive"> </div>
                            </li>
							 <li data-thumb="../images/eas/133.jpg">
                                <div class="thumb-image"> <img src="../images/eas/133.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Акустомагнитная бирка Bottle tag</h2>
                <hr>
                <p class="code-products">Код товара: 9040</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">204 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
					...
					<p><i class="fa fa-check"></i>  металлический тросик спрятан в специальной мягкой оболочке, что исключает случаи порчи товара защитными датчиками.
                    ...
                    <button id="fly" class="add_item" data-id="82" data-title="<a href='https://softgroup.kz/acoustomagnetic_bottle.php'>Акустомагнитная бирка Bottle tag</a>" data-price="204" data-quantity="1" data-img="https://softgroup.kz/images/eas/13.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                    ...
                    <div class="container">
                       <div class="models">
						 ...
						 <div style="text-align:center; margin-right:20px">
                            <img src="../images/eas/p4444.png"></div>
							 <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0"><a href="puller_universal.php">Снятие бирок Bottle tag</a></p>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика акустомагнитной бирки Bottle tag</p>
                <hr>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM acoustomagnetic_bottle
