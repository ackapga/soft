...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Системный блок Core i7 GTX | Системные блоки от Softgroup</title>
        <!--/tags -->
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Системный блок Core i7 GTX</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/block-sistemy/block-5/ava.png">
                                    <div class="thumb-image"> <img src="../images/block-sistemy/block-5/ava.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/block-sistemy/block-5/2.png">
                                    <div class="thumb-image"> <img src="../images/block-sistemy/block-5/2.png" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/block-sistemy/block-5/3.png">
                                    <div class="thumb-image"> <img src="../images/block-sistemy/block-5/3.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Системный блок Core i7 GTX</h1>
                    <hr>
                    <p class="code-products">Код товара: 3880</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">381 900 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>
                            Системный блок с корпусом ATX, midi tower AeroCool Cylon имеет процессор Intel Сore i7-9700. В качестве материнской платы используется Gigabyte H310M H, Socket LGA1151 с усиленной системой питания. В комплект с блоком входит охлаждающий кулер DeepCool
                            Gammaxx200T. Оперативная память состовляет 8GB. Твердотельный Накопитель SSD обладает емкостью 500 Гб. Высокопроизводительная видеокарта Cerberus GeForce GTX 1050 Ti специально создана для игр в режиме нон-стоп.
                        </p>
                        <br>
                        <h3><b>Системный блок состоит из:</b></h3>
                        <p><i class="fa fa-check"></i> Процессор: Сore i7-9700 (8 ядер, 8 потоков, ГГц: 3.0, 12 Мб Кэша);</p>
                        <p><i class="fa fa-check"></i> Видеокарта: ASUS GeForce GTX 1050Ti OC, 4Gb GDDR5;</p>
                        <p><i class="fa fa-check"></i> Оперативная память ОЗУ: DDR4 8GB х 2шт, 2666 МГц;</p>
                        <div><button id="fly" class="add_item" data-id="3880" data-title="<a href='https://softgroup.kz/Sistemnyy-blok-Core-i7-gtx.php'>Системный блок Core i7 GTX</a>" data-price="381900" data-quantity="1" data-img="https://softgroup.kz/images/block-sistemy/block-5/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grids">
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/block-sistemy/block-4/3.png" style="width: 30% !important;">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Процессор Intel Core i7-9400</p>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:20px">
                        <div class="container">
                            ...
                            <div style="text-align:center;">
                                <img src="../images/block-sistemy/block-5/video.png" style="text-align:center; margin-top: 50px; width: 40%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Высокопроизводительная видеокарта </p>
                            <p style="line-height:normal">
                                Высокопроизводительная видеокарта Cerberus GeForce GTX 1050 Ti специально создана для игр в режиме нон-стоп. Она отличается повышенной надёжностью, что было доказано продолжительными тестами с привлечением новейших компьютерных игр и стресс-тестов.
                            </p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:20px">
                        <div class="container">
                            ...
                            <div style="text-align:center;">
                                <img src="../images/block-sistemy/block-4/kuller.png" style="text-align:center; margin-top: 50px;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Охлаждающий Кулер </p>
                            <p style="line-height:normal">
                                Новое поколение систем охлаждения Gammaxx 200T сохранило ключевые особенности устройств серии Gammaxx 200, которые обеспечивали отличное рассеивание тепла. Технология Core Touch позволяет напрямую передавать тепло от процессора к радиатору. При этом размеры
                                радиатора и вентилятора (12-см с поддержкой ШИМ) в этой модели увеличены, чтобы усилить воздушный поток и улучшить охлаждение.
                            </p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style=" background-color: #e5f6f8; padding-bottom:20px">
                        <div class="container">
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/block-sistemy/block-4/smsng.png" style="text-align:center; width: 50%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff;   border-top: 1px solid #eee; padding-bottom:20px">
                        <div class="container">
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/block-sistemy/block-5/ssd.png" style="text-align:center; width: 30%;">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Твердотельный Накопитель SSD:</p>
                            <p style="line-height:normal">Накопитель Samsung 860 EVO представляет собой наиболее продаваемый в мире SATA SSD накопитель* SATA SSD. Специально разработанный для мейнстримовских ПК и ноутбуков, использующий технологию V-NAND и надежный контроллер с отлаженным
                                алгоритмом, этот накопитель является самым быстрым SSD. Он изготавливается в широком диапазоне форм-факторов для совместимым с большинством хост устройств.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;;   border-top: 1px solid #eee; padding-bottom:20px">
                        <div class="container">
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/block-sistemy/block-5/korpus.png" style="text-align:center; margin-top:20px">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Корпус</p>
                            <p style="line-height:normal">Элегантная контровая подсветка передней панели с 13 режимами работы. Шесть режимов мерцания RGB-подсветки. Семь цветовых режимов работы. Съемный пылевой фильтр и магнитный пылевой фильтр на верхней панели для легкой очистки.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        <tr>
                            <td>Процессор:</td>
                            <td> Сore i7-9700 (8 ядер, 8 потоков, ГГц: 3.0, 12 Мб Кэша) </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Видеокарта:</td>
                            <td>ASUS GeForce GTX 1050Ti OC, 4Gb GDDR5</td>
                        </tr>
                        <tr>
                            <td>Охлаждающий Кулер:</td>
                            <td>DeepCool Gammaxx200T, обор./мин.: 1600, коннектор: 4 pin </td>
                        </tr>
                        <tr>
                            <td>Оперативная память ОЗУ:</td>
                            <td>DDR4 8GB х 2шт, 2666 МГц </td>
                        </tr>
                        <tr>
                            <td>Блок Питания:</td>
                            <td> Wintek 600W</td>
                        ...
                        <tr>
                            ...
                            <td>Samsung 860 EVO, 500 GB </td>
                        </tr>
                        <tr>
                            <td>Корпус:</td>
                            <td>ATX, midi tower AeroCool Cylon Черный</td>
                        </tr>
                    </tbody>
                </table>
            </div>
