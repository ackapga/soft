...
<head>
    ...
    <title>Системный блок AMD || Системные блоки от Softgroup</title>
    <!--/tags -->
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/block-sistemy/block-1/ava.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-1/ava.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/block-sistemy/block-1/2.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-1/2.png" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/block-sistemy/block-1/3.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-1/3.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Системный блок AMD</h1>
                <hr>
                <!-- <p class="code-products">Код товара: </p> -->
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">155 800 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Системный блок с корпусом X-Game XC-370 имеет процессор AMD Ryzen 5 3400G. В качестве материнской платы используется ASUS серии Prime с усиленной системой питания. В комплект с блоком входит охлаждающий кулер DEEPCOOL BETA 10. Оперативная
                        память состовляет 4GB. Жесткий диск системного блока обладает частотой вращения 7 200 об/мин и емкостью 500 Гб. </p>
                    <br>
                    <h3><b>Системный блок состоит из:</b></h3>
                    <p><i class="fa fa-check"></i> Процессор: AMD Ryzen 5 3400G (8 ядер, 8 потоков, ГГц: 3.2, 16 Мб Кэша) ;</p>
                    <p><i class="fa fa-check"></i> Материнская плата: ASUS PRIME A320M-R-SI, AM4, Слоты: 2 x DDR4, SATA III: 4;</p>
                    <p><i class="fa fa-check"></i> Охлаждающий Кулер: DEEPCOOL BETA 10 AM4/AM3/+/AM2/+/FM2/+/FM1</p>
                    <div><button id="fly" class="add_item" data-id="4561" data-title="<a href='https://softgroup.kz/Sistemnyy-blok-AMD.php'>Системный блок AMD</a>" data-price="155800" data-quantity="1" data-img="https://softgroup.kz/images/block-sistemy/block-1/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/block-sistemy/block-1/prc1.webp" style="width: 50% ;">
                        </div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Много ядерный процессор</p>
                        <p style="line-height:normal">Процессор AMD Ryzen 5 3400G с видеокартой Radeon адаптирован для применения в различных сборках. Он обладает оптимальной производительностью и справляется со всеми задачами. Вы сможете получить действительно мощный чип, который
                            подойдет для рабочих станций и геймерских ПК.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:20px">
                    <div class="container">
                        ...
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/block-sistemy/block-1/prime.png" alt="Материнская плата">
                        </div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Материнская плата</p>
                        <p style="line-height:normal">Материнские платы ASUS серии Prime – это усиленная система питания, возможность организации полноценного охлаждения компонентов и интеллектуальные средства настройки. Сочетая поддержку новейших процессоров AMD и Intel с оригинальными
                            инженерными решениями, платы серии Prime станут отличным фундаментом для сборки универсальных компьютеров.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:20px">
                    <div class="container">
                        ...
                        <div style="text-align:center;">
                            <img src="../images/block-sistemy/block-1/kuller.png" style="text-align:center; width: 40%;"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Охлаждающий Кулер </p>
                        <p style="line-height:normal">DEEPCOOL BETA 10 AM4/AM3/+/AM2/+/FM2/+/FM1. Запатентованный 92x32мм "перевернутый" вентилятор с функцией ШИМ (PWM) обеспечивает отличный баланс между объемом потока воздуха и уровнем шума Алюминиевый радиатор эффективно рассеивает
                            тепло. Полированное основание обеспечивает превосходный контакт между радиатором и поверхностью процессора.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        ...
                        <p style="line-height:normal">Жесткий диск HDD 1000 Gb Toshiba с одной пластиной, обладающие частотой вращения 7 200 об/мин и емкостью 1 500гб, оптимизированы для использования в энергоэффективных настольных компьютерах, предназначенных для некоммерческих и
                            коммерческих целей. Модель серии DT01ACA100 поддерживает расширенный формат (AF) и технологию усовершенствованного управления питанием. Помимо всего прочего, они обеспечивают экономию энергии в режиме бездействия до 16 % по
                            сравнению с предыдущими моделями. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        ...
                        <td>Процессор:</td>
                        <td>AMD Ryzen 5 3400G (8 ядер, 8 потоков, ГГц: 3.2, 16 Мб Кэша) </td>
                    </tr>
                    <tr>
                        <td>Материнская плата:</td>
                        <td> ASUS PRIME A320M-R-SI, AM4, Слоты: 2 x DDR4, SATA III: 4</td>
                    </tr>
                    <tr>
                        <td>Видеокарта:</td>
                        <td>Нет</td>
                    ...
                    <tr>
                        ...
                        <td>DEEPCOOL BETA 10 AM4/AM3/+/AM2/+/FM2/+/FM1</td>
                    </tr>
                    <tr>
