...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner9125
   ...
   else $res=mysqli_query($db,"insert into scanner9125 (date, theme_id, login, message, rating)
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Стационарный сканер Штрих Кода 9125</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scanner/20.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/20.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/202.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/202.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/1011.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/1011.jpg" id="target" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Стационарный сканер штрих кодов 9125</h1>
                <hr>
                <p class="code-products">Код товара: 2006</p>
                <p><span class="item_price">37 080 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Стационарный сканер штрих кода 9125 настольного типа использует несколько десятков лазерных лучей. Благодаря этой функции кассиру не требуется специальным образом ориентировать штрих-код перед сканером, одна из сканирующих линий обязательно его пересечёт в любом положении.
                    </p>
                    <br>
                    ...
                    <button id="fly" class="add_item" data-id="26" data-title="<a href='https://softgroup.kz/scanner_9125.php'>Сканер штрих кода 9125</a>" data-price="37080" data-quantity="1" data-img="https://softgroup.kz/images/scanner/20.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scanner/shtrih7.png"></div>
                ...
                <div class="bootstrap-tab-text-grid">
                    ...
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/scanner/multiplane2.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Многоплоскостное сканирование</p>
                        <p style="line-height:normal">Сканирующая область стационарных сканеров представляет собой плотную сетку лазерных лучей, которая позволяет считывать штрих-код независимо от его расположения относительно сканера – как вертикально, так и горизонтально. </p>
                        <div class="clearfix"> </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>всенаправленное сканирование</td>
                    </tr>
                    <tr>

                        <td>Минимальный читаемый штрих-код:</td>
                        <td>0,132 мм</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scanner9125
...
?>
            <div class="w3_agile_latest_arrivals">
                ...
                <div class="col-md-3 product-men single">
                    <div class="men-pro-item">
                        <a href="scanner_8120.php">
                            <div class="men-thumb-item"><img src="../images/scanner/2.jpg" alt="" class="pro-image-front">
                                <img src="../images/scanner/2.png" alt="" class="pro-image-back">

                                <span class="product-new-top">New</span></div>
                        </a>
                        <div class="item-info-product ">
                            <h4><a href="scanner_8120.php">Сканер штрих кода 8120</a></h4>
