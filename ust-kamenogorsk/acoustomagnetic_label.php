...
if ($respponse->success){    //отправлен комментарий
    ...
    $rating=htmlspecialchars($_POST["rating"]);
        ...
        $res=mysqli_query($db,"insert into acoustomagnetic_label
        ...
        else $res=mysqli_query($db,"insert into acoustomagnetic_label (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Акустомагнитные этикетки купить в Усть-Каменогорске | Противокражные системы акустомагнитные купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Акустомагнитная этикетки, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить акустомагнитные этикетки для магазина в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных противокражных систем.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/acoustomagnetic_label.php">Актау</a></li>
                            <li><a href="../aktobe/acoustomagnetic_label.php">Актобе</a></li>
                            <li><a href="../acoustomagnetic_label.php">Алматы</a></li>
                            <li><a href="../atyrau/acoustomagnetic_label.php">Атырау</a></li>
                            <li><a href="../janaozen/acoustomagnetic_label.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/acoustomagnetic_label.php">Жезказган</a></li>
                            <li><a href="../karaganda/acoustomagnetic_label.php">Караганда</a></li>
                            <li><a href="../kokshetau/acoustomagnetic_label.php">Кокшетау</a></li>
                            <li><a href="../kostanai/acoustomagnetic_label.php">Костанай</a></li>
                            <li><a href="../kyzylorda/acoustomagnetic_label.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/acoustomagnetic_label.php">Астана</a></li>
                            <li><a href="../pavlodar/acoustomagnetic_label.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/acoustomagnetic_label.php">Петропавловск</a></li>
                            <li><a href="../semei/acoustomagnetic_label.php">Семей</a></li>
                            <li><a href="../taldykorgan/acoustomagnetic_label.php">Талдыкорган</a></li>
                            <li><a href="../taraz/acoustomagnetic_label.php">Тараз</a></li>
                            <li><a href="../turkestan/acoustomagnetic_label.php">Туркестан</a></li>
                            <li><a href="../uralsk/acoustomagnetic_label.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/acoustomagnetic_label.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/acoustomagnetic_label.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Акустомагнитная этикетка в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Акустомагнитная этикетка лист</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/3.jpg">
                                <div class="thumb-image"> <img src="../images/eas/3.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/33.jpg">
                                <div class="thumb-image"> <img src="../images/eas/33.jpg" class="img-responsive"> </div>
                            </li>
							 <li data-thumb="../images/eas/333.jpg">
                                <div class="thumb-image"> <img src="../images/eas/333.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Акустомагнитная этикетка лист</h2>
                <hr>
                <p class="code-products">Код товара: 9041</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">1403 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
					...
					<p><i class="fa fa-check"></i> Внутри защитной этикетки располагаются три металлические пластины с изоляторами между ними
                    ...
                    <button id="fly" class="add_item" data-id="83" data-title="<a href='https://softgroup.kz/acoustomagnetic_label.php'>Акустомагнитная этикетка лист</a>" data-price="1403" data-quantity="1" data-img="https://softgroup.kz/images/eas/3.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика акустомагнитной этикетки</p>
                <hr>
            </div>
            <table class="zui-table zui-table-zebra zui-table-horizontal">
               <tbody>
                    ...
                    <tr>
                        ...
                        <td>В одном листе</td>
                        <td>108 шт(18*6) (Продается листами)</td>
                    </tr>
                </tbody>
            </table>
            <div class="models">
...
$res=mysqli_query($db,"SELECT * FROM acoustomagnetic_label
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить акустомагнитной этикетки у нас:</h3>
                    <hr>
                </div>
