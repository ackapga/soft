...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into radio_deactivator
   ...
   else $res=mysqli_query($db,"insert into radio_deactivator (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Радиочастотный деактиватор купить в Усть-Каменогорске | Антикражные системы от SoftGroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Радиочастотный деактиватор, антикражный, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить Антикражный радиочастотный деактиваторв Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/radio_deactivator.php">Актау</a></li>
                            <li><a href="../aktobe/radio_deactivator.php">Актобе</a></li>
                            <li><a href="../radio_deactivator.php">Алматы</a></li>
                            <li><a href="../atyrau/radio_deactivator.php">Атырау</a></li>
                            <li><a href="../janaozen/radio_deactivator.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/radio_deactivator.php">Жезказган</a></li>
                            <li><a href="../karaganda/radio_deactivator.php">Караганда</a></li>
                            <li><a href="../kokshetau/radio_deactivator.php">Кокшетау</a></li>
                            <li><a href="../kostanai/radio_deactivator.php">Костанай</a></li>
                            <li><a href="../kyzylorda/radio_deactivator.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/radio_deactivator.php">Астана</a></li>
                            <li><a href="../pavlodar/radio_deactivator.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/radio_deactivator.php">Петропавловск</a></li>
                            <li><a href="../semei/radio_deactivator.php">Семей</a></li>
                            <li><a href="../taldykorgan/radio_deactivator.php">Талдыкорган</a></li>
                            <li><a href="../taraz/radio_deactivator.php">Тараз</a></li>
                            <li><a href="../turkestan/radio_deactivator.php">Туркестан</a></li>
                            <li><a href="../uralsk/radio_deactivator.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/radio_deactivator.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/radio_deactivator.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Радиочастотный деактиватор в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Радиочастотный деактиватор</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/12.png">
                                <div class="thumb-image"> <img src="../images/eas/12.png" id="target" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Радиочастотный деактиватор</h2>
                <hr>
                <p class="code-products">Код товара: 9037</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">38 277 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="85" data-title="<a href='https://softgroup.kz/radio_deactivator.php'>Съемник универсальный</a>" data-price="38277" data-quantity="1" data-img="https://softgroup.kz/images/eas/12.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика радиочастотного деактиватора</p>
                <hr>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM radio_deactivator
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить радиочастотного деактиватора у нас:</h3>
                    <hr>
                </div>
