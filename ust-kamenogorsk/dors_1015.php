...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors1015
   ...
   else $res=mysqli_query($db,"insert into dors1015 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот Dors CT1015 купить по низким ценам в Усть-Каменогорске</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, dors, CT1015, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот Dors купить в Усть-Каменогорске. Огромный выбор счетчиков для банкнот по низким ценам. Купить счетчики банкнот в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_1015.php">Актау</a></li>
                            <li><a href="../aktobe/dors_1015.php">Актобе</a></li>
                            <li><a href="../dors_1015.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_1015.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_1015.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_1015.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_1015.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_1015.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_1015.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_1015.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_1015.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_1015.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_1015.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_1015.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_1015.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_1015.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_1015.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_1015.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_1015.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_1015.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики банкнот DORS CT1015</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            ...
                            <li data-thumb="../images/schetchiki/11.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/11.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/1.png">
                                <div class="thumb-image"> <img src="../images/schetchiki/1.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/111.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот DORS CT1015</h2>
                <hr>
                <p class="code-products">Код товара: 8001</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">30 988 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>DORS CT1015 предназначен для пересчета банкнот любых валют. Компактный, портативный счетчик банкнот: работа от блока питания или от батареек (4шт АА), оснащен чехлом для переноса, который может крепиться к ремню. При необходимости заменить батарейки на панели управления загорается световой индикатор. </p>
                </div>
                </p>
                ...
                <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_1015.php'>Счетчики банкнот DORS CT1015</a>" data-price="30988" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/1.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <img src="../images/schetchiki/1111.png">
            ...
            <div style="text-align:center; margin-top:1em;">
                <img src="../images/schetchiki/11111.jpg">
            </div>

            <div>
                <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Виды контроля</p>
                <p style="line-height:normal"><b> • Оптическая плотность</b> банкнотной бумаги определяется как среднее значения пропускания ИК света, прошедшего через банкноту. Это базовый уровень контроля, обязательный для любого счетчика банкнот.</p>
            </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Количество пересчитываемых банкнот, максимум:</td>
                        <td>120 старых или 150 новых</td>
                    </tr>
                    <tr>

                        <td>Питание:</td>
                        <td>110-240 В, AC/DC адаптер или 4 батарейки типа АА</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Индикатор заряда батареек:</td>
                        <td>+</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM dors1015
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить счетчик банкнот у нас</h3>
                    <hr>
                </div>
