...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalemkth
   ...
   else $res=mysqli_query($db,"insert into scalemkth (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Электронные весы MK_ТН21 купить по доступным ценам в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы настольные, масса к, электронные, MK_ТН21, MK-ТН21, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Электронные весы MK_ТН21 купить в Усть-Каменогорске. Огромный выбор электронных весов для торговли. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_mk_th.php">Актау</a></li>
                            <li><a href="../aktobe/scale_mk_th.php">Актобе</a></li>
                            <li><a href="../scale_mk_th.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_mk_th.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_mk_th.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_mk_th.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_mk_th.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_mk_th.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_mk_th.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_mk_th.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_mk_th.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_mk_th.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_mk_th.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_mk_th.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_mk_th.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_mk_th.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_mk_th.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_mk_th.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_mk_th.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_mk_th.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы торговые MK_TH21(RU)</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/8.jpg">
                                <div class="thumb-image"> <img src="../images/scale/8.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/88.jpg">
                                <div class="thumb-image"> <img src="../images/scale/88.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/888.jpg">
                                <div class="thumb-image"> <img src="../images/scale/888.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы торговые MK_TH21(RU)</h2>
                <hr>
                <p class="code-products">Код товара: 5007</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">55 289 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Весы предназначены для измерений массы товаров при торговых операциях. Двухсторонняя светодиодная индикация. Легко интегрируются с учетными системами, POS-системами и смарт-терминалами. Поддерживается возможности суммирования стоимости покупки и расчета сдачи. Встроенный аккумулятор обеспечивает автономную работу весов до 50 часов. Обмен информацией с внешними устройствами реализован по интерфейсам RS-232 и USB.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_mk_th.php'>Весы  торговые MK_TH21(RU)</a>" data-price="55289" data-quantity="1" data-img="https://softgroup.kz/images/scale/8.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg9.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel5.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Панель управления</p>
                          <p style="line-height:normal"> Клавиши электронных весов — это прямая и адресная память для хранения данных о товаре. Клавиши позволяют вызвать из памяти весов часто используемую информацию и записанные товары. По устройству кнопочная клавиатура. В клавиатуре 24 кнопок. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/d4.png" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/icon3.png" style="text-align:center; margin-top:20px"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Тип индикации: </td>
                        <td>Двухсторонняя светодиодная индикация;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>сетевой адаптер - 1 шт, кабель USB 2.0 USB A (m) – USB B (m) длиной 1,5 м -1 шт.;</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры весов (ШхГхВ):</td>
                        <td> 345х350х500 мм;</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scalemkth
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить электронные весы у нас</h3>
                    <hr>
                </div>
