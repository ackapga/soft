    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/RP326/1.jpg">
                                <div class="thumb-image" id="thumb-image"> <img src="../images/RP326/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/RP326/2.jpg">
                                <div class="thumb-image"> <img src="../images/RP326/2.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/RP326/3.jpg">
                                <div class="thumb-image"> <img src="../images/RP326/3.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Принтер чеков RP 326</h1>
                <hr>
                <p class="code-products">Код товара: 5387</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">42 210 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p> <b>Принтер чеков RP 326</b> обладает скоростью печати 250 мм/сек. Термопринтер имеет компактные размеры корпуса и предназначен для печати на 58мм термоленте. Термопринтер чеков успешно используется в крупных торговых сетях, гостиницах
                        и ресторанах, интернет-магазинах с большим клиентским потоком.
                    </p>
                    ...
                    <button id="fly" class="add_item " data-id="5387" data-title="<a href='https://softgroup.kz/thermalprinter_RP326.php'>Принтер чеков Rongta RP 326</a>" data-price="42210" data-quantity="1" data-img="https://softgroup.kz/images/template.jpg" data-count="100500"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/RP326/4.png" style="width: 500px;"></div>
                    <div class="wthree_text_info">
                        <h2>Высокая скорость печати принтера чеков</h2>
                    </div>
                    <p style="line-height:normal">Принтер чеков имеет компактные размеры корпуса и предназначен для печати на 58мм термоленте. Благодаря продуманному дизайну не занимает много места, никаких лишних проводов на рабочем месте, предельно компактно и удобно.</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
