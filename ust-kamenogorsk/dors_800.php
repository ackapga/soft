...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors800
   ...
   else $res=mysqli_query($db,"insert into dors800 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот цветной сенсорный Dors 800 купить по низким ценам в Усть-Каменогорске</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, цветный, сенсорные, dors, 800, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот Dors 800 цветный сенсорные  с автоматическим распознаванием валюты купить в Усть-Каменогорске. Огромный выбор счетчиков для банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_800.php">Актау</a></li>
                            <li><a href="../aktobe/dors_800.php">Актобе</a></li>
                            <li><a href="../dors_800.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_800.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_800.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_800.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_800.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_800.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_800.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_800.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_800.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_800.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_800.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_800.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_800.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_800.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_800.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_800.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_800.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_800.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Счетчик банкнот цветной сенсорный</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики банкнот цветные сенсорные DORS 800</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/5.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/5.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/55.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/55.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/555.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/555.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот цветные сенсорные DORS 800</h2>
                <hr>
                <p class="code-products">Код товара: 8005</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">432 632 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Двухкарманный мультивалютный счетчик банкнот банковского класса DORS 800 Multi с определением номинала, детекцией по 9 признакам и функцией сортировки, гарантирует Вам быстрое решение любой задачи по обработке наличности. </p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_800.php'>Счетчики банкнот цветные сенсорные DORS 800</a>" data-price="432632" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/5.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Дисплей: </td>
                        <td>цветной сенсорный ЖК-дисплей с диагональю 4,3’’ (11 см)</td>
                    </tr>
                    <tr>
                        <td>Скорость счета, банкнот в минуту:</td>
                        <td>600/900/1200/1500</td>
                    </tr>
                    <tr>
                        <td>Размеры пересчитываемых банкнот:</td>
                        <td> 100-190 мм (ширина), 58-90 мм (длина)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Детекция: </td>
                        <td> Цифровая ИК, цифровая оптическая, многоэлементная линейка магнитных датчиков, 2 группы УФ датчиков, оптическая плотность, по размеру, датчики целостности и сдвоенности</td>
                    </tr>
                    <tr>

                        <td>Опции:</td>
                        <td> Внешний дисплей (DORS 85 или DORS 90), чековый принтер, система видеонаблюдения ЧЕКТВ БАНК</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры, (ШхГхВ): </td>
                        <td>305х295х345 мм</td>
                    </tr>
                </tbody>
            </table>
            <div class="models">
...
$res=mysqli_query($db,"SELECT * FROM dors800
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить сенсорный счетчик банкнот у нас</h3>
                    <hr>
                </div>
