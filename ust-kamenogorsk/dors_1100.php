...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors1100
   ...
   else $res=mysqli_query($db,"insert into dors1100 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детекторы банкнот инфракрасные Dors 1100 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1100, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1100 инфракрасные купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_1100.php">Актау</a></li>
                            <li><a href="../aktobe/dors_1100.php">Актобе</a></li>
                            <li><a href="../dors_1100.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_1100.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_1100.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_1100.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_1100.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_1100.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_1100.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_1100.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_1100.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_1100.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_1100.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_1100.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_1100.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_1100.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_1100.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_1100.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_1100.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_1100.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детекторы банкнот инфракрасные Dors</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Инфракрасные детекторы банкнот DORS 1100</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/5.jpg">
                                <div class="thumb-image"> <img src="../images/detector/5.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/55.jpg">
                                <div class="thumb-image"> <img src="../images/detector/55.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/555.jpg">
                                <div class="thumb-image"> <img src="../images/detector/555.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Инфракрасные детекторы банкнот DORS 1100</h2>
                <hr>
                <p class="code-products">Код товара: 9005</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">53 454 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>DORS 1100 - Инфракрасный детектор. Визуальный ИК-контроль подлинности банкнот различных валют, ценных бумаг, документов, акцизных и специальных марок несколькими видами контроля. </p>
                    <p>
                        Детектор валют DORS 1100 имеет современный эргономичный дизайн и компактные размеры. Отличается высокой эффективностью, простотой и удобством в эксплуатации. Оснащен встроенной видеокамерой с оптическим ИК-фильтром, модулем двухдиапазонной ИК-подсветки, высококонтрастным цветным жидкокристаллическим TFT-монитором с диагональю 12,7 см и сенсорной панелью управления.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_1100.php'>Инфракрасные детекторы банкнот DORS 1100</a>" data-price="53454" data-quantity="1" data-img="https://softgroup.kz/images/detector/5.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Инфракрасный контроль,
                            Контроль «спецэлемента М» ;</td>
                    </tr>
                    <tr>
                        <td>Монитор:</td>
                        <td>цветной ЖК TFT-монитор с диагональю 5 дюймов (12,7 см) </td>
                    </tr>
                    <tr>
                        <td>Верхняя подсветка:</td>
                        <td>двухдиапазонная ИК (940/850 нм)</td>
                    </tr>
                    <tr>
                        <td>Подключение дополнительных устройств:</td>
                        <td>1 видеовход для подключения DORS 1010 или DORS 1020, 1 видеовход для подключения внешнего видеоисточника (PAL), 1 видеовыход (PAL)</td>
                    </tr>
                    <tr>

                        <td>Потребляемая мощность: </td>
                        <td> не более 20 Вт</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры (ШхГхВ):</td>
                        <td>150х110х295 мм</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM dors1100
