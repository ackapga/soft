...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into puller_universal
   ...
   else $res=mysqli_query($db,"insert into puller_universal (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Антикражный съемник универсальный купить в Усть-Каменогорске | Антикражные системы </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Съемник универсальный, антикражный, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить Антикражный съемник универсальный в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/puller_universal.php">Актау</a></li>
                            <li><a href="../aktobe/puller_universal.php">Актобе</a></li>
                            <li><a href="../puller_universal.php">Алматы</a></li>
                            <li><a href="../atyrau/puller_universal.php">Атырау</a></li>
                            <li><a href="../janaozen/puller_universal.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/puller_universal.php">Жезказган</a></li>
                            <li><a href="../karaganda/puller_universal.php">Караганда</a></li>
                            <li><a href="../kokshetau/puller_universal.php">Кокшетау</a></li>
                            <li><a href="../kostanai/puller_universal.php">Костанай</a></li>
                            <li><a href="../kyzylorda/puller_universal.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/puller_universal.php">Астана</a></li>
                            <li><a href="../pavlodar/puller_universal.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/puller_universal.php">Петропавловск</a></li>
                            <li><a href="../semei/puller_universal.php">Семей</a></li>
                            <li><a href="../taldykorgan/puller_universal.php">Талдыкорган</a></li>
                            <li><a href="../taraz/puller_universal.php">Тараз</a></li>
                            <li><a href="../turkestan/puller_universal.php">Туркестан</a></li>
                            <li><a href="../uralsk/puller_universal.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/puller_universal.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/puller_universal.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Антикражный съемник в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/6.jpg">
                                <div class="thumb-image"> <img src="../images/eas/6.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/66.jpg">
                                <div class="thumb-image"> <img src="../images/eas/66.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Съемник универсальный</h2>
                <hr>
                <p class="code-products">Код товара: 9035</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">10462 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Съемник универсальный усиленный,</b> сила 12000 Гс. Предназначен для снятия любых датчиков антикражных систем с магнитным замком. Сила магнита 12000 Гс позволяет открывать все типы противокражных бирок. Бирка имеет специально намагниченную основу, которая защищает магазин, от неоплаченного выноса товара из торговой точки. Если товар неоплаченный и бирка не размагничена, то при попытке выйти из магазина раздается звуковой сигнал.
</p>
                    <br>
                    <h3><b>Преимущества антикражных петли:</b></h3>
                    ...
                    <button id="fly" class="add_item" data-id="84" data-title="<a href='https://softgroup.kz/puller_universal.php'>Съемник универсальный</a>" data-price="10462" data-quantity="1" data-img="https://softgroup.kz/images/eas/6.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>        <div class="responsive_tabs_agileits">
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика универсального съемника</p>
                <hr>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM puller_universal
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить универсального съемника у нас:</h3>
                    <hr>
                </div>
