...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into post8
   ...
   else $res=mysqli_query($db,"insert into post8 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Сенсорный моноблок с принтером чеков купить в Усть-Каменогорске | POS моноблоки</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="сенсорный моноблок с принтером чеков, для кассы, с сенсорным экраном, для розничной торговли, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Сенсорный моноблок с принтером чеков купить в Усть-Каменогорске от Softgroup. Широкий выбор ассортимента POS моноблоков с сенсорным экраном для кассы.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/pos_t8_white_printer.php">Актау</a></li>
                            <li><a href="../aktobe/pos_t8_white_printer.php">Актобе</a></li>
                            <li><a href="../pos_t8_white_printer.php">Алматы</a></li>
                            <li><a href="../atyrau/pos_t8_white_printer.php">Атырау</a></li>
                            <li><a href="../janaozen/pos_t8_white_printer.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/pos_t8_white_printer.php">Жезказган</a></li>
                            <li><a href="../karaganda/pos_t8_white_printer.php">Караганда</a></li>
                            <li><a href="../kokshetau/pos_t8_white_printer.php">Кокшетау</a></li>
                            <li><a href="../kostanai/pos_t8_white_printer.php">Костанай</a></li>
                            <li><a href="../kyzylorda/pos_t8_white_printer.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_t8_white_printer.php">Астана</a></li>
                            <li><a href="../pavlodar/pos_t8_white_printer.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/pos_t8_white_printer.php">Петропавловск</a></li>
                            <li><a href="../semei/pos_t8_white_printer.php">Семей</a></li>
                            <li><a href="../taldykorgan/pos_t8_white_printer.php">Талдыкорган</a></li>
                            <li><a href="../taraz/pos_t8_white_printer.php">Тараз</a></li>
                            <li><a href="../turkestan/pos_t8_white_printer.php">Туркестан</a></li>
                            <li><a href="../uralsk/pos_t8_white_printer.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/pos_t8_white_printer.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/pos_t8_white_printer.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Сенсорный экран Т8 с принтером чеков, белый</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/t8_white_printer.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/t8_white_printer.jpg" id="target" class="img-responsive"> </div>
                            </li>

                            <li data-thumb="../images/monitor/2444.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/2444.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/244_1.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/244_1.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Сенсорный моноблок Т8 с принтером чеков, белый</h1>
                <hr>
                <p class="code-products">Код товара: 1005</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">182 700 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Сенсорный моноблок</b> с принтером чеков, белый с 15,6-дюймовой диагональю экрана обладает высокой чувствительностью. Наличие встроенного принтера чека (58мм) является его главным отличием и достоинством. Дисплей покупателя имеет возможность показывать клиенту то, что он заказывает. </p>
                    <br>
                    <h3><b>В состав сенсорного Pos моноблока входит:</b></h3>
                    <p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800;</p>
                    <p><i class="fa fa-check"></i> Сенсорный моноблок кассира с 15,6-дюймовым диагональю экрана;</p>
                    <p><i class="fa fa-check"></i> Принтер чека 58мм;</p>
                    <p><i class="fa fa-check"></i> Дисплей покупателя: 2 строки, 40 символов.</p>
                    <img src="../images/monitor/icon3.png">
                    <div> <button id="fly" class="add_item" data-id="5" data-title="<a href='https://softgroup.kz/pos_t8_white_printer.php'>Т8 с принтером чеков, белый</a>" data-price="182700" data-quantity="1" data-img="https://softgroup.kz/images/monitor/t8_white_printer.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/monitor/p1.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Разнообразная цветовая гамма корпуса</p>
                        <p style="line-height:normal">Корпус сенсорного моноблока доступен в двух цветах на выбор: <b>черный и белый.</b> Моноблок в корпусе белого цвета дополнит рабочий стол. Классический черный цвет корпуса отлично впишется в любую обстановку.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/monitor/d2.png" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Яркий цветной дисплей</p>
                        <p style="line-height:normal">Сенсорный экран моноблока имеет диагональ 15,6 дюйма, что предоставляет высочайший комфорт при работе с устройством и повышает удобство для сотрудников при работе с большим объемом данных. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/vfd.png" style="text-align:center; "></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Встроенный дисплей покупателя</p>
                        <p style="line-height:normal">Дисплей покупателя предназначен для отображения информации о приобретенных товарах, об их стоимости и количестве. Транслирует общую сумму покупки, размер скидки, количество бонусных баллов. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/p8.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Встроенный принтер чеков</p>
                        <p style="line-height:normal">Моноблок со встроенным в корпус термопринтером для печати чеков, шириной 58 мм. Кассовый аппарат и термопринтер - два устройства в одном, это – разумная экономия и места, и денежных средств. Благодаря продуманному дизайну не занимает много места, никаких лишних проводов на рабочем месте, предельно компактно и удобно.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/t8_white_congif.jpg" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Набор интерфейсов</p>
                        <p style="line-height:normal">Все интерфейсные разъёмы расположены в нижней части устройства: разъём питания, VGA порт для подключения мониторов, СОМ порт для передачи данных, четыре разъёма USB порта (2 из них последняя версия стандарта USB 3.0), RJ порт для подключения локальной сети и два разъёма для передачи аудиосигнала.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/sensor2.jpg" style="text-align:center; "></div>
                        <div class="wthree_text_info">
                            <h2>Чувствительный моноблок с сенсорным экраном</h2>
                        </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/naklon.png" style="text-align:center; margin-top:20px"></div>
				 ...
				 <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/wifi1.png" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Встроенный модуль Wi-Fi</p>
                        <p style="line-height:normal">Моноблок поддерживает установку высокоскоростного модуля Wi-Fi, что дает широкие возможности для выхода в интернет и подключения дополнительного беспроводного оборудования.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        ...
                        <td>Дисплей:</td>
                        <td>15,6-дюймовый сенсорный экран</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Процессор:</td>
                        <td>Intel Celeron J1800 2,0 Ггц</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Интерфейс:</td>
                        <td>6 USB <br>1 COM port <br>1 LAN port <br>1 VGA port <br>1 Audio input; 1 Audio output</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>VFD: 2 строки, 40 символов</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
$res=mysqli_query($db,"SELECT * FROM post8
