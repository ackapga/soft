...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner8120
   ...
   else $res=mysqli_query($db,"insert into scanner8120 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Настольный сканер в Усть-Каменогорске | Многоплоскостной сканер штрих кода купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="многоплоскостной сканер штрих кода, настольный сканер, сканер настольный, для кассы, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить настольный сканер штрих кода в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент многоплоскостных сканеров штрих кода Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scanner_8120.php">Актау</a></li>
                            <li><a href="../aktobe/scanner_8120.php">Актобе</a></li>
                            <li><a href="../scanner_8120.php">Алматы</a></li>
                            <li><a href="../atyrau/scanner_8120.php">Атырау</a></li>
                            <li><a href="../janaozen/scanner_8120.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scanner_8120.php">Жезказган</a></li>
                            <li><a href="../karaganda/scanner_8120.php">Караганда</a></li>
                            <li><a href="../kokshetau/scanner_8120.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scanner_8120.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scanner_8120.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scanner_8120.php">Астана</a></li>
                            <li><a href="../pavlodar/scanner_8120.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scanner_8120.php">Петропавловск</a></li>
                            <li><a href="../semei/scanner_8120.php">Семей</a></li>
                            <li><a href="../taldykorgan/scanner_8120.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scanner_8120.php">Тараз</a></li>
                            <li><a href="../turkestan/scanner_8120.php">Туркестан</a></li>
                            <li><a href="../uralsk/scanner_8120.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scanner_8120.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scanner_8120.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scanner/2.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/2.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/22.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/22.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/222.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/222.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Настольный сканер штрих кода 8120</h1>
                <hr>
                <p class="code-products">Код товара: 2008</p>
                <p><span class="item_price">51 500 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Настольный сканер штрих кода</b> высокого качества идеально подходит для кассы любого направления торговли. Всенаправленная 24-строчная схема сканирования сети программного обеспечения Flash ROM. Процесс сканирования очень быстрый и точный. </p>
                    <br>
                    <h3><b>Вид настольного сканера штрих-кода:</b></h3>
                    <p><i class="fa fa-check"></i> По типу считывающего элемента – многоплоскостной</p>
                    <p><i class="fa fa-check"></i> По исполнению – стационарный</p>
                    ...
                    <button id="fly" class="add_item" data-id="28" data-title="<a href='https://softgroup.kz/scanner_8120.php'>Сканер штрих кода 8120</a>" data-price="51500" data-quantity="1" data-img="https://softgroup.kz/images/scanner/2.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scanner/shtrih5.png"></div>
                ...
                <div class="bootstrap-tab-text-grid">
                    ...
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/scanner/multiplane1.png"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>всенаправленное сканирование (шесть направлений, по четыре в каждом направлении параллельно линии сканирования)</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scanner8120
...
?>
            <div class="w3_agile_latest_arrivals">
                ...
                <div class="col-md-3 product-men single">
                    <div class="men-pro-item">
                        <a href="scanner_6900.php">
                            <div class="men-thumb-item"><img src="../images/scanner/1.jpg" alt="" class="pro-image-front">
                                <img src="../images/scanner/1.png" alt="" class="pro-image-back">

                                <span class="product-new-top">New</span></div>
                        </a>
                        <div class="item-info-product ">
                            <h4><a href="scanner_6900.php">Сканер штрих кода 6900</a></h4>
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h2>Причины купить настольного сканера у нас:</h2>
                    <hr>
                </div>
