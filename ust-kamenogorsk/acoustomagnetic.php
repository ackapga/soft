    ...
    $rating=htmlspecialchars($_POST["rating"]);
     ...
     if ($mess_login!='' and $user_text!=''){
      if (is_numeric($_POST["parent_id"]) and is_numeric($_POST["f_parent"]))
       $res=mysqli_query($db,"insert into acoustomagnetic
      ...
      else $res=mysqli_query($db,"insert into acoustomagnetic (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Противокражные системы в Усть-Каменогорске | Противокражные ворота акустомагнитные купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="противокражные системы, противокражные ворота, акустомагнитные, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить противокражные ворота для магазина в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных противокражных систем.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/acoustomagnetic.php">Актау</a></li>
                            <li><a href="../aktobe/acoustomagnetic.php">Актобе</a></li>
                            <li><a href="../acoustomagnetic.php">Алматы</a></li>
                            <li><a href="../atyrau/acoustomagnetic.php">Атырау</a></li>
                            <li><a href="../janaozen/acoustomagnetic.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/acoustomagnetic.php">Жезказган</a></li>
                            <li><a href="../karaganda/acoustomagnetic.php">Караганда</a></li>
                            <li><a href="../kokshetau/acoustomagnetic.php">Кокшетау</a></li>
                            <li><a href="../kostanai/acoustomagnetic.php">Костанай</a></li>
                            <li><a href="../kyzylorda/acoustomagnetic.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/acoustomagnetic.php">Астана</a></li>
                            <li><a href="../pavlodar/acoustomagnetic.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/acoustomagnetic.php">Петропавловск</a></li>
                            <li><a href="../semei/acoustomagnetic.php">Семей</a></li>
                            <li><a href="../taldykorgan/acoustomagnetic.php">Талдыкорган</a></li>
                            <li><a href="../taraz/acoustomagnetic.php">Тараз</a></li>
                            <li><a href="../turkestan/acoustomagnetic.php">Туркестан</a></li>
                            <li><a href="../uralsk/acoustomagnetic.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/acoustomagnetic.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/acoustomagnetic.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Противокражные системы в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Акустомагнитная противокражная система</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/1.jpg">
                                <div class="thumb-image"> <img src="../images/eas/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/11.jpg">
                                <div class="thumb-image"> <img src="../images/eas/11.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/111.jpg">
                                <div class="thumb-image"> <img src="../images/eas/111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Акустомагнитная противокражная система</h2>
                <hr>
                <p class="code-products">Код товара: 9038</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">165 867 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Акустомагнитные противокражные системы</b>  имеют самый высокий коэффициент срабатывания более 95 % и отличаются высокой помехоустойчивостью. Диапазон, в котором работают акустомагнитные антикражные системы, меньше других подвержен шумам и другим помехам, поэтому для них характерна низкая степень ложных срабатываний.

</p>
                    <br>
                    <h3><b>Преимущества антикражных ворот:</b></h3>
                    <p><i class="fa fa-check"></i> способность акустомагнитных систем защищать широкие проходы без перегораживания рамками;</p>
                    <p><i class="fa fa-check"></i> отсутствие выносного блока (вся электроника встроена в одну стойку-антенну);</p>
					<p><i class="fa fa-check"></i> стильное, современное и надежное решение для предотвращения потерь на предприятиях торговли;</p>
                    ...
                    <button id="fly" class="add_item" data-id="86" data-title="<a href='https://softgroup.kz/acoustomagnetic.php'>Акустомагнитная противокражная система</a>" data-price="165867" data-quantity="1" data-img="https://softgroup.kz/images/eas/1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/eas/sygnal1.png"></div>
 ...
 <div class="bootstrap-tab-text-grid">
                    <div class="container">
                      <div style="text-align:center">
                            <img src="../images/eas/svet1.png"></div>
                    ...
                    <div class="container">
					 <div class="models" style="margin-top:50px">
                        ...
                        <div style="float:left; margin-right:20px">
                            <img src="../images/eas/p1.png"></div>
                       <div class="eas" style="margin-top:40px"><p style="color:#ff9601;" ><a href="acoustomagnetic_tag.php">Акустомагнитная бирка Карандаш</a></p></div>
                        <p style="line-height:normal; margin-bottom:20px">Акустомагнитная бирка Карандаш применяется для защиты товаров в магазинах белья, одежды из деликатных тканей, кожгалантереи, детской одежды. Крепится на товар с помощью кнопки (гвоздика) или тросика. Снимается акустомагнитным деактиватором при продаже товара.</p>
                        <div class="clearfix"> </div>
				...
				<div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  margin:20px 0 10px 0">
                    ...
                    <div class="container">
                        <div style="float:left; margin-right:20px">
                             <img src="../images/eas/p2.png"></div>
							  <div class="eas" style="margin-top:20px"><p style="color:#ff9601;" ><a href="acoustomagnetic_label.php">Акустомагнитная этикетка</a></p></div>
                        <p style="line-height:normal">Акустомагнитная этикетка основана на акустомагнитной технологии, и работает на частоте 58KHz. Антикражная этикетка имитирует штрих-кодовую этикетку, крепко приклеивается на изделие и защищает его от несанкционированного выноса из магазина.</p> 
                        <div class="clearfix"> </div>
                    </div>
                </div>
					<div class="bootstrap-tab-text-grid"> 
                    <div class="container">
                        <div style="float:left; margin-right:20px">
                            <img src="../images/eas/p3.png"></div>
							 <div class="eas" style="margin-top:20px"><p style="color:#ff9601;" ><a href="acoustomagnetic_deactivator.php">Акустомагнитный деактиватор</a></p></div>
                        <p style="line-height:normal; margin-bottom:20px">Акустомагнитный деактиватор противокражных этикеток предназначены для снятия защитных свойств (деактивации) акустомагнитных этикеток, для бесконтактного размагничивания. Используются в кассовой зоне сотрудниками магазина для деактивации акустомагнитных этикеток на проданном товаре.</p>
                        <div class="clearfix"> </div>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика акустомагнитной противокражной системы</p>
                <hr>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM acoustomagnetic
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить акустомагнитной противокражной системы у нас:</h3>
                    <hr>
                </div>
