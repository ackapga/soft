...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into labelrp80
   ...
   else $res=mysqli_query($db,"insert into labelrp80 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Принтер этикеток самоклеящихся купить в Усть-Каменогорске | Принтер для этикеток Rongta</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Принтер этикеток, самоклеящихся, rongta, с термопечатью, на термоленте, для кассы, для печати, шириной 80 мм, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Принтеры самоклеящихся купить в Усть-Каменогорске. Высококачественный принтер этикеток Rongta по низким ценам от компании Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/label_rp80.php">Актау</a></li>
                            <li><a href="../aktobe/label_rp80.php">Актобе</a></li>
                            <li><a href="../label_rp80.php">Алматы</a></li>
                            <li><a href="../atyrau/label_rp80.php">Атырау</a></li>
                            <li><a href="../janaozen/label_rp80.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/label_rp80.php">Жезказган</a></li>
                            <li><a href="../karaganda/label_rp80.php">Караганда</a></li>
                            <li><a href="../kokshetau/label_rp80.php">Кокшетау</a></li>
                            <li><a href="../kostanai/label_rp80.php">Костанай</a></li>
                            <li><a href="../kyzylorda/label_rp80.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/label_rp80.php">Астана</a></li>
                            <li><a href="../pavlodar/label_rp80.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/label_rp80.php">Петропавловск</a></li>
                            <li><a href="../semei/label_rp80.php">Семей</a></li>
                            <li><a href="../taldykorgan/label_rp80.php">Талдыкорган</a></li>
                            <li><a href="../taraz/label_rp80.php">Тараз</a></li>
                            <li><a href="../turkestan/label_rp80.php">Туркестан</a></li>
                            <li><a href="../uralsk/label_rp80.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/label_rp80.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/label_rp80.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
                    ...
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/label/2.png">
                                <div class="thumb-image"> <img src="../images/label/2.png" id="target" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">51 000 тг. </span></p>
                <div class="rating1">
...
$res=mysqli_query($db,"SELECT * FROM labelrp80
