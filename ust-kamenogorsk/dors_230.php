...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors230
   ...
   else $res=mysqli_query($db,"insert into dors230 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детектор банкнот автоматический Dors 230 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 230, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 230 автоматические купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_230.php">Актау</a></li>
                            <li><a href="../aktobe/dors_230.php">Актобе</a></li>
                            <li><a href="../dors_230.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_230.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_230.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_230.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_230.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_230.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_230.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_230.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_230.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_230.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_230.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_230.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_230.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_230.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_230.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_230.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_230.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_230.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детектор банкнот автоматический</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Автоматические детекторы банкнот DORS 230</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/10.jpg">
                                <div class="thumb-image"> <img src="../images/detector/10.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/101.jpg">
                                <div class="thumb-image"> <img src="../images/detector/101.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/1011.jpg">
                                <div class="thumb-image"> <img src="../images/detector/1011.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Автоматические детекторы банкнот DORS 230</h2>
                <hr>
                <p class="code-products">Код товара: 9010</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">117 229 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>В детекторе валют DORS 230 применены технические решения, не имеющие аналогов среди приборов данного класса, – инновационная система распознавания банкнот, сенсорный экран, цветной графический анимированный пользовательский интерфейс.</p>

                    <br>• DORS 230 не имеет ограничений по количеству поддерживаемых валют, аппаратные возможности прибора позволяют поддерживать в одной базе валют все существующие валюты мира;
                    <br>• прибор оснащен сенсорным экраном и имеет цветной графический анимированный пользовательский интерфейс;
                    <br>• вид валюты определяется автоматически, пользователю не требуется выбирать валюту вручную нажатием на соответствующую клавишу;
                    <br>• банкнота может помещаться в прибор любой стороной.
                    </p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_230.php'>Автоматические детекторы банкнот DORS 230</a>" data-price="117229" data-quantity="1" data-img="https://softgroup.kz/images/detector/10.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        <td>Размеры проверяемых банкнот: </td>
                        <td>ширина 58–85 мм, длина 100–181 мм</td>
                    </tr>
                    <tr>
                        <td>Позиционирование банкноты: </td>
                        <td>узкой стороной вперед</td>
                    </tr>
                    <tr>
                        <td>Скорость проверки: </td>
                        <td>60 банкнот в минуту</td>
                    </tr>
                    <tr>
                        <td>Блок детекции:</td>
                        <td>многодиапазонный CIS-сканер, встроенная система автоматического анализа типа валюты, номинала и признаков подлинности</td>
                    </tr>
                    <tr>
                        <td>Дисплей:</td>
                        <td>цветной жидкокристаллический с диагональю 8,9 см (3,5″)</td>
                    </tr>
                    <tr>

                        <td>Управление: </td>
                        <td>сенсорный экран (Touchscreen)</td>
                    </tr>
                    <tr>
                        <td>Подключение к ПК: </td>
                        <td>miniUSB разъем</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры (ШхГхВ):</td>
                        <td>115х104,5х86 мм</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM dors230
