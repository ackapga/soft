...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalemkabruew
   ...
   else $res=mysqli_query($db,"insert into scalemkabruew (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы из нержавеющей стали MK_АВ21(RUEW) купить по доступным ценам в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы настольные, масса к, электронные, MK_AB21(ruew), MK-AB21, влагозащищенные, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Весы  из нержавеющей стали MK_АВ21(RUEW) купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_mk_ab_ruew.php">Актау</a></li>
                            <li><a href="../aktobe/scale_mk_ab_ruew.php">Актобе</a></li>
                            <li><a href="../scale_mk_ab_ruew.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_mk_ab_ruew.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_mk_ab_ruew.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_mk_ab_ruew.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_mk_ab_ruew.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_mk_ab_ruew.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_mk_ab_ruew.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_mk_ab_ruew.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_mk_ab_ruew.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_mk_ab_ruew.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_mk_ab_ruew.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_mk_ab_ruew.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_mk_ab_ruew.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_mk_ab_ruew.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_mk_ab_ruew.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_mk_ab_ruew.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_mk_ab_ruew.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_mk_ab_ruew.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
            <h1>Весы из нержавеющей стали</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы влагозащищенные MK_AB2(RUEW)</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/6.jpg">
                                <div class="thumb-image"> <img src="../images/scale/6.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/66.jpg">
                                <div class="thumb-image"> <img src="../images/scale/66.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/666.jpg">
                                <div class="thumb-image"> <img src="../images/scale/666.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы электронные влагозащищенные MK_AB2(RUEW)</h2>
                <hr>
                <p class="code-products">Код товара: 5005</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">103 598 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Весы с улучшенной влагозащитой предназначены для измерений массы товаров при торговых, учетных и технологических операциях. Терминал весов в корпусе из нержавеющей стали. Весы легко интегрируются с учетными системами, POS и смарт-терминалами. Весы могут работать в счетном режиме, режимах процентного взвешивания и контроля массы (компараторный режим). Обмен информацией с внешними устройствами реализован по интерфейсам RS-232, USB, Ethernet и Wi-Fi.</p>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg16.png"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> сетевой адаптер - 1 шт., Патч-корд (Cat 5e) длиной 2 м - 1шт;</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры весов (ШхГхВ):</td>
                        <td>458х412х415 мм;</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scalemkabruew
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить весы из нержавеющей стали у нас</h3>
                    <hr>
                </div>
