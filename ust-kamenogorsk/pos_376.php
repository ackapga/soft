...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into pos376
   ...
   else $res=mysqli_query($db,"insert into pos376 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Pos-система для кассы магазина купить в Усть-Каменогорске | POS терминалы - Широкий выбор</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Pos-система для магазина, pos терминалы, для магазина, для кассы, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="POS системы и POS терминалы для магазина купить в Усть-Каменогорске по выгодным ценам от Softgroup. Широкий выбор продукции Pos систем для супермаркетов">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/pos_376.php">Актау</a></li>
                            <li><a href="../aktobe/pos_376.php">Актобе</a></li>
                            <li><a href="../pos_376.php">Алматы</a></li>
                            <li><a href="../atyrau/pos_376.php">Атырау</a></li>
                            <li><a href="../janaozen/pos_376.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/pos_376.php">Жезказган</a></li>
                            <li><a href="../karaganda/pos_376.php">Караганда</a></li>
                            <li><a href="../kokshetau/pos_376.php">Кокшетау</a></li>
                            <li><a href="../kostanai/pos_376.php">Костанай</a></li>
                            <li><a href="../kyzylorda/pos_376.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_376.php">Астана</a></li>
                            <li><a href="../pavlodar/pos_376.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/pos_376.php">Петропавловск</a></li>
                            <li><a href="../semei/pos_376.php">Семей</a></li>
                            <li><a href="../taldykorgan/pos_376.php">Талдыкорган</a></li>
                            <li><a href="../taraz/pos_376.php">Тараз</a></li>
                            <li><a href="../turkestan/pos_376.php">Туркестан</a></li>
                            <li><a href="../uralsk/pos_376.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/pos_376.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/pos_376.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/8.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/8.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/88.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/88.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/888.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/888.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <h1>Pos-система для магазина</h1>
                <hr>
                <p class="code-products">Код товара: 1010</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">93 981 тг.</span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p> Pos-система для магазина - готовое решение для автоматизации кассы магазинов, супермаркетов и для любых торговых предприятий. POS-система содержит все необходимые оборудования для осуществления расчётов с покупателями и работы кассира.</p>
                    <br>
                    <h3><b>В состав POS системы для магазина входит:</b></h3>
                    <p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800;</p>
                    <p><i class="fa fa-check"></i> Монитор кассира с 12-дюймовой диагональю экрана;</p>
                    <p><i class="fa fa-check"></i> Принтер чека 58 мм;</p>
                    <p><i class="fa fa-check"></i> Клавиатура KB 103;</p>
                    <p><i class="fa fa-check"></i> Дисплей покупателя: 2 строки, 40 символов;</p>
                    <p><i class="fa fa-check"></i> Денежный ящик с функцией блокировки, 4/5 отделениями для купюр и 8 для монет.</p>
                    <button id="fly" class="add_item" data-id="1" data-title="<a href='https://softgroup.kz/pos_376.php'>Pos-система для магазина</a>" data-summary="summary 1" data-price="93981" data-quantity="1" data-img="https://softgroup.kz/images/monitor/8.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/monitor/pos_monitor.png"></div>
                        <div class="wthree_text_info">
                            <h2>Регулируемый монитор POS системы</h2>
                        </div>
                        <p style="line-height:normal"><b>Монитор POS системы</b> с 12-дюймовой диагональю экрана. На экране имеется заводская защитная плёнка. Наклон монитора легко регулируется, что позволяет размещать его на нужную высоту для удобства кассира и клиента. В данном моноблоке уже установлен Windows7.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/display.png" style="text-align:center; "></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Встроенный дисплей покупателя</p>
                        <p style="line-height:normal"><b>Дисплей покупателя</b> предназначен для отображения информации о приобретенных товарах, их стоимости и количестве. Транслирует общую сумму покупки, размер скидки, количество бонусных баллов. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/keyboard.png" style="text-align:center; "></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Встроенная POS-клавиатура</p>
                        <p style="line-height:normal">Pos-система имеет встроенную <b>клавиатуру,</b> которая служит для управления программно-аппаратным комплексом. С точки зрения общепринятой классификации, программируемая клавиатура, равно как и стандартная, относится к периферийному оборудованию, и по своей сути является устройством ввода информации. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/till.png" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Денежный ящик для хранения денег</p>
                        <p style="line-height:normal">В комплекте Pos системы идет <b>денежный ящик</b> со съёмными 4/5 отделениями для купюр, с прижимными лапками и 8 отделениями для монет. Предназначен для надёжного хранения денег, чеков и остальной документации. Ящик идёт с уникальным замком и функцией блокировки.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        ...
                        <td>Дисплей:</td>
                        <td>12-дюймовый (диагональный) светодиодный</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Процессор:</td>
                        <td>Intel Celeron J1800 2,41 GHz dual core</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Мощность:</td>
                        <td>250 Вт / 220В / 110 В</td>
                    </tr>
                    <tr>

                        <td>Интерфейс:</td>
                        <td>6 USB <br>1 PS/2 клавиатура <br>1 PS/2 мышь <br> 1 LAN port<br>1 Serial port<br>1 VGA port<br>1 Parallel port<br> 1 Audio Input / 1 Output<br>RJ11</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Принтер чека:</td>
                        <td>Термопринтер 58 мм</td>
                    </tr>
                    <tr>

                        <td>Денежный ящик:</td>
                        <td>5 отделений для купюр, 4 для монет, с функцией блокировки</td>

                    </tr>
                    <tr>

                        <td>Pos клавиатура:</td>
                        <td>KB 103 </td>
...
$res=mysqli_query($db,"SELECT * FROM pos376
