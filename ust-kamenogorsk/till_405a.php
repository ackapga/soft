...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into till405a
   ...
   else $res=mysqli_query($db,"insert into till405a (date, theme_id, login, message, rating)
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/till/2.jpg">
                                <div class="thumb-image"> <img src="../images/till/2.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/till/22.jpg">
                                <div class="thumb-image"> <img src="../images/till/22.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/till/222.jpg">
                                <div class="thumb-image"> <img src="../images/till/222.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Денежный ящик 405A</h1>
                <hr>
                <p class="code-products">Код товара: 6002</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">18 960 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Денежный ящик</b> металлический со съемными 5 отделениями для купюр с прижимными лапками и 8 отделениями для монет предназначен для надежного хранения денег, чеков и остальной документации. Ящик комплектуется уникальным замком с функцией блокировки.</p>
                    ...
                    <button id="fly" class="add_item" data-id="24" data-title="<a href='https://softgroup.kz/till_405a.php'>Денежный ящик 405A</a>" data-price="18960" data-quantity="1" data-img="https://softgroup.kz/images/till/2.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/till/till_a.png"></div>
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>2 слота проверки замка, 3 положения блокировки
                            </td>
                        </tr>
                        <tr>
...
$res=mysqli_query($db,"SELECT * FROM till405a
