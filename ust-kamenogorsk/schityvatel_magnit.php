...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into schityvatel_magnit
   ...
   else $res=mysqli_query($db,"insert into schityvatel_magnit (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Считыватель магнитных карт в Усть-Каменогорске | Цены на считыватели карт от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="считыватель магнитных карт, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Предлагаем вам купить считыватели магнитных карт в Усть-Каменогорске по доступным ценам. Считыватели магнитных карт в широком ассортименте от Softgroup.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/schityvatel_magnit.php">Актау</a></li>
                            <li><a href="../aktobe/schityvatel_magnit.php">Актобе</a></li>
                            <li><a href="../schityvatel_magnit.php">Алматы</a></li>
                            <li><a href="../atyrau/schityvatel_magnit.php">Атырау</a></li>
                            <li><a href="../janaozen/schityvatel_magnit.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/schityvatel_magnit.php">Жезказган</a></li>
                            <li><a href="../karaganda/schityvatel_magnit.php">Караганда</a></li>
                            <li><a href="../kokshetau/schityvatel_magnit.php">Кокшетау</a></li>
                            <li><a href="../kostanai/schityvatel_magnit.php">Костанай</a></li>
                            <li><a href="../kyzylorda/schityvatel_magnit.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/schityvatel_magnit.php">Астана</a></li>
                            <li><a href="../pavlodar/schityvatel_magnit.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/schityvatel_magnit.php">Петропавловск</a></li>
                            <li><a href="../semei/schityvatel_magnit.php">Семей</a></li>
                            <li><a href="../taldykorgan/schityvatel_magnit.php">Талдыкорган</a></li>
                            <li><a href="../taraz/schityvatel_magnit.php">Тараз</a></li>
                            <li><a href="../turkestan/schityvatel_magnit.php">Туркестан</a></li>
                            <li><a href="../uralsk/schityvatel_magnit.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/schityvatel_magnit.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/schityvatel_magnit.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/27.png">
                                <div class="thumb-image"> <img src="../images/monitor/27.png" id="target" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Считыватель магнитных карт</h1>
                <hr>
                <p class="code-products">Код товара: 1017</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">18 900 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="25" data-title="<a href='https://softgroup.kz/schityvatel_magnit.php'>Считыватель магнитных карт</a>" data-price="18900" data-quantity="1" data-img="https://softgroup.kz/images/monitor/27.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
...
$res=mysqli_query($db,"SELECT * FROM schityvatel_magnit
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Продажа считывателя магнитных карт в Усть-Каменогорске</h3>
                    <hr>
                </div>
