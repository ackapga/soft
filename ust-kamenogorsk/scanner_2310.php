...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner2310
   ...
   else $res=mysqli_query($db,"insert into scanner2310 (date, theme_id, login, message, rating)
...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Стационарный сканер штрих кодов в Усть-Каменогорске | Купить лазерный стационарный сканер штрих кодов </title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="стационарный сканер штрих кодов, стационарный сканер штрих кодов 2d, стационарный сканер штрих кодов купить, стационарный сканер штрих кодов usb, лазерный стационарный сканер штрих кодов, Усть-Каменогорск, купить, цена, продажа."
        />
        <meta name="description" content="Купить стационарный сканер штрих кодов по низким ценам в Усть-Каменогорске. Широкий выбор высококачественных лазерных считывателей штрих кода от Softgroup">
        <!--//tags -->
                ...
                <div class="fond">
                    ...
                    <div id="box_2" class="mymagicoverbox_fenetre">
                        <div class="mymagicoverbox_fenetreinterieur">
                            <ul>
                                <li><a href="../aktau/scanner_9125.php">Актау</a></li>
                                <li><a href="../aktobe/scanner_9125.php">Актобе</a></li>
                                <li><a href="../scanner_9125.php">Алматы</a></li>
                                <li><a href="../atyrau/scanner_9125.php">Атырау</a></li>
                                <li><a href="../janaozen/scanner_9125.php">Жанаозен</a></li>
                                <li><a href="../jezkazgan/scanner_9125.php">Жезказган</a></li>
                                <li><a href="../karaganda/scanner_9125.php">Караганда</a></li>
                                <li><a href="../kokshetau/scanner_9125.php">Кокшетау</a></li>
                                <li><a href="../kostanai/scanner_9125.php">Костанай</a></li>
                                <li><a href="../kyzylorda/scanner_9125.php">Кызылорда</a></li>
                            </ul>
                            <ul class="dlya_left">
                                <li><a href="../astana/scanner_9125.php">Астана</a></li>
                                <li><a href="../pavlodar/scanner_9125.php">Павлодар</a></li>
                                <li><a href="../petropavlovsk/scanner_9125.php">Петропавловск</a></li>
                                <li><a href="../semei/scanner_9125.php">Семей</a></li>
                                <li><a href="../taldykorgan/scanner_9125.php">Талдыкорган</a></li>
                                <li><a href="../scanner_9125.php">Тараз</a></li>
                                <li><a href="../turkestan/scanner_9125.php">Туркестан</a></li>
                                <li><a href="../uralsk/scanner_9125.php">Уральск</a></li>
                                <li><a href="../ust-kamenogorsk/scanner_9125.php">Усть-Каменогорск</a></li>
                                <li><a href="../shymkent/scanner_9125.php">Шымкент</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                ...
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/2310/11.jpg">
                                    <div class="thumb-image"> <img src="../images/2310/11.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/2310/3wm.jpg">
                                    <div class="thumb-image"> <img src="../images/2310/3wm.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/2310/4wm.jpg">
                                    <div class="thumb-image"> <img src="../images/2310/4wm.jpg" id="target" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Стационарный сканер штрих кодов 2310</h1>
                    <hr>
                    <p class="code-products">Код товара: 4909</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">69 300 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p> Имиджевый сканер штрих кодов максимально удобен и эффективен в работе. Сканер предназначен для предприятий розничной торговли, желающих иметь недорогое и эстетичное сканирующее устройство. Также данный модель настольного сканера
                            легко справляется с большим потоком клиентов и может сканировать 3600 строк скана в минуту.

                        </p>
                        <br>
                        <h3><b>Вид стационарного сканера штрих кода:</b></h3>
                        <p><i class="fa fa-check"></i> По типу считывающего элемента – многоплоскостной</p>
                        <p><i class="fa fa-check"></i> По исполнению – настольный стационарный</p>
                        ...
                        <button id="fly" class="add_item" data-id="4909" data-title="<a href='https://softgroup.kz/scanner_2310.php'>Сканер штрих кода 2310</a>" data-price="69300" data-quantity="1" data-img="https://softgroup.kz/images/2310/11.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                    </div>
                </div>
            </div>
            <div class="clearfix"> </div>
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grids">
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/2310/1o.png" style="width: 40%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/2310/2o.png" style="width: 40%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/2310/3o.png" style="width: 40%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style=" padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/2310/2wm.jpg" style="width:  50%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; ">Чтение штрих-кодов</p>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/2310/ava1.png" style="width: 40%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Имиджевое сканирование</p>
                            <p style="line-height:normal; text-align: center;">Имиджевая разработка считывания разрешает узнавать маленькие или не четко печатанные коды. Сканер может декодировать символы высочайшей плотности (HD).</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            <td>Тип элемента сканирования: </td>
                            <td> 2D</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>Источник цвета:</td>
                            <td>имиджевый (оснащены CCD-матрицей высокого разрешения подобно видеокамерам или цифровым фотоаппаратам)</td>
                        </tr>
                        <tr>
                            <td>Глубина сканирование:</td>
                            <td> 0-150 мм для 13mil</td>
                        </tr>
                        <tr>
...
$res=mysqli_query($db,"SELECT * FROM scanner2310
        ...
        <div class="coupons">
            <div class="coupons-grids text-center">
                <div class="w3layouts_mail_grid">
                    <div class="models">
                        <h2>Причины купить стационарного сканера у нас:</h2>
                        <hr>
                    </div>
