...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors1170
   ...
   else $res=mysqli_query($db,"insert into dors1170 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детекторы банкнот инфракрасные Dors 1170D купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1170D, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1170D инфракрасные купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_1170.php">Актау</a></li>
                            <li><a href="../aktobe/dors_1170.php">Актобе</a></li>
                            <li><a href="../dors_1170.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_1170.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_1170.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_1170.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_1170.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_1170.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_1170.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_1170.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_1170.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_1170.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_1170.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_1170.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_1170.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_1170.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_1170.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_1170.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_1170.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_1170.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Инфракрасные детекторы банкнот DORS 1170D</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/6.jpg">
                                <div class="thumb-image"> <img src="../images/detector/6.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/66.jpg">
                                <div class="thumb-image"> <img src="../images/detector/66.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/666.jpg">
                                <div class="thumb-image"> <img src="../images/detector/666.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Инфракрасные детекторы банкнот DORS 1170D</h2>
                <hr>
                <p class="code-products">Код товара: 9006</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">86 380 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p> Универсальный просмотровый детектор. Позволяет практически мгновенно определить подлинность и осуществить экспертную оценку банкнот по комплексу защитных признаков. Способен выявить любые поддельные банкноты, в том числе самого высокого качества. </p>
                    <p>• комплексная проверка банкноты осуществляется за несколько секунд;
                        <br>• большой 7-ми дюймовый дисплей высоко четкости делает процесс проверки на подлинность быстрым и удобным;
                        <br>• простое управление осуществляется с помощью только 1 кнопки;
                        <br>• инфракрасная камера располагается так, что захватывает большую область перед прибором, благодаря чему кассир может проверить банкноты, расположенные веером.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_1170.php'>Инфракрасные детекторы банкнот DORS 1170D</a>" data-price="86380" data-quantity="1" data-img="https://softgroup.kz/images/detector/6.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Инфракрасный контроль,
                            Контроль «спецэлемента М» Интеллектуальный Антистокс-контроль,
                            Ультрафиолетовый контроль,
                            Контроль в белом отраженном свете;</td>
                    </tr>
                    <tr>
                        <td>Монитор:</td>
                        <td>цветной, диагональ 7”дюймов (18 см)</td>
                    </tr>
                    <tr>
                        <td>Встроенные видеокамеры:</td>
                        <td>2 шт. (1х, 10х) Видеовыход есть </td>
                    </tr>
                    <tr>

                        <td>Потребляемая мощность: </td>
                        <td> не более 10 Вт</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры (ШхГхВ):</td>
                        <td>122х111х245 мм</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM dors1170
