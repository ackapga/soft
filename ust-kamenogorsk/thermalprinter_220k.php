...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into thermalprinter220
   ...
   else $res=mysqli_query($db,"insert into thermalprinter220 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Принтер для печати чеков купить в Усть-Каменогорске - Доступные цены на принтеры чеков </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="принтер для печати чеков, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Купить принтер для печати чеков в Усть-Каменогорске по доступным ценам. Осуществляем продажу принтера чеков для магазина в широком ассортименте от Softgroup">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/thermalprinter_220k.php">Актау</a></li>
                            <li><a href="../aktobe/thermalprinter_220k.php">Актобе</a></li>
                            <li><a href="../thermalprinter_220k.php">Алматы</a></li>
                            <li><a href="../atyrau/thermalprinter_220k.php">Атырау</a></li>
                            <li><a href="../janaozen/thermalprinter_220k.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/thermalprinter_220k.php">Жезказган</a></li>
                            <li><a href="../karaganda/thermalprinter_220k.php">Караганда</a></li>
                            <li><a href="../kokshetau/thermalprinter_220k.php">Кокшетау</a></li>
                            <li><a href="../kostanai/thermalprinter_220k.php">Костанай</a></li>
                            <li><a href="../kyzylorda/thermalprinter_220k.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/thermalprinter_220k.php">Астана</a></li>
                            <li><a href="../pavlodar/thermalprinter_220k.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/thermalprinter_220k.php">Петропавловск</a></li>
                            <li><a href="../semei/thermalprinter_220k.php">Семей</a></li>
                            <li><a href="../taldykorgan/thermalprinter_220k.php">Талдыкорган</a></li>
                            <li><a href="../taraz/thermalprinter_220k.php">Тараз</a></li>
                            <li><a href="../turkestan/thermalprinter_220k.php">Туркестан</a></li>
                            <li><a href="../uralsk/thermalprinter_220k.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/thermalprinter_220k.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/thermalprinter_220k.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/thermalprinter/6.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/6.jpg" id="target" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Принтер для печати чеков 220K</h1>
                <hr>
                <p class="code-products">Код товара: 3008</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">38 900 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Принтер для печати чеков 220K</b> предназначен для печати на термоленте шириной 76мм с высоким качественным разрешением. Термопринтер чеков успешно используется в крупных торговых сетях, гостиницах и ресторанах, интернет-магазинах с большим потоком клиентов.</p>
                    ...
                    <button id="fly" class="add_item" data-id="15" data-title="<a href='https://softgroup.kz/thermalprinter_220k.php'>Принтер чеков 220K</a>" data-price="38900" data-quantity="1" data-img="https://softgroup.kz/images/thermalprinter/6.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/thermalprinter/80_4.png"></div>
                    <div class="wthree_text_info">
                        <h2>Высокая скорость печати принтера чеков</h2>
                    </div>
                    <p style="line-height:normal">Принтер чеков с автоотрезчиком печатает чеки на термобумаге шириной до 76 миллиметров со скоростью 4,5 линии/сек. Данное устройство отличается эргономичным дизайном и простотой в эксплуатации.</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM thermalprinter220
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить принтера для печати чеков у нас:</h3>
                    <hr>
                </div>
