...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner10t2d
   ...
   else $res=mysqli_query($db,"insert into scanner10t2d (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Cканер QR и штрих-кодов в Усть-Каменогорске | Купить Сканер ручной для QR кодов</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="сканер штрих кода, сканер qr кода, для кассы, для магазина, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Высококачественный имиджевый сканер QR и штрих-кодов в Усть-Каменогорске по доступным ценам. Осуществляем продажу сканеров штрих кода от Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scanner_10t_2d.php">Актау</a></li>
                            <li><a href="../aktobe/scanner_10t_2d.php">Актобе</a></li>
                            <li><a href="../scanner_10t_2d.php">Алматы</a></li>
                            <li><a href="../atyrau/scanner_10t_2d.php">Атырау</a></li>
                            <li><a href="../janaozen/scanner_10t_2d.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scanner_10t_2d.php">Жезказган</a></li>
                            <li><a href="../karaganda/scanner_10t_2d.php">Караганда</a></li>
                            <li><a href="../kokshetau/scanner_10t_2d.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scanner_10t_2d.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scanner_10t_2d.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scanner_10t_2d.php">Астана</a></li>
                            <li><a href="../pavlodar/scanner_10t_2d.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scanner_10t_2d.php">Петропавловск</a></li>
                            <li><a href="../semei/scanner_10t_2d.php">Семей</a></li>
                            <li><a href="../taldykorgan/scanner_10t_2d.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scanner_10t_2d.php">Тараз</a></li>
                            <li><a href="../turkestan/scanner_10t_2d.php">Туркестан</a></li>
                            <li><a href="../uralsk/scanner_10t_2d.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scanner_10t_2d.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scanner_10t_2d.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scanner/9.png">
                                <div class="thumb-image"> <img src="../images/scanner/9.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/99.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/99.jpg" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Cканер QR и штрих-кодов 10T-2D</h1>
                <hr>
                <p class="code-products">Код товара: 2005</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">23 940 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Cканер QR и штрих-кодов 10T- с 2D режимом считывания, сканирует любые штрих-коды: с экрана монитора, смартфона, а также считывает QR-коды. Применяется в розничной торговли, легкой промышленности, документообороте, а также в сфере банковских и коммунальных услуг.
                    </p>
                    <br>
                    <h3><b>Вид сканера QR и штрих-кодов:</b></h3>
                    <p><i class="fa fa-check"></i> По типу считывающего элемента – имиджевый (image сканер)</p>
                    <p><i class="fa fa-check"></i> По исполнению – ручной</p>
                    ...
                    <button id="fly" class="add_item" data-id="25" data-title="<a href='https://softgroup.kz/scanner_10t_2d.php'>Сканер штрих кода 10T-2D</a>" data-price="23940" data-quantity="1" data-img="https://softgroup.kz/images/scanner/9.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scanner/shtrih4.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0">Считывание штрих-кодов</p>
                ...
                <div class="bootstrap-tab-text-grid">
                    <div class="container">
                        <div style="text-align:center; margin-top:20px">
                            <img src="../images/scanner/qr.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0">Считывание QR кодов</p>
                        <p style="line-height:normal">Сканеры штрих кодов способны считывать и распознавать QR коды. Эти штрих-коды с каждым днем все больше и больше используются в различных сферах деятельности, что подтверждает их востребованность. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:30px; margin-top:20px;">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scanner/tablet.png" style="text-align:center; "></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Cчитывание штрих-кодов и QR-кодов с экрана</p>
                        <p style="line-height:normal">Сканер может безошибочно декодировать штрихкоды с любых отражающих поверхностей, включая сканирование с экрана мобильного телефона или монитора компьютера. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
            </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>вручную/непрерывно</td>
                    </tr>
                    <tr>

                        <td>Стандартное разрешение:</td>
                        <td>2500</td>
                    </tr>
                    <tr>

                        <td>Расстояние считывания:</td>
                        <td> от 10 до 1500 мм</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> (от 622 до 628 нм)</td>
                    </tr>
                    <tr>

                        <td>Чтение наклонности:</td>
                        <td>65 °-60 °</td>
                    </tr>
                    <tr>

                        <td>Вид сканирования: </td>
                        <td>Штрих-код, QR-код</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scanner10t2d
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h2>Причины купить сканера QR и штрих-кодов у нас:</h2>
                    <hr>
                </div>
