...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors1300
   ...
   else $res=mysqli_query($db,"insert into dors1300 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детектор банкнот инфракрасный Dors 1000 M3 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1300, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1300 инфракрасные купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_1300.php">Актау</a></li>
                            <li><a href="../aktobe/dors_1300.php">Актобе</a></li>
                            <li><a href="../dors_1300.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_1300.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_1300.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_1300.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_1300.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_1300.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_1300.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_1300.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_1300.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_1300.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_1300.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_1300.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_1300.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_1300.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_1300.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_1300.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_1300.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_1300.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детектор банкнот инфракрасный</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li><a href="detector.html">Детекторы банкнот</a><i>/</i></li>
                        <li>Инфракрасные детекторы банкнот DORS 1300</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/9.jpg">
                                <div class="thumb-image"> <img src="../images/detector/9.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/99.jpg">
                                <div class="thumb-image"> <img src="../images/detector/99.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/999.jpg">
                                <div class="thumb-image"> <img src="../images/detector/999.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Инфракрасные детекторы банкнот DORS 1300</h2>
                <hr>
                <p class="code-products">Код товара: 9009</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price"> 148 482 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p> Универсальный просмотровый детектор "DORS 1300" - одна из последних технических новинок в области проверки подлинности купюр и других защищенных от подделки документов. юбой режим контроля может быть активирован одним нажатием соответствующей клавиши на передней панели. При этом высокое качество визуализации элементов защиты, широкие функциональные и коммутационные возможности позволяют использовать DORS 1300 M2 в работе профессиональных экспертов различной специализации. </p>
                    <p>Отличительной особенностью модели Dors M2 является наличие:
                        <br>• модуля детекции антистоксовских меток (для контроля «спецэлементов И»);
                        <br>• датчика детекции магнитных меток;
                        <br>• 20-кратного объектива на второй встроенной видеокамере.
                    </p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_1300.php'>Инфракрасные детекторы банкнот DORS 1300</a>" data-price="148482" data-quantity="1" data-img="https://softgroup.kz/images/detector/9.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Виды контроля:</td>
                        <td>Инфракрасный контроль
                            Контроль «спецэлементов М»
                            Интеллектуальный Антистокс-контроль
                            Ультрафиолетовый контроль
                            Инфракрасный контроль на просвет
                            Магнитный контроль
                            Контроль в белом отраженном верхнем свете
                            Контроль в белом отраженном косопадающем свете
                            Контроль в белом отраженном свете с увеличением
                            Контроль в белом проходящем свете
                            Геометрический контроль;</td>
                    </tr>
                    <tr>
                        <td>Монитор:</td>
                        <td>цветной, поворотный в двух плокостях, диагональ 7”дюймов (18 см)</td>
                    </tr>
                    <tr>
                        <td>Встроенные видеокамеры:</td>
                        <td>2 шт. (1х, 20х). </td>
                    </tr>
                    <tr>
                        <td>Верхняя подсветка:</td>
                        <td> многодиапазонная ИК (ИК-светодиоды, 800–1000 нм), 3 УФ-лампы 6 Вт (365 нм),2 верхняя белая (светодиоды ДС), 2 косопадающая белая (светодиод ДС) </td>
                    </tr>
                    <tr>
                        <td>Нижняя подсветка: </td>
                        <td>белая лампа 6 Вт</td>
                    </tr>
                    <tr>
                        <td>Измерительная линейка: </td>
                        <td>на матовом стекле предметного стола
                            Подключение дополнительных устройств: DORS 1010 и DORS 1020, DORS 10 и DORS 15</td>
                    </tr>
                    <tr>

                        <td>Потребляемая мощность: </td>
                        <td> не более 45 Вт</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры (ШхГхВ):</td>
                        <td>300х170х324 мм</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM dors1300
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить детектора банкнот у нас</h3>
                    <hr>
                </div>
