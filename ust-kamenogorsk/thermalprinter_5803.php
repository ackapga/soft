...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into thermalprinter5803
   ...
   else $res=mysqli_query($db,"insert into thermalprinter5803 (date, theme_id, login, message, rating)
...
<title>Термопринтер чеков в Усть-Каменогорске - Pos терминалы</title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="принтер чеков, кассовый аппарат, кассовое оборудование, кассовый терминал, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
<meta name="description" content="Термопринтер 58 мм для печати чеков совместим с любым програмным обеспечением. Купить термопринтер чеков в Усть-Каменогорске.">
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
	     ...
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/thermalprinter/8.jpg">
							<div class="thumb-image"> <img src="../images/thermalprinter/8.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/thermalprinter/88.jpg">
							<div class="thumb-image"> <img src="../images/thermalprinter/88.jpg"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/thermalprinter/888.jpg">
							<div class="thumb-image"> <img src="../images/thermalprinter/888.jpg"  class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Термопринтер 5803</h3>
					<hr>
					<p class="code-products">Код товара: 3008</p>
					<p><span class="item_price">37 600  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p><b>Термопринтер чеков</b> 5803 печатает чеки на термобумаге шириной 58 миллиметров со скоростью 90 миллиметров за секунду. Принтер чеков 5803 совместим с большинством распространённого программного обеспечения и отлично впишется в малый или средний бизнес.</p>
					...
					<button id ="fly" class="add_item" data-id="17" data-title="<a href='thermalprinter_5803.php'>Принтер чеков 5803</a>"  data-price="37600" data-quantity="1" data-img="../images/thermalprinter/8.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
		      </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
						...
						<div class="tab2">
							...
							<div class="single_page_agile_its_w3ls">
								<div class="bootstrap-tab-text-grids">
									...
									<img src="../images/thermalprinter/8888.jpg">
										<div class="clearfix"> </div>
						             </div>
...
$res=mysqli_query($db,"SELECT * FROM thermalprinter5803
