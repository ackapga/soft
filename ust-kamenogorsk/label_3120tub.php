        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Принтер этикеток 3120TUB</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/3120TUB/1.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TUB/1.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3120TUB/2.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TUB/2.jpg" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3120TUB/4.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TUB/4.jpg" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Принтер этикеток 3120TUB</h1>
                    <hr>
                    <p class="code-products">Код товара: 4939</p>
                    ...
                    <div class="description">
                        <p>Высокопроизводительный принтер 3120TUB со скоростью 127 мм/сек с разрешением 203 dpi имеет превосходные технические характеристики для печати этикеток шириной 76 мм. Данный принетер является безупречным решением для организации
                        ...
                        <button id="fly" class="add_item" data-id="4939" data-title="<a href='https://softgroup.kz/label_3120tub.php'>Принтер этикеток 3120TUB</a>" data-price="33390" data-quantity="1" data-img="https://softgroup.kz/images/3120TUB/1.jpg><i class=" fa fa-shopping-cart
            ...
            <div class="responsive_tabs_agileits ">
                <div class="bootstrap-tab-text-grid " style="background-color: #e5f6f8; padding-bottom:40px ">
                    <div class="container ">
                        ...
                        <div style="text-align:center; margin-top:0px ">
                            <img src="../images/3120TUB/tel.png " style="text-align:center; width: 65%; "></div>
                        <div class="wthree_text_info ">
                            <h2>Высокая скорость печати принтера этикеток</h2>
                        </div>
                        <p style="line-height:normal ">Принтер этикеток позволяет печатать на ленте шириной от 23 до 80мм, скорость печати принтера составляет 127мм/сек, разрешение печати - 203dpi</p>
                ...
                <div class="bootstrap-tab-text-grid " style="padding-bottom:20px ">
                    <div class="container ">
                        <div style="text-align:center; margin-top:0px ">
                            <img src="../images/3120TUB/usb.png " style="text-align:center; width: 45%; "></div>
                ...
                <div class="bootstrap-tab-text-grid " style=" background-color: #e5f6f8; padding-bottom:20px ">
                    <div class="container ">
                        <div style="text-align:center; margin-top:10px ">
                            <img src="../images/3120TUB/structure.png ">
                            <img style="width: 20%; " src="../images/3120TUC/auto.webp "></div>
