...
<head>
    ...
    <title>Системный блок Core i7 || Системные блоки от Softgroup</title>
    <!--/tags -->
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/block-sistemy/block-4/ava.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-4/ava.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/block-sistemy/block-4/2.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-4/2.png" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/block-sistemy/block-4/3.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-4/3.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Системный блок Core i7</h1>
                <hr>
                <!-- <p class="code-products">Код товара: 4491</p> -->
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">236 400 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>
                        Системный блок с корпусом X-Game XC-370 имеет процессор Intel Сore i7-9700. В качестве материнской платы используется Gigabyte H310M H, Socket LGA1151 с усиленной системой питания. В комплект с блоком входит охлаждающий кулер DeepCool Gammaxx200. Оперативная
                        память состовляет 4GB. Твердотельный Накопитель SSD обладает емкостью 240 Гб.
                    </p>
                    <br>
                    ...
                    <p><i class="fa fa-check"></i> Охлаждающий Кулер: DeepCool Gammaxx200T, обор./мин.: 1600, коннектор: 4 pin;</p>
                    <div><button id="fly" class="add_item" data-id="7894" data-title="<a href='https://softgroup.kz/Sistemnyy-blok-Core-i7.php'>Системный блок Core i7</a>" data-price="236400" data-quantity="1" data-img="https://softgroup.kz/images/block-sistemy/block-4/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Samsung DDR4 4GB х 2шт, 2666 МГц</td>
                    </tr>
                    <tr>
                        <td>Блок Питания:</td>
                        <td>GameMax 500W</td>
