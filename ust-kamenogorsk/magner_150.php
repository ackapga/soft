...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into magner150
   ...
   else $res=mysqli_query($db,"insert into magner150 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот графический Magner 150 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, графические, Magner, 150, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот графические Magner 150 купить в Усть-Каменогорске по низким ценам. Огромный выбор счетчиков для банкнот от компании Softgroup">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/magner_150.php">Актау</a></li>
                            <li><a href="../aktobe/magner_150.php">Актобе</a></li>
                            <li><a href="../magner_150.php">Алматы</a></li>
                            <li><a href="../atyrau/magner_150.php">Атырау</a></li>
                            <li><a href="../janaozen/magner_150.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/magner_150.php">Жезказган</a></li>
                            <li><a href="../karaganda/magner_150.php">Караганда</a></li>
                            <li><a href="../kokshetau/magner_150.php">Кокшетау</a></li>
                            <li><a href="../kostanai/magner_150.php">Костанай</a></li>
                            <li><a href="../kyzylorda/magner_150.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/magner_150.php">Астана</a></li>
                            <li><a href="../pavlodar/magner_150.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/magner_150.php">Петропавловск</a></li>
                            <li><a href="../semei/magner_150.php">Семей</a></li>
                            <li><a href="../taldykorgan/magner_150.php">Талдыкорган</a></li>
                            <li><a href="../taraz/magner_150.php">Тараз</a></li>
                            <li><a href="../turkestan/magner_150.php">Туркестан</a></li>
                            <li><a href="../uralsk/magner_150.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/magner_150.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/magner_150.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Счетчик банкнот графический Magner</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики банкнот графические Magner 150</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/10.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/10.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/101.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/101.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/1011.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/1011.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот графические Magner 150</h2>
                <hr>
                <p class="code-products">Код товара: 8010</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">767 000 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Профессиональный двухкарманный счетчик банкнот Magner 150 Digital — самая популярная модель среди устройств своего уровня. Аппарат обеспечивает надежные пересчет, сортировку и детекцию на подлинность тенге, долларов США и евро.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/magner_150.php'>Счетчики банкнот графические Magner 150</a>" data-price="767000" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/10.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Дисплей: </td>
                        <td>графический ЖК-дисплей 3,1”, разрешение 192х128 пикс.</td>
                    </tr>
                    <tr>
                        <td>Скорость счета, банкнот в минуту:</td>
                        <td>400, 1000, 1500 банкнот в минуту</td>
                    </tr>
                    <tr>
                        <td>Размеры пересчитываемых банкнот:</td>
                        <td>мин. 90x60 мм; макс. 180x100 мм; толщина — 0,08 - 0,12 мм</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Детекция:</td>
                        <td>цифровая ИК, цифровая оптическая, многоэлемент-
                            ная линейка магнитных датчиков, 2 группы УФ дат-
                            чиков, оптическая плотность, по размеру</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Опции:</td>
                        <td>выносной дисплей, чековый термопринтер, подключение к ПК / ноутбуку*, система видеонаблюдения ЧЕКТВ БАНК, Трассир</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM magner150
