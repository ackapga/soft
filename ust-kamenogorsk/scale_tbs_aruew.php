...
<head>
    ...
    <meta name="description" content="Напольные весы ТВ-S_A RUEW со стойкой купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
        ...
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы товарные ТВ-S_A(RUEW)3</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/70.jpg">
                                <div class="thumb-image"> <img src="../images/scale/70.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/707.jpg">
                                <div class="thumb-image"> <img src="../images/scale/707.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/7077.jpg">
                                <div class="thumb-image"> <img src="../images/scale/7077.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <div class="description">
                    <p>Напольные товарные весы с вертикальной стойкой. Жидкокристаллический индикатор с подсветкой. Встроенный аккумулятор обеспечивает автономную работу весов до 15 часов. Счетный режим. Дозаторный режим. Взвешивание тушь. Весы легко интегрируются в системы учета. Обмен информацией с внешними устройствами реализован по интерфейсам RS-232, USB, Ethernet и Wi-Fi.</p>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg14.png"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> - кронштейн крепления терминала на стене - 1шт, кронштейн крепления терминала на стойке - 2шт, сетевой адаптер- 1 шт., кабель переходной 4D - 1шт;</td>
                    </tr>
