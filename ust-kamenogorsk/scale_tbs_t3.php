...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scaletbst3
   ...
   else $res=mysqli_query($db,"insert into scaletbst3 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы ТВ-S_T3 купить в Усть-Каменогорске | Товарные напольные весы</title>
    <!--/tags -->
    ...
    <meta name="description" content="Весы ТВ-S_T3 купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные товарные напольные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_tbs_t3.php">Актау</a></li>
                            <li><a href="../aktobe/scale_tbs_t3.php">Актобе</a></li>
                            <li><a href="../scale_tbs_t3.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_tbs_t3.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_tbs_t3.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_tbs_t3.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_tbs_t3.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_tbs_t3.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_tbs_t3.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_tbs_t3.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_tbs_t3.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_tbs_t3.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_tbs_t3.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_tbs_t3.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_tbs_t3.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_tbs_t3.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_tbs_t3.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_tbs_t3.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_tbs_t3.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_tbs_t3.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы торговые TB-S_T3 (платформа+терминал)</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/9.jpg">
                                <div class="thumb-image"> <img src="../images/scale/9.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/99.jpg">
                                <div class="thumb-image"> <img src="../images/scale/99.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <div class="description">
                    <p>Напольные товарные весы с вертикальной стойкой. Поддерживаются возможности расчета стоимости штучных товаров, суммирования стоимости покупки и расчета сдачи. Память на 16 значений цены товара. Встроенный аккумулятор обеспечивает автономную работу весов до 115 часов. Обмен информацией с внешними устройствами реализован по интерфейсу RS-232.</p>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg12.png"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>- платформа нержавеющая сталь<br>
                            - рама алюминиевый сплав;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Габаритные размеры весов модуля ( (ШхГхВ):</td>
                        <td>520x395х765мм;</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scaletbst3
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить весы Масса-К у нас</h3>
                    <hr>
                </div>
