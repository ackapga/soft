...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner2306
   ...
   else $res=mysqli_query($db,"insert into scanner2306 (date, theme_id, login, message, rating)
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                ...
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/2306/1.jpg">
                                    <div class="thumb-image"> <img src="../images/2306/1.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/2306/6.png">
                                    <div class="thumb-image"> <img src="../images/2306/6.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/2306/7.jpg">
                                    <div class="thumb-image"> <img src="../images/2306/7.jpg" id="target" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Стационарный сканер штрих кодов 2306</h1>
                    <hr>
                    <p class="code-products">Код товара: 4907</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">35 280 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Стационарный сканер штрих кода 2306 настольного типа использует несколько десятков лазерных лучей. Благодаря этой функции кассиру не требуется специальным образом ориентировать штрих-код перед сканером, одна из сканирующих линий
                            обязательно его пересечёт в любом положении.
                        </p>
                        <br>
                        <h3><b>Вид стационарного сканера штрих кода:</b></h3>
                        <p><i class="fa fa-check"></i> По типу считывающего элемента – имиджевый</p>
                        ...
                        <button id="fly" class="add_item" data-id="4907 " data-title="<a href='https://softgroup.kz/scanner_2306.php'>Сканер штрих кода 2306</a>" data-price="35280" data-quantity="1" data-img="https://softgroup.kz/images/scanner/20.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                    </div>
                </div>
            </div>
            <div class="clearfix"> </div>
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grids">
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        ...
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/2306/1o.png" style="width: 40%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/2306/2o.png" style="width: 40%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/2306/3o.png" style="width: 40%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">QR сканирование</p>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/2306/4.png" style="width: 40%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Режимы сканирование</p>
                            <p style="line-height:normal; text-align: center;">В верхней части сканера имеется светодиодная подсветка для регулировки режима сканирования.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/2306/5.png" style="width: 40%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0">Особенности сканера</p>
                            <p style="line-height:normal; text-align: center;">Этот тип сканера издает звуковой сигнал при считываний, а также имеет противоскользящие накладки для удобство. </p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                </div>
...
$res=mysqli_query($db,"SELECT * FROM scanner2306
