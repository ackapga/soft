...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors125
   ...
   else $res=mysqli_query($db,"insert into dors125 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детектор банкнот ультрафиолетовый Dors купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors ультрафиолетовые купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_125.php">Актау</a></li>
                            <li><a href="../aktobe/dors_125.php">Актобе</a></li>
                            <li><a href="../dors_125.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_125.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_125.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_125.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_125.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_125.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_125.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_125.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_125.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_125.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_125.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_125.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_125.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_125.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_125.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_125.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_125.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_125.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детектор банкнот ультрафиолетовый</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Ультрафиолетовые детекторы банкнот DORS</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/3.jpg">
                                <div class="thumb-image"> <img src="../images/detector/3.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/33.jpg">
                                <div class="thumb-image"> <img src="../images/detector/33.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/333.png">
                                <div class="thumb-image"> <img src="../images/detector/333.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Ультрафиолетовые детекторы банкнот DORS</h2>
                <hr>
                <p class="code-products">Код товара: 9003</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">8 639 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Ультрафиолетовый просмотровый детектор DORS предназначен для визуального контроля подлинности банкнот различных валют, ценных бумаг, документов строгого учета на защищенных бланках, документов удостоверяющих личность и другой защищенной полиграфической продукции несколькими методами.</p>
                    <p>• мощный источник ультрафиолетового света (суммарная мощность 12 Вт);
                        <br>• щель в задней стенке корпуса для удобного контроля документов больших форматов;
                        <br>• новый отказоустойчивый электронный балласт, обеспечивающий высокую эффективность и надежность работы люминесцентных ламп;
                        <br>• широкое просветное поле с измерительной линейкой для удобного контроля в белом проходящем свете. </p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_125.php'>Ультрафиолетовые детекторы банкнот DORS</a>" data-price="8639" data-quantity="1" data-img="https://softgroup.kz/images/detector/3.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
...
$res=mysqli_query($db,"SELECT * FROM dors125
