...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into magner35
   ...
   else $res=mysqli_query($db,"insert into magner35 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот светодиодные Magner 35S купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, светодиодные, magner алматы, 35S, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот светодиодные Magner 35S купить в Усть-Каменогорске по низким ценам. Огромный выбор счетчиков для банкнот от компании Softgroup">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/magner_35.php">Актау</a></li>
                            <li><a href="../aktobe/magner_35.php">Актобе</a></li>
                            <li><a href="../magner_35.php">Алматы</a></li>
                            <li><a href="../atyrau/magner_35.php">Атырау</a></li>
                            <li><a href="../janaozen/magner_35.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/magner_35.php">Жезказган</a></li>
                            <li><a href="../karaganda/magner_35.php">Караганда</a></li>
                            <li><a href="../kokshetau/magner_35.php">Кокшетау</a></li>
                            <li><a href="../kostanai/magner_35.php">Костанай</a></li>
                            <li><a href="../kyzylorda/magner_35.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/magner_35.php">Астана</a></li>
                            <li><a href="../pavlodar/magner_35.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/magner_35.php">Петропавловск</a></li>
                            <li><a href="../semei/magner_35.php">Семей</a></li>
                            <li><a href="../taldykorgan/magner_35.php">Талдыкорган</a></li>
                            <li><a href="../taraz/magner_35.php">Тараз</a></li>
                            <li><a href="../turkestan/magner_35.php">Туркестан</a></li>
                            <li><a href="../uralsk/magner_35.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/magner_35.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/magner_35.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Счетчик банкнот светодиодные Magner</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики банкнот светодиодные Magner 35S</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/6.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/6.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/66.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/66.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/666.png">
                                <div class="thumb-image"> <img src="../images/schetchiki/666.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот светодиодные Magner 35S</h2>
                <hr>
                <p class="code-products">Код товара: 8006</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">246 239 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Отсутствие широкого набора дополнительных функций обеспечивает счетчику банкнот Magner 35 S невысокую стоимость, сочетающуюся с отличными техническими характеристиками прибора.
                        <br>• Переключение ручного или автоматического старта;
                        <br>• Установка одного из 7 уровней плотности для работы с различными банкнотами: от новых и чистых до ветхих и загрязненных;
                        <br>• Простой пересчет;
                        <br>• Отсчет фиксированного количества банкнот (пачка);
                        <br>• Остановка счетчика Magner 35S с указанием кода конкретной ошибки в случае обнаружения слипшихся, очень загрязненных, сложенных банкнот или половины от банкноты.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/magner_35.php'>Счетчики банкнот светодиодные Magner 35S</a>" data-price="246239" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/6.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <img src="../images/schetchiki/6666.jpg">

            <div>
                <p style="line-height:normal; margin-top:0.5em;">• В Magner 35 S предусмотрена функция, позволяющая оператору устанавливать <b>ограничение плотности банкнот,</b> также позволяющее работать с купюрами различной интенсивности окраски (светлые и темные). В какой-то степени возможность регулировки уровня плотности банкноты можно считать базовым уровнем детекции подлинности, позволяющим отсеять банкноты, плотность которых не соответствует заданной (возможно, поддельные).
                    <br><b>• Трехскоростной режим счета</b> у счетчика банкнот Magner 35S (500, 1000 и 1300 банкнот/мин.) позволяет оператору производить точный подсчет ветхих банкнот (500 банкнот/мин.), а также работать с максимальной производительностью при пересчете новых (1300 банкнот/мин.). Простота управления и непритязательность в уходе характерны для счетчиков банкнот Magner 35S. </p>
            </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Дисплей: </td>
                        <td>светодиодный, зеленого свечения</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Размеры пересчитываемых банкнот:</td>
                        <td>мин. 100х50 мм; макс. 180х95 мм; толщина – 0,05 - 0,2 мм</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Механизм подачи банкнот:</td>
                        <td>роликовый, фрикционного типа</td>
                    </tr>

                    <tr>

                        <td>Оптические элементы:</td>
                        <td> Самоочищающиеся датчики</td>
                    </tr>
                    <tr>

                        <td>Детекция: </td>
                        <td>по длине, по оптической плотности</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM magner35
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить светодиодный счетчик банкнот у нас</h3>
                    <hr>
                </div>
