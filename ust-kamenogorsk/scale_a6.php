...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalea6
   ...
   else $res=mysqli_query($db,"insert into scalea6 (date, theme_id, login, message, rating)
...
<title>Настольные электронные торговые весы купить в Усть-Каменогорске - Pos терминалы</title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Настольные весы, торговые весы, электронные весы, для взвешивания, с печатью этикеток, с принтером этикеток, для магазинов, супермаркетов, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
	     ...
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/scale/2.jpg">
							<div class="thumb-image"> <img src="../images/scale/2.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Весы электронные A6</h3>
					<hr>
					<p class="code-products">Код товара: 5002</p>
					<p><span class="item_price">224 990  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p><b>Весы электронные настольные торговые</b> позволяют высокоэффективно и надежно производить операции по взвешиванию на оптово-розничных предприятиях, в супермаркетах, гипермаркетах и обычных магазинах.</p>
					...
					<button id ="fly" class="add_item" data-id="28" data-title="<a href='scale_a6.php'>Весы электронные A6</a>"  data-price="224990" data-quantity="1" data-img="../images/scale/2.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
		      </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
	...
	<tr>
		...
		<tr>
            ...
            <td>Дисплей:</td>
            <td>вес (5 символ), цена за ед.изм (5 символ), итог (6 символ) </td>
        </tr>
		<tr>
...
$res=mysqli_query($db,"SELECT * FROM scalea6
