...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalemkr2p10
   ...
   else $res=mysqli_query($db,"insert into scalemkr2p10 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы с печатью этикеток МК_R2P10-1 купить в Усть-Каменогорске от компании Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы с печатью этикеток, масса к, электронные, МК_R2P10-1, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Электронные весы с печатью этикеток купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_mk_r2p_10.php">Актау</a></li>
                            <li><a href="../aktobe/scale_mk_r2p_10.php">Актобе</a></li>
                            <li><a href="../scale_mk_r2p_10.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_mk_r2p_10.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_mk_r2p_10.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_mk_r2p_10.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_mk_r2p_10.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_mk_r2p_10.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_mk_r2p_10.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_mk_r2p_10.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_mk_r2p_10.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_mk_r2p_10.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_mk_r2p_10.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_mk_r2p_10.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_mk_r2p_10.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_mk_r2p_10.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_mk_r2p_10.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_mk_r2p_10.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_mk_r2p_10.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_mk_r2p_10.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы торговые с печатью этикеток МК_R2P10-1</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/20.jpg">
                                <div class="thumb-image"> <img src="../images/scale/20.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/202.jpg">
                                <div class="thumb-image"> <img src="../images/scale/202.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/2022.jpg">
                                <div class="thumb-image"> <img src="../images/scale/2022.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <div class="description">
                    <p>Весы с устройством подмотки конца ленты предназначены для маркировки и учета весовых, штучных и счетных товаров за прилавком. Весы печатают как простые этикетки с автоматически настраиваемым форматом, так и этикетки любой сложности. Весы поддерживают печать 8 форматов штрихкодов. Память на 20 000 товаров. Регистрируют товароучетные операции (продажа, прием, отпуск, списание, инвентаризация). Легко интегрируются в системы учета, в том числе в режиме весового терминала сбора данных. Обеспечена возможность подключения к весам сканера штрихкодов и выносного промышленного индикатора. Обмен информацией с внешними устройствами реализован по интерфейсам Ethernet и RS-232, а также с помощью USB-flash накопителя.</p>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg3.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/scale/p3.png" style="text-align:center; margin-top:20px"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/icon1.png" style="text-align:center; margin-top:20px"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Степень защиты платформы:</td>
                        <td> IP68;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Ширина рулона с чековой лентой: </td>
                        <td>58мм; </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> USB тип А, DB9-MА/вилка (интерфейс RS-232), TJ1A-4P4C;</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scalemkr2p10
