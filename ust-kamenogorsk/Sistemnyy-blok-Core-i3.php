...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into computers
   ...
   else $res=mysqli_query($db,"insert into computers (date, theme_id, login, message, rating)
...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Системный блок Core i3 || Системные блоки от Softgroup</title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content=" купить системный блок, AMD, CORE, купить, Усть-Каменогорск, цена, продажа." />
        <meta name="description" content="Купить Системный блок  в Усть-Каменогорске по низким ценам. Осуществляем продажу игровых системных блоков.">
        <!--//tags -->
        ...
        <div class="header-bot" id="home">
            ...
            <div class="header-bot_inner_wthreeinfo_header_mid">
                <div class="fond">
                    ...
                    <div iddiv="box_2" class="mymagicoverbox"> <i class="fa fa-map-marker" aria-hidden="true"></i> Усть-Каменогорск<i class="fa fa-caret-down " aria-hidden="true"></i> </div>
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li><a href="Komputery-i-komplektuyushchiye.html">Компьютеры и комплектующие</a><i>/</i></li>
                            <li><a href="Blok-sistemy.html">Блок системы</a><i>/</i></li>
                            <li>Системный блок Core i3</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/block-sistemy/block-2/ava.png">
                                    <div class="thumb-image"> <img src="../images/block-sistemy/block-2/ava.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/block-sistemy/block-2/2.png">
                                    <div class="thumb-image"> <img src="../images/block-sistemy/block-2/2.png" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/block-sistemy/block-2/3.png">
                                    <div class="thumb-image"> <img src="../images/block-sistemy/block-2/3.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Системный блок Core i3</h1>
                    <hr>
                    <p class="code-products">Код товара: 3879</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">156 490 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Системный блок с корпусом X-Game XC-370 имеет процессор Intel Core i3-9100. В качестве материнской платы используется Gigabyte H310M H, Socket LGA1151 с усиленной системой питания. В комплект с блоком входит охлаждающий кулер DEEPCOOL
                            THETA20. Оперативная память состовляет 4GB. Жесткий диск системного блока обладает частотой вращения 7 200 об/мин и емкостью 500 Гб.
                        </p>
                        <br>
                        <h3><b>Системный блок состоит из:</b></h3>
                        <p><i class="fa fa-check"></i> Процессор: Intel Core i3-9100 (4 ядер, 4 потоков, ГГц: 3.6, 6 Мб Кэша);</p>
                        <p><i class="fa fa-check"></i> Материнская плата: Gigabyte H310M H, Socket LGA1151, Слоты: 2 x DDR4, SATA III: 4;</p>
                        <p><i class="fa fa-check"></i> Охлаждающий Кулер: DEEPCOOL THETA20, обор./мин.: 2200, коннектор: 3 pin</p>
                        <div><button id="fly" class="add_item" data-id="3879" data-title="<a href='https://softgroup.kz/Sistemnyy-blok-Core-i3.php'>Системный блок Core i3</a>" data-price="156490" data-quantity="1" data-img="https://softgroup.kz/images/block-sistemy/block-2/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grids">
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/block-sistemy/block-2/3.png" style="width: 30% !important;">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Процессор Intel Core i3-9100</p>
                            <p style="line-height:normal">Высокая производительность и эффективная работа компьютера для выполнения повседневных задач. Улучшенная продуктивность, бесперебойная потоковая трансляция и превосходные развлечения в формате HD с эффектом погружения, поддержка
                                полноэкранного изображения в формате 4K и панорамного видео.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:20px">
                        <div class="container">
                            ...
                            <div style="text-align:center; margin-top:0px">
                                <img src="../images/block-sistemy/block-2/plata.png" style="text-align:center; margin-top:20px; width: 50%">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Материнская плата</p>
                            <p style="line-height:normal">Благодаря Smart Fan 5 пользователи могут быть уверены в том, что их игровой ПК будет функционировать в наиболее благоприятном температурном режиме без ущерба для производительности. Благодаря термодатчикам, размещенным на материнской
                                плате, средствами Smart Fan 5 можно контролировать работу каждого вентилятора. Кроме того, Smart Fan 5 - это еще и большее количество гибридных разъемов для подключения вентиляторов, которые поддерживают режимы работы PWM
                                и Voltage, обеспечивая максимальное удобство обслуживания установленной жидкостной системы охлаждения. </p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:20px">
                        <div class="container">
                            ...
                            <div style="text-align:center;">
                                <img src="../images/block-sistemy/block-2/kuller.png" style="text-align:center; width: 40%; margin-top: 50px;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Охлаждающий Кулер </p>
                            <p style="line-height:normal">Процессорный кулер Theta 20 PWM от Deepcool предназначен для эффективного охлаждения процессоров Intel LGA 115X с разъемом до 95 Вт TDP. Благодаря направленному вниз потоку воздуха этот процессорный кулер также может отводить
                                тепло от вашей памяти и материнской платы для снижения общей температуры. Для дополнительной безопасности он использует заднюю панель, чтобы она была правильно установлена.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                        <div class="container">
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/block-sistemy/block-1/ozu.png" style="text-align:center; width: 30%;"></div>
                            <div class="wthree_text_info">
                                <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Оперативная память ОЗУ</p>
                            </div>
                            <p style="line-height:normal">DDR4 обеспечивает повышение производительности и пропускной способности до 50 процентов при одновременном снижении энергопотребления всей вычислительной среды. Это представляет собой значительное улучшение по сравнению с предыдущими
                                технологиями памяти и экономию энергии до 40 процентов</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                        <div class="container">
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/block-sistemy/block-1/toshiba.png" style="text-align:center; width: 40%;">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Жесткий диск HDD</p>
                            <p style="line-height:normal">Жесткий диск HDD 1000 Gb Toshiba с одной пластиной, обладающие частотой вращения 7 200 об/мин и емкостью 1 500гб, оптимизированы для использования в энергоэффективных настольных компьютерах, предназначенных для некоммерческих
                                и коммерческих целей. Модель серии DT01ACA100 поддерживает расширенный формат (AF) и технологию усовершенствованного управления питанием. Помимо всего прочего, они обеспечивают экономию энергии в режиме бездействия до 16
                                % по сравнению с предыдущими моделями. </p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff;   border-top: 1px solid #eee; padding-bottom:20px">
                        <div class="container">
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/block-sistemy/block-1/korpus.png" style="text-align:center; margin-top:20px">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Корпус</p>
                            <p style="line-height:normal">Олицетворяет в себе стильный дизайн в сочетании с широкими функциональными возможностями. Строгий в то же время продвинутый дизайн лицевой панели стилизованный под металл, этот корпус украсит любое помещение. С фронтальной
                                стороны расположена панель ввода/вывода: разъёмы 2 аудио, 2 USB-порта. Присутствует перфорированная боковая панель для охлаждения комплектующих компьютера c возможностью установки 1*12см кулеров для дополнительного охлаждения,
                                а также продумана конструкция для создания воздушных потоков в кейсе. Структура корпуса позволяет устанавливать в него полноразмерную графическую карту до 300 мм. Дополнительно в новой серии усилены боковые панели с помощью
                                рёбер жёсткости. что создаёт ещё более жёсткую структуру для кейса в целом.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        <tr>
                            <td>Процессор:</td>
                            <td>Intel Core i3-9100 (4 ядер, 4 потоков, ГГц: 3.6, 6 Мб Кэша)</td>
                        </tr>
                        <tr>
                            <td>Материнская плата:</td>
                            <td> Gigabyte H310M H, Socket LGA1151, Слоты: 2 x DDR4, SATA III: 4 </td>
                        </tr>
                        <tr>
                            <td>Видеокарта:</td>
                            <td>Нет</td>
                        ...
                        <tr>
                            <td>Охлаждающий Кулер:</td>
                            <td>DEEPCOOL THETA20, обор./мин.: 2200, коннектор: 3 pin</td>
                        </tr>
                        <tr>
                            <td>Оперативная память ОЗУ:</td>
                            <td>McPoint DDR4 4GB</td>
                        </tr>
                        <tr>
                            <td>Блок Питания:</td>
                            <td>GameMax 400W</td>
                        ...
                        <tr>
                            <td>Жесткий диск HDD:</td>
                            <td>TOSHIBA DT01ACA100, 500GB/ 3.5"/ SATA III/ 7200 </td>
                        </tr>
                        <tr>
                            <td>Корпус:</td>
                            <td>X-Game XC-370</td>
...
$res=mysqli_query($db,"SELECT * FROM computers
