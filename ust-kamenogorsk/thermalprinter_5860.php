...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into thermalprinter5860
   ...
   else $res=mysqli_query($db,"insert into thermalprinter5860 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Мобильный термопринтер купить в Усть-Каменогорске - Доступные цены термопринтеры для печати чеков</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="мобильный термопринтер, чеков, принтер чеков, bluetooth, чековый, для печати чеков, Усть-Каменогорск, купить, цена, продажа." />
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/thermalprinter_5860.php">Актау</a></li>
                            <li><a href="../aktobe/thermalprinter_5860.php">Актобе</a></li>
                            <li><a href="../thermalprinter_5860.php">Алматы</a></li>
                            <li><a href="../atyrau/thermalprinter_5860.php">Атырау</a></li>
                            <li><a href="../janaozen/thermalprinter_5860.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/thermalprinter_5860.php">Жезказган</a></li>
                            <li><a href="../karaganda/thermalprinter_5860.php">Караганда</a></li>
                            <li><a href="../kokshetau/thermalprinter_5860.php">Кокшетау</a></li>
                            <li><a href="../kostanai/thermalprinter_5860.php">Костанай</a></li>
                            <li><a href="../kyzylorda/thermalprinter_5860.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/thermalprinter_5860.php">Астана</a></li>
                            <li><a href="../pavlodar/thermalprinter_5860.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/thermalprinter_5860.php">Петропавловск</a></li>
                            <li><a href="../semei/thermalprinter_5860.php">Семей</a></li>
                            <li><a href="../taldykorgan/thermalprinter_5860.php">Талдыкорган</a></li>
                            <li><a href="../taraz/thermalprinter_5860.php">Тараз</a></li>
                            <li><a href="../turkestan/thermalprinter_5860.php">Туркестан</a></li>
                            <li><a href="../uralsk/thermalprinter_5860.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/thermalprinter_5860.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/thermalprinter_5860.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Принтер чека 5860 (bluetooth)</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/thermalprinter/10.png">
                                <div class="thumb-image"> <img src="../images/thermalprinter/10.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/101.png">
                                <div class="thumb-image"> <img src="../images/thermalprinter/101.png" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/1011.png">
                                <div class="thumb-image"> <img src="../images/thermalprinter/1011.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Мобильный термопринтер 5860 (bluetooth)</h1>
                <hr>
                <p class="code-products">Код товара: 3004</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">27 720 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Мобильный термопринтер 5860 (bluetooth)</b> легко синхронизируется с устройствами(Android) на смартфоне, планшете, компьютере и печатает на стандартной термоленте шириной 58 мм. Принтер чеков 5860 совместим с любыми программными обеспечениями и отлично впишется в малый или средний бизнес.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/thermalprinter_5860.php'>Принтер чеков 5860(bluetooth)</a>" data-price="27720" data-quantity="1" data-img="https://softgroup.kz/images/thermalprinter/10.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/thermalprinter/58_2.png"></div>
                    <div class="wthree_text_info">
                        <h2>Высокая скорость печати мобильного термопринтера</h2>
                    </div>
                    <p style="line-height:normal">Принтер чеков оборудованный специальным автоотрезчиком имеет компактные размеры корпуса и предназначен для печати на 58мм термоленте. Благодаря продуманному дизайну не занимает много места, никаких лишних проводов на рабочем месте, предельно компактно и удобно.</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
            ...
            <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                <div class="container">
                    <div style="text-align:center; margin-top:0px">
                        <img src="../images/thermalprinter/auto3.png" style="text-align:center; margin-top:10px"></div>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:30px">
                        <img src="../images/thermalprinter/bluetoth.png"></div>
                    <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:10px 0 10px 0">Подключение к мобильным устройствам</p>
                    <p style="line-height:normal">Принтер оснащен интерфейсами RS-232, USB и Bluetooth, которые используются для подключения к мобильным устройствам под управлением Android, Windows.</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM thermalprinter5860
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить мобильного термопринтера у нас:</h3>
                    <hr>
                </div>
