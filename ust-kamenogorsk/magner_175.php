...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into magner175
   ...
   else $res=mysqli_query($db,"insert into magner175 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот графический Magner 175 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, magner, 175, графические, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Продажа высококачественных счетчиков банкнот Magner в Усть-Каменогорске от Softgroup. Счетчики банкнот предназначены для пересчета банкнот любых валют.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/magner_175.php">Актау</a></li>
                            <li><a href="../aktobe/magner_175.php">Актобе</a></li>
                            <li><a href="../magner_175.php">Алматы</a></li>
                            <li><a href="../atyrau/magner_175.php">Атырау</a></li>
                            <li><a href="../janaozen/magner_175.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/magner_175.php">Жезказган</a></li>
                            <li><a href="../karaganda/magner_175.php">Караганда</a></li>
                            <li><a href="../kokshetau/magner_175.php">Кокшетау</a></li>
                            <li><a href="../kostanai/magner_175.php">Костанай</a></li>
                            <li><a href="../kyzylorda/magner_175.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/magner_175.php">Астана</a></li>
                            <li><a href="../pavlodar/magner_175.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/magner_175.php">Петропавловск</a></li>
                            <li><a href="../semei/magner_175.php">Семей</a></li>
                            <li><a href="../taldykorgan/magner_175.php">Талдыкорган</a></li>
                            <li><a href="../taraz/magner_175.php">Тараз</a></li>
                            <li><a href="../turkestan/magner_175.php">Туркестан</a></li>
                            <li><a href="../uralsk/magner_175.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/magner_175.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/magner_175.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Счетчик банкнот графический</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики банкнот графические Magner 175</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/20.png">
                                <div class="thumb-image"> <img src="../images/schetchiki/20.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/202.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/202.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/2022.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/2022.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот жидкокристаллические Magner 175</h2>
                <hr>
                <p class="code-products">Код товара: 8011</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">1 235 000 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Мультивалютный двухкарманный сортировщик банкнот Magner 175F с функцией сортировки по ветхости предназначен для работы с любым объемом наличности. Предусмотрен режим раздельного учета операций для двух кассиров. Возможно расширение до 10 валют.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/magner_175.php'>Счетчики банкнот жидкокристаллические Magner 175</a>" data-price="1235000" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/20.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Дисплей: </td>
                        <td>графический ЖК-дисплей с подсветкой</td>
                    </tr>
                    <tr>
                        <td>Скорость счета, банкнот в минуту:</td>
                        <td>:простой счет – 1500 банкнот/мин
                            определение номинала – 1200 банкнот/мин
                            сверка серийных номеров – 1200 банкнот/мин
                            определение ветхости – 1200 банкнот/мин (только 175F)</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Детекция: </td>
                        <td> цифровая оптическая и ИК (2CIS сканера), магнитная, УФ, по размеру, сверка и распознавание серийных номеров</td>
                    </tr>

                    <tr>
                        <td>Интерфейс:</td>
                        <td> LAN, USB, подключение внешнего дисплея и чекового принтера</td>
                    </tr>

                    <tr>

                        <td>Опции:</td>
                        <td>выносной дисплей, чековый принтер, подключение
                            к ПК / ноутбуку, сканер шрих-кода для обработки пакетов / сумок /
                            депозитов, система видеонаблюдения ЧЕКТВ БАНК, Трассир</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM magner175
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить графический счетчик банкнот у нас</h3>
                    <hr>
                </div>
