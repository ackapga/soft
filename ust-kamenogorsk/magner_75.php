...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into magner75
   ...
   else $res=mysqli_query($db,"insert into magner75 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот жидкокристаллический Magner 75 D купить в Усть-Каменогорске</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, жидкокристаллические,75 D, magner алматы, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот жидкокристаллические Magner 75 D купить в Усть-Каменогорске. Огромный выбор счетчиков для банкнот от компании SoftGroup.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/magner_75.php">Актау</a></li>
                            <li><a href="../aktobe/magner_75.php">Актобе</a></li>
                            <li><a href="../magner_75.php">Алматы</a></li>
                            <li><a href="../atyrau/magner_75.php">Атырау</a></li>
                            <li><a href="../janaozen/magner_75.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/magner_75.php">Жезказган</a></li>
                            <li><a href="../karaganda/magner_75.php">Караганда</a></li>
                            <li><a href="../kokshetau/magner_75.php">Кокшетау</a></li>
                            <li><a href="../kostanai/magner_75.php">Костанай</a></li>
                            <li><a href="../kyzylorda/magner_75.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/magner_75.php">Астана</a></li>
                            <li><a href="../pavlodar/magner_75.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/magner_75.php">Петропавловск</a></li>
                            <li><a href="../semei/magner_75.php">Семей</a></li>
                            <li><a href="../taldykorgan/magner_75.php">Талдыкорган</a></li>
                            <li><a href="../taraz/magner_75.php">Тараз</a></li>
                            <li><a href="../turkestan/magner_75.php">Туркестан</a></li>
                            <li><a href="../uralsk/magner_75.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/magner_75.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/magner_75.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Счетчик банкнот жидкокристаллический Magner</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики банкнот жидкокристаллические Magner 75 D</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/8.png">
                                <div class="thumb-image"> <img src="../images/schetchiki/8.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/88.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/88.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/888.png">
                                <div class="thumb-image"> <img src="../images/schetchiki/888.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот жидкокристаллические Magner 75 D</h2>
                <hr>
                <p class="code-products">Код товара: 8008</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">301 716 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Счетчик банкнот Magner 75 D — высококачественный и надежный мультивалютный счетчик, предназначенный для быстрого пересчета банкнот с проверкой на подлинность по размеру купюры.
                        <br>• Режим простого пересчета;
                  
                        <br>• Фасовка банкнот заданным количеством;
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/magner_75.php'>Счетчики банкнот жидкокристаллические Magner 75 D</a>" data-price="301716" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/8.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
...
$res=mysqli_query($db,"SELECT * FROM magner75
