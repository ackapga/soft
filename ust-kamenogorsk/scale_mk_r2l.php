...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalemkr2l
   ...
   else $res=mysqli_query($db,"insert into scalemkr2l (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы с печатью этикеток МК_R2L10-1 купить в Усть-Каменогорске от компании Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы с печатью этикеток, масса к, электронные, МК_R2L10-1, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Электронные весы с печатью этикеток купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные торговые весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_mk_r2l.php">Актау</a></li>
                            <li><a href="../aktobe/scale_mk_r2l.php">Актобе</a></li>
                            <li><a href="../scale_mk_r2l.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_mk_r2l.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_mk_r2l.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_mk_r2l.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_mk_r2l.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_mk_r2l.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_mk_r2l.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_mk_r2l.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_mk_r2l.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_mk_r2l.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_mk_r2l.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_mk_r2l.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_mk_r2l.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_mk_r2l.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_mk_r2l.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_mk_r2l.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_mk_r2l.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_mk_r2l.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
            <h1>Весы торговые с печатью этикеток</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы торговые с печатью этикеток МК_RL10-1</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/40.jpg">
                                <div class="thumb-image"> <img src="../images/scale/40.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/404.jpg">
                                <div class="thumb-image"> <img src="../images/scale/404.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/4044.jpg">
                                <div class="thumb-image"> <img src="../images/scale/4044.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы торговые с печатью этикеток МК_R2L10-1</h2>
                <hr>
                <p class="code-products">Код товара: 5012</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">182 266 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Весы предназначены для маркировки и учета весовых, штучных и счетных товаров за прилавком. Память на 20000 товаров. Печатают как простые этикетки с автоматически настраиваемым форматом, так и этикетки любой сложности. Весы поддерживают печать 8 форматов штрихкодов, регистрируют товароучетные операции (прием, отпуск, списание, инвентаризация). Легко интегрируются в системы учета, в том числе в режиме весового терминала сбора данных. Обеспечена возможность подключения к весам сканера штрихкодов. Обмен информацией с внешними устройствами - по интерфейсам Ethernet и RS-232, а также с помощью USB-flash накопителя. Увеличенный ресурс термопринтера.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_mk_r2l.php'>Весы   торговые с печатью этикеток МК_R2L10-1</a>" data-price="182266" data-quantity="1" data-img="https://softgroup.kz/images/scale/40.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg4.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Диапазон взвешивания</p>
                        <p style="line-height:normal">Главным преимуществом оборудования является высокая точность измерений. Максимальный предел взвешивания - 32 кг. Устройства широко применяются в быту, в сфере продаж (подходят для магазинов любого формата), на предприятиях общественного питания, на складах, в фармацевтических компаниях и т. д. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/scale/p4.png" style="text-align:center; margin-top:20px"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/d2.png" style="text-align:center; "></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Дисплей покупателя</p>
                        <p style="line-height:normal">Дисплей (табло, индикатор) покупателя (клиента) служит для отображения различной информации (наименование товара, стоимость товара, сумма чека, сумма сдачи, и т.п.), предназначенной для обслуживаемого на кассовом узле клиента.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel2.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Панель управления</p>
                          <p style="line-height:normal"> Клавиши электронных весов — это прямая и адресная память для хранения данных о товаре. Клавиши позволяют вызвать из памяти весов часто используемую информацию и записанные товары. По устройству кнопочная клавиатура. В клавиатуре 33 кнопок. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/icon2.png" style="text-align:center; margin-top:20px"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Диапазон рабочих температур терминала:</td>
                        <td> от -10 до +40 °С;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Тип индикации: </td>
                        <td>матричный ЖК с подсветкой, 192х64 точки;</td>
                    </tr>
                    <tr>

                        <td>Торговая индикация (масса, цена, стоимость): </td>
                        <td>да;</td>
                    </tr>
                    <tr>

                        <td>Многофункциональный графический дисплей с подсветкой: </td>
                        <td>2 шт;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Разъёмы для подключения периферийных устройств:</td>
                        <td>USB-flash накопителя, сканера штрихкодов, ККМ, дозатора и др.: USB тип А, DB9-MА/вилка (интерфейс RS-232);</td>
                    </tr>
                    <tr>

                        <td>Количество товаров, вызываемых кнопками быстрого вызова: </td>
                        <td>8/64шт;</td>
                    </tr>
                    <tr>

                        <td>В комплекте поставки: </td>
                        <td>сетевой адаптер - 1 шт;</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры весов (ШхГхВ):</td>
                        <td>360х375х380 мм;</td>
                    </tr>
                    <tr>

                        <td>Масса весов нетто/брутто:</td>
                        <td>8,2 кг.</td>
                    </tr>
                </tbody>
            </table>
...
$res=mysqli_query($db,"SELECT * FROM scalemkr2l
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить весы с печатью этикеток у нас</h3>
                    <hr>
                </div>
