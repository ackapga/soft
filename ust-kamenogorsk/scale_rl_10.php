...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalerl10
   ...
   else $res=mysqli_query($db,"insert into scalerl10 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы с печатью этикеток МК_RL10-1 купить в Усть-Каменогорске от компании Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы с печатью этикеток, масса к, электронные, МК_RL10-1, Усть-Каменогорск, купить, цена, продажа." />
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
            <h1>Весы с печатью этикеток Масса-К</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/30.jpg">
                                <div class="thumb-image"> <img src="../images/scale/30.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/303.jpg">
                                <div class="thumb-image"> <img src="../images/scale/303.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/3033.jpg">
                                <div class="thumb-image"> <img src="../images/scale/3033.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы торговые с печатью этикеток МК_RL10-1</h2>
                <hr>
                <p class="code-products">Код товара: 5011</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">176 172 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_rl_10.php'>Весы   торговые с печатью этикеток МК_RL10-1</a>" data-price="176172" data-quantity="1" data-img="https://softgroup.kz/images/scale/30.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
...
$res=mysqli_query($db,"SELECT * FROM scalerl10
