...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into loop
   ...
   else $res=mysqli_query($db,"insert into loop (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Антикражный тросик типа "петля-игла" купить в Усть-Каменогорске | Антикражные системы </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Антикражный тросик, петля-игла, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить Антикражный тросик типа петля-игла в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/loop.php">Актау</a></li>
                            <li><a href="../aktobe/loop.php">Актобе</a></li>
                            <li><a href="../loop.php">Алматы</a></li>
                            <li><a href="../atyrau/loop.php">Атырау</a></li>
                            <li><a href="../janaozen/loop.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/loop.php">Жезказган</a></li>
                            <li><a href="../karaganda/loop.php">Караганда</a></li>
                            <li><a href="../kokshetau/loop.php">Кокшетау</a></li>
                            <li><a href="../kostanai/loop.php">Костанай</a></li>
                            <li><a href="../kyzylorda/loop.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/loop.php">Астана</a></li>
                            <li><a href="../pavlodar/loop.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/loop.php">Петропавловск</a></li>
                            <li><a href="../semei/loop.php">Семей</a></li>
                            <li><a href="../taldykorgan/loop.php">Талдыкорган</a></li>
                            <li><a href="../taraz/loop.php">Тараз</a></li>
                            <li><a href="../turkestan/loop.php">Туркестан</a></li>
                            <li><a href="../uralsk/loop.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/loop.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/loop.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Антикражный тросик  в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/9.jpg">
                                <div class="thumb-image"> <img src="../images/eas/9.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/99.jpg">
                                <div class="thumb-image"> <img src="../images/eas/99.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/999.jpg">
                                <div class="thumb-image"> <img src="../images/eas/999.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Антикражный тросик</h2>
                <hr>
                <p class="code-products">Код товара: 9034</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">5742 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Антикражный тросик типа "петля-игла"</b>  предназначен для крепления противокражных датчиков к товарам, к которым невозможно прикрепить датчики с помощью стандартной клипсы. Тросики имеют специальное полимерное покрытие, которое не наносит повреждений защищаемому товару.

</p>
                    <br>
                    <h3><b>Преимущества антикражного тросика:</b></h3>
                    ...
                    <button id="fly" class="add_item" data-id="84" data-title="<a href='https://softgroup.kz/loop.php'>Антикражный тросик</a>" data-price="5742" data-quantity="1" data-img="https://softgroup.kz/images/eas/9.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                    ...
                    <div class="container">
                        <div class="models" style="margin-top:50px">
                         ...
                         <div style="text-align:center">
                            <img src="../images/eas/p20.png"></div>
							 <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Крепления противокражных датчиков </p>
                        <p style="line-height:normal; margin-bottom:20px">Антикражные тросики «петля - игла» предназначены специально для крепления к тем товарам, на которых нельзя зафиксировать датчик при помощи клипсы. Тросики имеют полимерное покрытие, которое не повреждает защищаемый с помощью датчика товар.</p> 
                       <div class="clearfix"> </div>
                    ...
                    <div class="container"> 
						 ...
						 <div style="text-align:center;">
                            <img src="../images/eas/p44444.png"></div>
							 <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0"><a href="puller_universal.php">Снятие антикражного тросика</a></p>
 ...
 <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  margin:20px 0 10px 0; padding:15px 0">					
				
                    <div class="container">
					 <div class="models" style="margin-top:0px">
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика антикражного тросика</p>
                <hr>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM loop
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить антикражного тросика у нас:</h3>
                    <hr>
                </div>
