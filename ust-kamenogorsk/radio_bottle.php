...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into radio_bottle
   ...
   else $res=mysqli_query($db,"insert into radio_bottle (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Радиочастотная бирка для бутылок купить в Усть-Каменогорске | Антикражные системы </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Радиочастотная бирка для бутылок, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить Радиочастотная бирка Bottle tag в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/radio_bottle.php">Актау</a></li>
                            <li><a href="../aktobe/radio_bottle.php">Актобе</a></li>
                            <li><a href="../radio_bottle.php">Алматы</a></li>
                            <li><a href="../atyrau/radio_bottle.php">Атырау</a></li>
                            <li><a href="../janaozen/radio_bottle.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/radio_bottle.php">Жезказган</a></li>
                            <li><a href="../karaganda/radio_bottle.php">Караганда</a></li>
                            <li><a href="../kokshetau/radio_bottle.php">Кокшетау</a></li>
                            <li><a href="../kostanai/radio_bottle.php">Костанай</a></li>
                            <li><a href="../kyzylorda/radio_bottle.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/radio_bottle.php">Астана</a></li>
                            <li><a href="../pavlodar/radio_bottle.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/radio_bottle.php">Петропавловск</a></li>
                            <li><a href="../semei/radio_bottle.php">Семей</a></li>
                            <li><a href="../taldykorgan/radio_bottle.php">Талдыкорган</a></li>
                            <li><a href="../taraz/radio_bottle.php">Тараз</a></li>
                            <li><a href="../turkestan/radio_bottle.php">Туркестан</a></li>
                            <li><a href="../uralsk/radio_bottle.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/radio_bottle.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/radio_bottle.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Радиочастотная бирка Bottle tag в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Радиочастотная бирка Bottle tag</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/14.jpg">
                                <div class="thumb-image"> <img src="../images/eas/14.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/144.jpg">
                                <div class="thumb-image"> <img src="../images/eas/144.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/1444.jpg">
                                <div class="thumb-image"> <img src="../images/eas/1444.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Радиочастотная бирка Bottle tag</h2>
                <hr>
                <p class="code-products">Код товара: 9033</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">185 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="83" data-title="<a href='https://softgroup.kz/radio_bottle.php'>Радиочастотная бирка Bottle tag</a>" data-price="185" data-quantity="1" data-img="https://softgroup.kz/images/eas/14.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
<div class="responsive_tabs_agileits">
			 ...
			 <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  margin:20px 0 10px 0">
                    <div class="container">
                        <div class="models" style="margin-top:50px">
                         ...
                         <div style="text-align:center">
                            <img src="../images/eas/p17.png"></div>
							 <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Конструкция радиочастотной бирки Bottle tag</p>
                        <p style="line-height:normal; margin-bottom:20px">  Для защиты от кражи акустомагнитный датчик крепится к горлышку бутылки жестким тросом, снять который можно, используя магнитный съемник. Чтобы стекло бутылки не раздавила твердая поверхность тросика, он защищен мягкой прозрачной оболочкой.  </p> 
                       <div class="clearfix"> </div>
				  ...
				  <div class="bootstrap-tab-text-grid">
                    ...
                    <div class="container"> 
                         ...
                         <div style="text-align:center">
                            <img src="../images/eas/p444.png"></div>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика радиочастотной бирки Bottle tag</p>
                <hr>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM radio_bottle
