...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into label3120
   ...
   else $res=mysqli_query($db,"insert into label3120 (date, theme_id, login, message, rating)
...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Принтер этикеток купить в Усть-Каменогорске | Принтер для печати этикеток шириной 80 мм</title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="Принтер этикеток, с термопечатью, на термоленте, для кассы, для печати, шириной 80 мм, Усть-Каменогорск, купить, цена, продажа." />
        <meta name="description" content="Принтеры для печати этикеток купить в Усть-Каменогорске. Широкий выбор ассортимента принтеров этикеток по низким ценам от компании Softgroup">
        <!--//tags -->
                ...
                <div class="fond">
                    ...
                    <div id="box_2" class="mymagicoverbox_fenetre">
                        <div class="mymagicoverbox_fenetreinterieur">
                            <ul>
                                <li><a href="../aktau/label_3120t.php">Актау</a></li>
                                <li><a href="../aktobe/label_3120t.php">Актобе</a></li>
                                <li><a href="../label_3120t.php">Алматы</a></li>
                                <li><a href="../atyrau/label_3120t.php">Атырау</a></li>
                                <li><a href="../janaozen/label_3120t.php">Жанаозен</a></li>
                                <li><a href="../jezkazgan/label_3120t.php">Жезказган</a></li>
                                <li><a href="../karaganda/label_3120t.php">Караганда</a></li>
                                <li><a href="../kokshetau/label_3120t.php">Кокшетау</a></li>
                                <li><a href="../kostanai/label_3120t.php">Костанай</a></li>
                                <li><a href="../kyzylorda/label_3120t.php">Кызылорда</a></li>
                            </ul>
                            <ul class="dlya_left">
                                <li><a href="../astana/label_3120t.php">Астана</a></li>
                                <li><a href="../pavlodar/label_3120t.php">Павлодар</a></li>
                                <li><a href="../petropavlovsk/label_3120t.php">Петропавловск</a></li>
                                <li><a href="../semei/label_3120t.php">Семей</a></li>
                                <li><a href="../taldykorgan/label_3120t.php">Талдыкорган</a></li>
                                <li><a href="../label_3120t.php">Тараз</a></li>
                                <li><a href="../turkestan/label_3120t.php">Туркестан</a></li>
                                <li><a href="../uralsk/label_3120t.php">Уральск</a></li>
                                <li><a href="../ust-kamenogorsk/label_3120t.php">Усть-Каменогорск</a></li>
                                <li><a href="../shymkent/label_3120t.php">Шымкент</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li><a href="label.html">Принтеры этикеток</a><i>/</i></li>
                            <li>Принтер этикеток 3120T</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/3120TUC/1.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TUC/1.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3120TUC/2.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TUC/2.jpg" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3120TUC/3.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TUC/3.jpg" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Принтер этикеток 3120TUC</h1>
                    <hr>
                    <p class="code-products">Код товара: 4938</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">33 390 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Высокопроизводительный принтер 3120TUC со скоростью 127 мм/сек с разрешением 203 dpi имеет превосходные технические характеристики для печати этикеток шириной 80 мм. Данный принетер является безупречным решением для организации
                            работы торговых компаний разной специализации</p>
                        ...
                        <button id="fly" class="add_item" data-id="4938" data-title="<a href='https://softgroup.kz/label_3120tuc.php'>Принтер этикеток 3120TUC</a>" data-price="33390" data-quantity="1" data-img="https://softgroup.kz/images/3120TUC/1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
            ...
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  padding-bottom:20px; ">
                    ...
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/3120TUC/4.png" style="text-align:center; margin-top:10px; width: 60%;"></div>
                        <div class="wthree_text_info">
                            <h2>Высокая скорость печати принтера этикеток</h2>
                        </div>
                        <p style="line-height:normal">Принтер этикеток позволяет печатать на ленте шириной от 25 до 80мм, скорость печати принтера составляет 127мм/сек, разрешение печати - 203dpi</p>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center; margin-top:10px">
                            <img src="../images/3120TUC/1.png">
                            <img style="width: 20%; " src="../images/3120TUC/auto.webp">
                        </div>
                        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  padding-bottom:20px; ">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/3120TUC/structure.png" style="text-align:center; margin-top:10px; width: 60%;"></div>
                        <div class="wthree_text_info">
                            <h2>Структура принтера</h2>
                        </div>
                        <p style="line-height:normal">Принтер этикеток имеет удобную и простую конструкцию. Он состоит из следующих частей: острое лезвие для разрыва бумаги, прижимной ролик, кнопка для открытия крышки, блок печати.</p>
                ...
                <div class="bootstrap-tab-text-grid " style="padding-bottom:20px ">
                    <div class="container ">
                        <div style="text-align:center; margin-top:0px ">
                            <img src="../images/3120TUC/interface.png " style="text-align:center; width: 45%; padding-top: 30px;"></div>
                        <p class="wthree_text_info " style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0 ">Удобный интерфейс подключения</p>
                        <p style="line-height:normal ">
Управление принтера этикеток производится с поддержкой известного интерфейса USB. Устройства с этим интерфейсом можно подключать и отключать во время работы компьютера. Современные операционные системы сразу же распознают USB-устройства и подгружают необходимые
                        драйверы. На многих компьютерах для повышения удобства доступа порты USB размещены на фронтальной или боковой стороне корпуса.</p>
                        <div class="clearfix "> </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            <td>Емкость рулона этикеток, макс:</td>
                            <td>115 мм</td>
                        </tr>
                        <tr>
                            <td>Емкость рулона этикеток, мин:</td>
                            <td>25 мм</td>
                        </tr>
                        <tr>
                            <td>Интерфейс:</td>
...
$res=mysqli_query($db,"SELECT * FROM label3120
