...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalemkra
   ...
   else $res=mysqli_query($db,"insert into scalemkra (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы со стойкой MK_RA11 купить по доступным ценам в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы настольные, масса к, электронные, MK_RA11, MK-RA11, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Электронные весы со стойкой MK_RA11 купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_mk_ra.php">Актау</a></li>
                            <li><a href="../aktobe/scale_mk_ra.php">Актобе</a></li>
                            <li><a href="../scale_mk_ra.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_mk_ra.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_mk_ra.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_mk_ra.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_mk_ra.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_mk_ra.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_mk_ra.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_mk_ra.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_mk_ra.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_mk_ra.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_mk_ra.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_mk_ra.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_mk_ra.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_mk_ra.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_mk_ra.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_mk_ra.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_mk_ra.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_mk_ra.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
            <h1>Весы электронные со стойкой</h1>
            <!--//w3_short-->
        </div>
    </div>
        ...
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы влагозащищенные MK_RA11</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/5.jpg">
                                <div class="thumb-image"> <img src="../images/scale/5.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/55.jpg">
                                <div class="thumb-image"> <img src="../images/scale/55.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/555.jpg">
                                <div class="thumb-image"> <img src="../images/scale/555.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <div class="description">
                    <p>Весы предназначены для измерений массы и количества различных грузов при торговых, учетных и технологических операциях. Возможна работа в счетном режиме. Обеспечена возможность подключения к весам сканера штрихкодов и дозатора. Весы регистрируют товароучетные операции (прием, отпуск, списание, инвентаризация). Легко интегрируются в системы учета, в том числе в режиме весового терминала сбора данных. Обмен информацией с внешними устройствами реализован по интерфейсам Ethernet и RS-232, а также с помощью USB-flash накопителя.
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg13.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel9.png"></div>
...
$res=mysqli_query($db,"SELECT * FROM scalemkra
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить весы со стойкой у нас</h3>
                    <hr>
                </div>
