    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/rack/st1.jpg">
                                <div class="thumb-image"> <img src="../images/rack/st1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/rack/st2.jpg">
                                <div class="thumb-image"> <img src="../images/rack/st2.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Стойка для сканера Универсальная</h1>
                <hr>
                <p class="code-products">Код товара: 4843</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">2 115 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Стандартная стойка для сканера штрих-кода Универсальная предназначена для непрерывного сканирования. Она надежно закрепляется у основания сканера.</p><br>
                    ...
                    <button id="fly" class="add_item" data-id="4843" data-title="<a href='https://softgroup.kz/stoika.php'>Стойка для сканера Универсальная</a>" data-price="2115" data-quantity="1" data-img="https://softgroup.kz/images/scanner/defphoto.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <div class="models">
