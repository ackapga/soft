...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into mini_square
   ...
   else $res=mysqli_query($db,"insert into mini_square (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Радиочастотная бирка Mini square купить в Усть-Каменогорске | Антикражные системы </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Радиочастотная бирка, Mini square, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить радиочастотные бирки в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/mini_square.php">Актау</a></li>
                            <li><a href="../aktobe/mini_square.php">Актобе</a></li>
                            <li><a href="../mini_square.php">Алматы</a></li>
                            <li><a href="../atyrau/mini_square.php">Атырау</a></li>
                            <li><a href="../janaozen/mini_square.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/mini_square.php">Жезказган</a></li>
                            <li><a href="../karaganda/mini_square.php">Караганда</a></li>
                            <li><a href="../kokshetau/mini_square.php">Кокшетау</a></li>
                            <li><a href="../kostanai/mini_square.php">Костанай</a></li>
                            <li><a href="../kyzylorda/mini_square.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/mini_square.php">Астана</a></li>
                            <li><a href="../pavlodar/mini_square.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/mini_square.php">Петропавловск</a></li>
                            <li><a href="../semei/mini_square.php">Семей</a></li>
                            <li><a href="../taldykorgan/mini_square.php">Талдыкорган</a></li>
                            <li><a href="../taraz/mini_square.php">Тараз</a></li>
                            <li><a href="../turkestan/mini_square.php">Туркестан</a></li>
                            <li><a href="../uralsk/mini_square.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/mini_square.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/mini_square.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Радиочастотные бирки в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Радиочастотная бирка Mini square</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/7.jpg">
                                <div class="thumb-image"> <img src="../images/eas/7.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/77.jpg">
                                <div class="thumb-image"> <img src="../images/eas/77.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/777.jpg">
                                <div class="thumb-image"> <img src="../images/eas/777.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Радиочастотная бирка Mini square</h2>
                <hr>
                <p class="code-products">Код товара: 9031</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">31 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Радиочастотная бирка Mini Square</b>  имеет размер 48 x 42 мм - что является сравнительно небольшим и подходит практически для всех категорий товаров. Он крепится с помощью иглы или троса игла-петля. Это самая легкая противоправная бирка из всей линейки. Датчик совместим со всеми видами противокражных ворот радиочастотной технологии. Его относительная доступность, высокая надёжность размеры и лёгкость установки и деактивации делают его самым удачным решением защиты от краж для магазинов одежды, обуви, сумок, белья и др..</p>
                    <br>
                    <h3><b>Преимущества радиочастотных бирок:</b></h3>
                    ...
                    <button id="fly" class="add_item" data-id="81" data-title="<a href='https://softgroup.kz/mini_square.php'>Радиочастотная бирка Mini square</a>" data-price="31" data-quantity="1" data-img="https://softgroup.kz/images/eas/7.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
			 <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  margin:20px 0 10px 0">
                    <div class="container">
                        <div class="models" style="margin-top:50px">
                         ...
                         <div style="text-align:center">
                            <img src="../images/eas/p14.png"></div>
                        ...
                        <p style="line-height:normal; margin-bottom:15px">Антикражные тросики «петля - игла» предназначены специально для крепления к тем товарам, на которых нельзя зафиксировать датчик при помощи клипсы. Тросики имеют полимерное покрытие, которое не повреждает защищаемый с помощью датчика товар.</p> 
                       <div class="clearfix"> </div>
				 ...
				 <div class="bootstrap-tab-text-grid">
                    ...
                    <div class="container">
					  <div style="text-align:center">
                            <img src="../images/eas/p15.png"></div>
							 <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Крепление с помощью гвоздика.</p>
                        <p style="line-height:normal; margin-bottom:20px">Радиочастотная бирка Mini Square крепится на одежду либо другой товар с помощью гвоздика. Благодаря своему небольшому размеру, гвоздик продевается через шов или через петлю в одежде и вставляется в отверстие бирки.</p>
                    ...
                    <div class="container"> 
						 ...
						 <div style="text-align:center; margin-right:20px">
                            <img src="../images/eas/p44444.png"></div>
							<p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0"><a href="puller_universal.php">Снятие бирок Mini Square</a></p>
                        <p style="line-height:normal; margin-bottom:10px">Съемник предназначен для снятия любых датчиков антикражных систем с магнитным замком. Сила магнита 12000 Гс позволяет открывать все типы противокражных бирок.</p>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика радиочастотной бирки Mini square</p>
                <hr>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM mini_square
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить радиочастотной бирки у нас:</h3>
                    <hr>
                </div>
