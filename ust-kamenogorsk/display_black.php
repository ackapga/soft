...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into display_black
   ...
   else $res=mysqli_query($db,"insert into display_black (date, theme_id, login, message, rating)
...
<head>
   ...
   <title>Дисплей покупателя в Усть-Каменогорске - Купить дисплеи покупателя черного цвета</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="дисплей покупателя, купить, цена, Усть-Каменогорск, продажа." />
    <meta name="description" content="Дисплей покупателя черного цвета купить в Усть-Каменогорске по низким ценам. Огромный выбор дисплея покупателя для рекламной информации в виде бегущей строки.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/display_black.php">Актау</a></li>
                            <li><a href="../aktobe/display_black.php">Актобе</a></li>
                            <li><a href="../display_black.php">Алматы</a></li>
                            <li><a href="../atyrau/display_black.php">Атырау</a></li>
                            <li><a href="../janaozen/display_black.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/display_black.php">Жезказган</a></li>
                            <li><a href="../karaganda/display_black.php">Караганда</a></li>
                            <li><a href="../kokshetau/display_black.php">Кокшетау</a></li>
                            <li><a href="../kostanai/display_black.php">Костанай</a></li>
                            <li><a href="../kyzylorda/display_black.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/display_black.php">Астана</a></li>
                            <li><a href="../pavlodar/display_black.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/display_black.php">Петропавловск</a></li>
                            <li><a href="../semei/display_black.php">Семей</a></li>
                            <li><a href="../taldykorgan/display_black.php">Талдыкорган</a></li>
                            <li><a href="../taraz/display_black.php">Тараз</a></li>
                            <li><a href="../turkestan/display_black.php">Туркестан</a></li>
                            <li><a href="../uralsk/display_black.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/display_black.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/display_black.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li><a href="pos.html">POS системы, Моноблоки</a><i>/</i></li>
                        <li>Дисплей покупателя, черный</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/25.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/25.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/255.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/255.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Дисплей покупателя, черный</h1>
                <hr>
                <p class="code-products">Код товара: 1015</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">25 200 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="23" data-title="<a href='https://softgroup.kz/display_black.php'>Дисплей покупателя, черный</a>" data-price="25200" data-quantity="1" data-img="https://softgroup.kz/images/monitor/25.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
...
$res=mysqli_query($db,"SELECT * FROM display_black
    WHERE theme_id='".$theme_id."' ORDER BY id");
$number=mysqli_num_rows($res);

if ($number>0) {
 echo '<div style="padding-top:10px;">';
 echo '<div style="float:none;font-size:26px; font-weight:bold;padding: 10px 0px 10px; color: #0ba98b; "><div  class="models"><p>Отзывы</h3><hr></div></div>';
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Продажа дисплея покупателя в Усть-Каменогорске</h3>
                    <hr>
                </div>
