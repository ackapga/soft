        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Принтер чеков Rongta 58B</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/58Bwith wm/1.jpg">
                                    <div class="thumb-image" id="thumb-image"> <img src="../images/58Bwith wm/1.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/58Bwith wm/2.jpg">
                                    <div class="thumb-image"> <img src="../images/58Bwith wm/2.jpg" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/58Bwith wm/3.jpg">
                                    <div class="thumb-image"> <img src="../images/58Bwith wm/3.jpg" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Принтер чеков Rongta 58B</h1>
                    <hr>
                    <p class="code-products">Код товара: 5382</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">12 096 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p><b>Принтер чеков Rongta 58B</b> `обладает скоростью печати 90 мм/сек. Термопринтер имеет компактные размеры корпуса и предназначен для печати на 58мм термоленте.
                        </p>
                        ...
                        <button id="fly" class="add_item " data-id="12096" data-title="<a href='https://softgroup.kz/thermalprinter_58B.php'>Принтер чеков Rongta 58B</a>" data-price="12096" data-quantity="1" data-img="https://softgroup.kz/images/58Bwith wm/1.jpg" data-count="100500"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    <div class="container">
                        ...
                        <div style="text-align:center; margin-top:10px">
                            <img src="../images/58Bwith wm/8.png" style="width: 500px;"></div>
