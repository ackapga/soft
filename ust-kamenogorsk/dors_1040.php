...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors1040
   ...
   else $res=mysqli_query($db,"insert into dors1040 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот жидкокристаллический Dors CT1040 купить в Усть-Каменогорске</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, жидкокристаллические, dors, CT1040, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот Dors жидкокристаллические купить в Усть-Каменогорске по низким ценам. Огромный выбор счетчиков для банкнот от компании Softgroup">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_1040.php">Актау</a></li>
                            <li><a href="../aktobe/dors_1040.php">Актобе</a></li>
                            <li><a href="../dors_1040.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_1040.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_1040.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_1040.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_1040.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_1040.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_1040.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_1040.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_1040.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_1040.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_1040.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_1040.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_1040.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_1040.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_1040.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_1040.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_1040.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_1040.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Счетчик банкнот жидкокристаллический</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li><a href="schetchiki.html">Счетчики банкнот</a><i>/</i></li>
                        <li>Счетчики банкнот жидкокристаллические DORS CT1040</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/2.png">
                                <div class="thumb-image"> <img src="../images/schetchiki/2.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/22.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/22.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/222.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/222.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот жидкокристаллические DORS CT1040</h2>
                <hr>
                <p class="code-products">Код товара: 8002</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">53 582 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    Счетчики банкнот DORS CT1040 Series позволяют пересчитывать банкноты различных валют.

                    Рекомендуются для пересчета однородной по номиналу денежной массы в местах с небольшим и средним оборотом наличных средств.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_1040.php'>Счетчики банкнот жидкокристаллические DORS CT1040</a>" data-price="53582" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/2.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <div style="text-align:center; margin-top:0.5em;">
                <img src="../images/schetchiki/2222.jpg">
            </div>
            <div>
                <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Функциональные возможности</p>
                <p style="line-height:normal"><b>• Режим суммирования</b> результатов пересчета позволяет просчитать любой объем однородной по номиналу денежной массы. Удобен при сверке количества банкнот в пачке с заявленным по документам количеством. Также удобен при получении от клиента большого количества банкнот низких номиналов, т. к. позволяет избежать пересчета каждой банкноты вручную.
                    <br><b>• Режим отсчета</b> пачки банкнот заданного размера позволяет сформировать корешок (100 банкнот) одного номинала.
                    <br>• Режим удобен <b>при выдаче заранее известной суммы:</b> кассир выставляет на счетчике необходимое количество банкнот, после чего кладет на слистыватель любое количество имеющихся банкнот данного номинала. Если пересчитанных банкнот недостаточно, счетчик автоматически продолжит счет с накоплением при следующем пересчете. Если есть избыток банкнот, DORS CT1040 Series отсчитает нужное количество и остановится.
                    <br><b>• Режим ручного начала пересчета</b> позволяет контролировать начало пересчета банкнот: у кассира есть возможность без спешки ровно уложить банкноты.</p>
            </div>

            <div style="text-align:center; margin-top:1em;">
                <img src="../images/schetchiki/22222.jpg">
            </div>

            <div>
                <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Виды контроля</p>
                <p style="line-height:normal"><b>• Оптическая плотность</b> банкнотной бумаги определяется как среднее значения пропускания ИК света, прошедшего через банкноту. Это базовый уровень контроля, обязательный для любого счетчика банкнот.
                    <br><b>• Определение размера</b> каждой просчитанной банкноты: DORS CT1040 Series определяет длину короткой стороны первой просчитанной банкноты и берет ее за эталон. Далее, счетчик сравнивает длину каждой последующей банкноты с эталонной. В случае, если длины совпадают, счет продолжается. Если же есть существенные отличия в длине текущей и эталонной банкноты, то счет автоматически прекращается, DORS CT1040 Series подает звуковой сигнал и отображает на дисплее код ошибки.
                    <br><b>• Детекция на сдвоенность</b> служит для определения того, что при пересчете две банкноты, наслоенные друг на друга, не прошли как одна.
                    <br><b>• Детекция цепочки банкнот</b> также позволяет избежать ошибок счета. Осуществляется проверка по времени прохождения каждой банкноты: в случае, если две банкноты идут внахлест, счетчик не воспринимает их как одну: нет ошибки счета.
                    <br><b>• Детекция банкнот с большим отсутствующим фрагментом</b> позволяет убедиться в физической целостности пересчитываемых банкнот, отбраковать дефектные денежные знаки.
                    <br><b>• Детекция замятий банкнот</b> по ходу их движения в тракте позволяет избежать повреждения большого количества банкнот. Обычно замятия возникают при попадании в тракт счетчика посторонних предметов (канцелярские скрепки, бумага и т. п.). В этом случае первая просчитанная банкнота застревает, но во избежание физического повреждения остальных денежных знаков DORS CT1040 Series прекращает работу.
                    <br><b>• Магнитные датчики</b> DORS CT1040UM оптимизированы для проверки магнитных меток тенге, российских рублей, долларов США и евро.</p>
            </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        <td>Скорость счета, банкнот в минуту:</td>
                        <td>1000</td>
                    </tr>
                    <tr>

                        <td>Вместимость подающего кармана:</td>
                        <td>300 банкнот</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Отсчитываемое количество: </td>
                        <td> от 1 до 999</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Опции: </td>
                        <td>выносной светодиодный дисплей</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры, (ШхГхВ): </td>
                        <td>320х288х205 мм</td>
                    </tr>
                </tbody>
            </table>
            <div class="models">
...
$res=mysqli_query($db,"SELECT * FROM dors1040
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить жидкокристаллический счетчик банкнот у нас</h3>
                    <hr>
                </div>
