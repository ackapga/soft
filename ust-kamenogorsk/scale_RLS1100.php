            ...
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Весы Rongta RLS1100 с принтером этикеток</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                ...
                                <li data-thumb="../images/rongta_rls/rongta2.jpg">
                                    <div class="thumb-image"> <img src="../images/rongta_rls/rongta2.jpg" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/rongta_rls/rongta_3wm.jpg">
                                    <div class="thumb-image"> <img src="../images/rongta_rls/rongta_3wm.jpg" id="target" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    ...
                    <div class="description">
                        <p>Весы Rongta RLS1100 успешно могут использоваться в магазинах, в супермаркетах и на фасовке, они не только могут взвешивать товар, но и производить полную калькуляцию покупки. Вакуумно-флуоресцентный дисплей покупателя установлен
                ...
                <div class="bootstrap-tab-text-grids">
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        ...
                        <div class="container">
                            ...
                            <p style="line-height:normal ">Главным преимуществом оборудования является высокая точность измерений. Максимальный предел взвешивания - 30 кг. Устройства широко применяются в быту, в сфере продаж (подходят для магазинов), на предприятиях общественного питания,
                                в фармацевтических компаниях и т. д. </p>
                            <div class="clearfix "> </div>
                        </div>
                    </div>
...
$res=mysqli_query($db,"SELECT * FROM scaleRLS1100
