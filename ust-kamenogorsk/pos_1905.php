        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                ...
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/1905/ava.png">
                                    <div class="thumb-image"> <img src="../images/1905/ava.png" id="target" class="img-responsive"> </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Сенсорный монитор 1905, белый</h1>
                    <hr>
                    <p class="code-products">Код товара: 5148</p>
                    ...
                    <div class="description">
                        <p><b>Сенсорный монитор</b> 1905 белый имеет новый компактный дизайн, сенсорный монитор с высокой чувствительностью. Идеально подойдет для автоматизации любой торговли: супермаркетов, магазинов, кафе или же аптек.</p>
                        <br>
                        ...
                        <div><button id="fly" class="add_item" data-id="5148" data-title="<a href='https://softgroup.kz/pos_1905.php'>Сенсорный монитор 1905</a>" data-price="130000" data-quantity="1" data-img="https://softgroup.kz/images/1905/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
