...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scaletbsa
   ...
   else $res=mysqli_query($db,"insert into scaletbsa (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Напольные товарные весы ТВ-S_A013 купить по доступным ценам в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы напольные, масса к, электронные, ТВ-S_A013, товарные, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Напольные весы ТВ-S_A013 купить в Усть-Каменогорске. Огромный выбор электронных весов для товаров. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_tbs_a.php">Актау</a></li>
                            <li><a href="../aktobe/scale_tbs_a.php">Актобе</a></li>
                            <li><a href="../scale_tbs_a.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_tbs_a.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_tbs_a.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_tbs_a.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_tbs_a.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_tbs_a.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_tbs_a.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_tbs_a.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_tbs_a.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_tbs_a.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_tbs_a.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_tbs_a.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_tbs_a.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_tbs_a.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_tbs_a.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_tbs_a.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_tbs_a.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_tbs_a.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы товарные ТВ-S_A01/TB3</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/60.jpg">
                                <div class="thumb-image"> <img src="../images/scale/60.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/606.jpg">
                                <div class="thumb-image"> <img src="../images/scale/606.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы товарные ТВ-S_A01/TB3</h2>
                <hr>
                <p class="code-products">Код товара: 5014</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">60 940 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <p>Дополнительные режимы работы:
                        <br>• счетный режим (подсчет количества штучного товара по весу)
                        <br>• режим процентного взвешивания
                        <br>• компараторный режим взвешивания (достижение заданного веса сопровождается звуковым и визуальным сигналами)
                        <br>• подсчет суммарной массы товара
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_tbs_a.php'>Весы  товарные ТВ-S_A01/TB3</a>" data-price="60940" data-quantity="1" data-img="https://softgroup.kz/images/scale/60.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg10.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel6.png"></div>
        ...
        <div class="container">
            ...
            <p>Весовой терминал с печатью этикеток RL:</p>
            <table class="zui-table zui-table-zebra zui-table-horizontal">
...
$res=mysqli_query($db,"SELECT * FROM scaletbsa
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить напольные товарные весы у нас</h3>
                    <hr>
                </div>
