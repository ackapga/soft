...
<head>
    ...
    <title>Монитор кассира купить в Усть-Каменогорске| Широкий выбор Pos-мониторов SSD 64 ГБ</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="монитор кассира, для кассы, pos мониторы, 64 гб, ssd, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Сенсорный монитор кассира в Усть-Каменогорске по выгодной цене от Softgroup. Высококачественный монитор кассира предназначен для автоматизации магазина">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/pos_t8_64.php">Актау</a></li>
                            <li><a href="../aktobe/pos_t8_64.php">Актобе</a></li>
                            <li><a href="../pos_t8_64.php">Алматы</a></li>
                            <li><a href="../atyrau/pos_t8_64.php">Атырау</a></li>
                            <li><a href="../janaozen/pos_t8_64.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/pos_t8_64.php">Жезказган</a></li>
                            <li><a href="../karaganda/pos_t8_64.php">Караганда</a></li>
                            <li><a href="../kokshetau/pos_t8_64.php">Кокшетау</a></li>
                            <li><a href="../kostanai/pos_t8_64.php">Костанай</a></li>
                            <li><a href="../kyzylorda/pos_t8_64.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_t8_64.php">Астана</a></li>
                            <li><a href="../pavlodar/pos_t8_64.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/pos_t8_64.php">Петропавловск</a></li>
                            <li><a href="../semei/pos_t8_64.php">Семей</a></li>
                            <li><a href="../taldykorgan/pos_t8_64.php">Талдыкорган</a></li>
                            <li><a href="../taraz/pos_t8_64.php">Тараз</a></li>
                            <li><a href="../turkestan/pos_t8_64.php">Туркестан</a></li>
                            <li><a href="../uralsk/pos_t8_64.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/pos_t8_64.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/pos_t8_64.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Монитор кассира T8 Pro, черный</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/avatars/T8_PRO.jpg">
                                <div class="thumb-image"> <img src="../images/avatars/T8_PRO.jpg" id="target" class="img-responsive"> </div>
                            </li>

                            <li data-thumb="../images/monitor/2111.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/2111.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/211.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/211.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Монитор кассира T8 Pro, черный</h1>
                <hr>
                <p class="code-products">Код товара: 1008</p>
                <p><span class="item_price">189 000 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Монитор кассира</b> черного цвета с 15,6-дюймовой диагональю экрана с высокой чувствительностью является главным отличием и достоинством. Модель имеет жесткий диск типа SSD 64 ГБ. Дисплей покупателя имеет возможность показывать клиенту то, что он заказывает.</p>
                    <br>
                    ...
                    <div> <button id="fly" class="add_item" data-id="8" data-title="<a href='https://softgroup.kz/pos_t8_64.php'>Монитор кассира T8, черный Pro</a>" data-price="189000" data-quantity="1" data-img="https://softgroup.kz/images/avatars/T8_PRO.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
