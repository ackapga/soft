...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into thermalprinter8251
   ...
   else $res=mysqli_query($db,"insert into thermalprinter8251 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Кассовый принтер купить в Усть-Каменогорске - Доступные цены на кассовые принтеры</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="кассовый принтер, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Купить кассовый принтер в Усть-Каменогорске по доступным ценам. Осуществляем продажу кассовых принтеров в широком ассортименте от Softgroup">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/thermalprinter_8251.php">Актау</a></li>
                            <li><a href="../aktobe/thermalprinter_8251.php">Актобе</a></li>
                            <li><a href="../thermalprinter_8251.php">Алматы</a></li>
                            <li><a href="../atyrau/thermalprinter_8251.php">Атырау</a></li>
                            <li><a href="../janaozen/thermalprinter_8251.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/thermalprinter_8251.php">Жезказган</a></li>
                            <li><a href="../karaganda/thermalprinter_8251.php">Караганда</a></li>
                            <li><a href="../kokshetau/thermalprinter_8251.php">Кокшетау</a></li>
                            <li><a href="../kostanai/thermalprinter_8251.php">Костанай</a></li>
                            <li><a href="../kyzylorda/thermalprinter_8251.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/thermalprinter_8251.php">Астана</a></li>
                            <li><a href="../pavlodar/thermalprinter_8251.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/thermalprinter_8251.php">Петропавловск</a></li>
                            <li><a href="../semei/thermalprinter_8251.php">Семей</a></li>
                            <li><a href="../taldykorgan/thermalprinter_8251.php">Талдыкорган</a></li>
                            <li><a href="../taraz/thermalprinter_8251.php">Тараз</a></li>
                            <li><a href="../turkestan/thermalprinter_8251.php">Туркестан</a></li>
                            <li><a href="../uralsk/thermalprinter_8251.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/thermalprinter_8251.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/thermalprinter_8251.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/thermalprinter/4.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/4.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/44.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/44.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/444.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/444.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Кассовый принтер 8251</h1>
                <hr>
                <p class="code-products">Код товара: 3006</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">61 900 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Кассовый принтер 8251</b> с автоотрезчиком печатает чеки на термобумаге шириной до 80 миллиметров со скоростью 260 миллиметров в секунду. Данное устройство отличается эргономичным дизайном и простотой в эксплуатации.</p>
                    ...
                    <button id="fly" class="add_item" data-id="20" data-title="<a href='https://softgroup.kz/thermalprinter_8251.php'>Кассовый принтер 8251</a>" data-price="61900" data-quantity="1" data-img="https://softgroup.kz/images/thermalprinter/4.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
        </div>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/thermalprinter/80_2.png"></div>
                    <div class="wthree_text_info">
                        <h2>Высокая скорость печати кассового принтера</h2>
                    </div>
                    <p style="line-height:normal">Принтер чеков с автоотрезчиком печатает чеки на термобумаге шириной до 80 миллиметров со скоростью 260 миллиметров в секунду. Данное устройство отличается эргономичным дизайном и простотой в эксплуатации.</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
            ...
            <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                <div class="container">
                    <div style="text-align:center; margin-top:0px">
                        <img src="../images/thermalprinter/auto5.png" style="text-align:center; margin-top:10px"></div>
...
$res=mysqli_query($db,"SELECT * FROM thermalprinter8251
        ...
        <div class="w3_agile_latest_arrivals">
            ...
            <div class="col-md-3 product-men single">
                <div class="men-pro-item">
                    ...
                    <div class="item-info-product ">
                        <h4><a href="thermalprinter_8030.php">Кассовый принтер 8030</a></h4>
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить кассового принтера у нас:</h3>
                    <hr>
                </div>
