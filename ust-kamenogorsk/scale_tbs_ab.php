...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scaletbsab
   ...
   else $res=mysqli_query($db,"insert into scaletbsab (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Напольные весы ТВ-S_АB(RUEW)1 купить по доступным ценам в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы напольные, масса к, электронные, ТВ-S_АB(RUEW)1, товарные, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Напольные весы ТВ-S_АB(RUEW)1 купить в Усть-Каменогорске. Огромный выбор электронных весов для товаров. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_tbs_ab.php">Актау</a></li>
                            <li><a href="../aktobe/scale_tbs_ab.php">Актобе</a></li>
                            <li><a href="../scale_tbs_ab.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_tbs_ab.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_tbs_ab.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_tbs_ab.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_tbs_ab.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_tbs_ab.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_tbs_ab.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_tbs_ab.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_tbs_ab.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_tbs_ab.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_tbs_ab.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_tbs_ab.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_tbs_ab.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_tbs_ab.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_tbs_ab.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_tbs_ab.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_tbs_ab.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_tbs_ab.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/90.jpg">
                                <div class="thumb-image"> <img src="../images/scale/90.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/909.jpg">
                                <div class="thumb-image"> <img src="../images/scale/909.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/9099.jpg">
                                <div class="thumb-image"> <img src="../images/scale/9099.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <div class="description">
                    <p>Весы состоят из модуля взвешивающего и терминала, которые соединены между собой 5-метровым кабелем. Грузоприемная платформа может быть размещена на полу или на столе. Терминал может быть закреплен на стене. Крепление терминала входит в комплект поставки. Весы легко интегрируются с учетными, кассовыми программами и кассами. 1C совместимы. Возможна работа в счетном и дозаторном режиме, режимах процентного взвешивания и контроля массы (компараторный режим). Обмен информацией с внешними устройствами реализован по интерфейсам RS-232, USB, Ethernet и Wi-Fi.</p>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg18.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel11.png"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> кабель удлинительный (5 м) -1 шт.;</td>
                    </tr>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Материал корпуса терминала: </td>
                    ...
                    <tr>
                        ...
                        <td>Интерфейсы для подключения: R</td>
                        <td>RS-232, USB, Ethernet, Wi-Fi;</td>
                    </tr>
                    <tr>

                        <td>В комплекте поставки: </td>
                        <td>- сетевой адаптер 1шт, кабель переходной 4D - 1 шт, крепление терминала к стене-1 шт., крепление терминала к стойке- 2шт, Патч-корд 2м-13шт.</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM scaletbsab
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить напольные весы у нас</h3>
                    <hr>
                </div>
