    ...
    $rating=htmlspecialchars($_POST["rating"]);
     ...
     if ($mess_login!='' and $user_text!=''){
      if (is_numeric($_POST["parent_id"]) and is_numeric($_POST["f_parent"]))
       $res=mysqli_query($db,"insert into acoustomagnetic_tag
      ...
      else $res=mysqli_query($db,"insert into acoustomagnetic_tag (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Акустомагнитная бирка Карандаш в Усть-Каменогорске | Противокражные ворота акустомагнитные купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Акустомагнитная бирка, Карандаш,  для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить акустомагнитную бирку Карандаш для магазина в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных противокражных систем.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/acoustomagnetic_tag.php">Актау</a></li>
                            <li><a href="../aktobe/acoustomagnetic_tag.php">Актобе</a></li>
                            <li><a href="../acoustomagnetic_tag.php">Алматы</a></li>
                            <li><a href="../atyrau/acoustomagnetic_tag.php">Атырау</a></li>
                            <li><a href="../janaozen/acoustomagnetic_tag.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/acoustomagnetic_tag.php">Жезказган</a></li>
                            <li><a href="../karaganda/acoustomagnetic_tag.php">Караганда</a></li>
                            <li><a href="../kokshetau/acoustomagnetic_tag.php">Кокшетау</a></li>
                            <li><a href="../kostanai/acoustomagnetic_tag.php">Костанай</a></li>
                            <li><a href="../kyzylorda/acoustomagnetic_tag.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/acoustomagnetic_tag.php">Астана</a></li>
                            <li><a href="../pavlodar/acoustomagnetic_tag.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/acoustomagnetic_tag.php">Петропавловск</a></li>
                            <li><a href="../semei/acoustomagnetic_tag.php">Семей</a></li>
                            <li><a href="../taldykorgan/acoustomagnetic_tag.php">Талдыкорган</a></li>
                            <li><a href="../taraz/acoustomagnetic_tag.php">Тараз</a></li>
                            <li><a href="../turkestan/acoustomagnetic_tag.php">Туркестан</a></li>
                            <li><a href="../uralsk/acoustomagnetic_tag.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/acoustomagnetic_tag.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/acoustomagnetic_tag.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Акустомагнитные бирки в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li><a href="eas.html">Антикражное оборудование</a><i>/</i></li><li><a href="magnetic.html">Акустомагнитная антикражная система</a><i>/</i></li>
                        <li>Акустомагнитная бирка Карандаш</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/2.jpg">
                                <div class="thumb-image"> <img src="../images/eas/2.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/44.jpg">
                                <div class="thumb-image"> <img src="../images/eas/44.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/4444.jpg">
                                <div class="thumb-image"> <img src="../images/eas/4444.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Акустомагнитная бирка Карандаш</h2>
                <hr>
                <p class="code-products">Код товара: 9039</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">57 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Акустомагнитная бирка Карандаш</b> Антикражная этикетка основана на акустомагнитной технологии, и работает на частоте 58KHz. Антикражная этикетка имитирует штрих-кодовую этикетку, крепко приклеивается на изделие и защищает его от несанкционированного выноса из магазина.  Внутри защитной этикетки располагаются три металлические пластины с изоляторами между ними (двухконтурная деактивируемая защитная этикетка).
</p>
                    <br>
                    <h3><b>Преимущества акустомагнитных бирок:</b></h3>
					<p><i class="fa fa-check"></i>  Двойной контур обеспечивает усиленный сигнал, что увеличивает процент срабатывания.</p>
					<p><i class="fa fa-check"></i>  За счет своих малых размеров (44,6 х 10,16 х 1,73 мм) этикетки могут применяться для защиты мелких товаров.
                    ...
                    <button id="fly" class="add_item" data-id="81" data-title="<a href='https://softgroup.kz/acoustomagnetic_tag.php'>Акустомагнитная бирка Карандаш</a>" data-price="57" data-quantity="1" data-img="https://softgroup.kz/images/eas/2.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
			...
			<div class="bootstrap-tab-text-grid">
                    ...
                    <div class="container">
					  <div class="models" style="margin-top:50px">
                            <p style="font-size:1.9em">Цвета могут быть</p>
                            <hr>
                        </div>
					  <div style="text-align:center">
                            <img src="../images/eas/p14.jpg"></div>
                        <div class="clearfix"> </div>
                 ...
                 <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  margin:20px 0 10px 0">
                    <div class="container">
                        <div class="models" style="margin-top:50px">
                         ...
                         <div style="text-align:center">
                            <img src="../images/eas/p19.png"></div>
							 <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Крепление с помощью троса игла-петля</p>
                        <p style="line-height:normal; margin-bottom:10px">Антикражные тросики «петля - игла» предназначены специально для крепления к тем товарам, на которых нельзя зафиксировать датчик при помощи клипсы. Тросики имеют полимерное покрытие, которое не повреждает защищаемый с помощью датчика товар.</p> 
                       <div class="clearfix"> </div>
				 ...
				 <div class="bootstrap-tab-text-grid">
                    ...
                    <div class="container">
					  <div style="text-align:center">
                            <img src="../images/eas/p18.png"></div>
							 <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Крепление с помощью гвоздика.</p>
                        <p style="line-height:normal; margin-bottom:20px">Акустомагнитная бирка Карандаш крепится на одежду, либо на другой товар с помощью гвоздика. Благодаря своему небольшому размеру, гвоздик продевается через шов или через петлю в одежде и вставляется в отверстие бирки.</p>
				...
				<div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  margin:20px 0 10px 0">
                    ...
                    <div class="container"> 
						 ...
						 <div style="text-align:center; margin: 20px 0 20px 20px">
                            <img src="../images/eas/p44.png"></div>
							<p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0"><a href="puller_universal.php">Снятие бирок</a></p>
                        <p style="line-height:normal; margin-bottom:20px">Съемник предназначен для снятия любых датчиков антикражных систем с магнитным замком. Сила магнита 12000 Гс позволяет открывать все типы противокражных бирок.</p>
				 ...
				 <div class="bootstrap-tab-text-grid">
                    <div class="container">
						  ...
						  <div style="float:left; margin:10px 20px 10px 0px">
                            <img src="../images/eas/p10.png"></div>
							 <div class="eas" style="margin-top:100px"><p style="color:#ff9601;" ><a href="acoustomagnetic.php">Акустомагнитные противокражные ворота</a></p></div>
                        <p style="line-height:normal; margin-bottom:20px">Акустомагнитные противокражные системы имеют самый высокий коэффициент срабатывания более 95 % и отличаются высокой помехоустойчивостью. Диапазон, в котором работают акустомагнитные антикражные системы, меньше других подвержен шумам и другим помехам, поэтому для них характерна низкая степень ложных срабатываний.</p>
                       <div class="clearfix"> </div>
</div>
                    </div><div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  margin:20px 0 10px 0">
				
                 <div class="container">
                       <div style="float:left; margin-right:20px">
                            <img src="../images/eas/p13.png"></div>
							 <div class="eas" style="margin-top:20px"><p style="color:#ff9601;" ><a href="acoustomagnetic_bottle.php">Акустомагнитная бирка Bottle tag</a></p></div>
                        <p style="line-height:normal">Бирка акустомагнитная - компактный датчик для защиты бутылок от краж. Металлический трос надежно зажимает горлышко бутылки, что предотвращает возможность снятия датчика без специального съемника.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика акустомагнитной бирки Карандаш</p>
                <hr>
            </div>
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>1000 шт.  (Продается штучно)  </td>
                    </tr>
                </tbody>
            </table>
            <div class="models">
...
$res=mysqli_query($db,"SELECT * FROM acoustomagnetic_tag
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить акустомагнитной бирки у нас:</h3>
                    <hr>
                </div>
