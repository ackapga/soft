...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into pos3072
   ...
   else $res=mysqli_query($db,"insert into pos3072 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>POS монитор купить | Монитор с сенсорным экраном черного цвета для кассы</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="сенсорный монитор, для кассы, монитор с сенсорным экраном, pos монитор, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Купить сенсорный монитор черного цвета по выгодной цене от компании Softgroup. Широкий выбор продукции Pos-мониторов с сенсорным экраном">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/pos_3072_black.php">Актау</a></li>
                            <li><a href="../aktobe/pos_3072_black.php">Актобе</a></li>
                            <li><a href="../pos_3072_black.php">Алматы</a></li>
                            <li><a href="../atyrau/pos_3072_black.php">Атырау</a></li>
                            <li><a href="../janaozen/pos_3072_black.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/pos_3072_black.php">Жезказган</a></li>
                            <li><a href="../karaganda/pos_3072_black.php">Караганда</a></li>
                            <li><a href="../kokshetau/pos_3072_black.php">Кокшетау</a></li>
                            <li><a href="../kostanai/pos_3072_black.php">Костанай</a></li>
                            <li><a href="../kyzylorda/pos_3072_black.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_3072_black.php">Астана</a></li>
                            <li><a href="../pavlodar/pos_3072_black.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/pos_3072_black.php">Петропавловск</a></li>
                            <li><a href="../semei/pos_3072_black.php">Семей</a></li>
                            <li><a href="../taldykorgan/pos_3072_black.php">Талдыкорган</a></li>
                            <li><a href="../taraz/pos_3072_black.php">Тараз</a></li>
                            <li><a href="../turkestan/pos_3072_black.php">Туркестан</a></li>
                            <li><a href="../uralsk/pos_3072_black.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/pos_3072_black.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/pos_3072_black.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Сенсорный монитор 3072, черный</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/3072.png">
                                <div class="thumb-image"> <img src="../images/monitor/3072.png" id="target" class="img-responsive"> </div>
                            <li data-thumb="../images/monitor/3072_2.png">
                                <div class="thumb-image"> <img src="../images/monitor/3072_2.png" class="img-responsive"> </div>
                            <li data-thumb="../images/monitor/3072_3.png">
                                <div class="thumb-image"> <img src="../images/monitor/3072_3.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Сенсорный монитор 3072, черный</h1>
                <hr>
                <p class="code-products">Код товара: 1002</p>
                ...
                <div class="description">
                    <p><b>Сенсорный монитор</b> 3072 черный имеет новый компактный дизайн, сенсорный монитор с высокой чувствительностью. Идеально подойдет для автоматизации любой торговли: супермаркетов, магазинов, кафе или же аптек.</p>
                    <br>
                    <h3><b>В состав cенсорного монитор входит:</b></h3>
                    <p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800;</p>
                    <p><i class="fa fa-check"></i> Сенсорный экран кассира с 12.1-дюймовым диагональю экрана;</p>
                    <p><i class="fa fa-check"></i> Дисплей покупателя: 2 строки, 40 символов.</p>
                    <img src="../images/monitor/icon2.png">
                    <div><button id="fly" class="add_item" data-id="2" data-title="<a href='https://softgroup.kz/pos_3072_black.php'>Сенсорный монитор 3072, черный</a>" data-price="163800" data-quantity="1" data-img="https://softgroup.kz/images/monitor/3072.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/monitor/color.png"></div>
                        ...
                        <p style="line-height:normal">Корпус сенсорного монитора доступен в двух цветах на выбор: <b>черный и белый.</b> Монитор в корпусе белого цвета дополнит рабочий стол. Классический черный цвет корпуса отлично впишется в любую обстановку.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/vfd2.jpg" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/monitor/sensor5.png" style="text-align:center; "></div>
                        <div class="wthree_text_info">
                            <h2>Чувствительный монитор с сенсорным экраном</h2>
                        </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/d7.png" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Яркий цветной дисплей</p>
                        <p style="line-height:normal">Сенсорный экран моноблока имеет диагональ 12,1 дюйма, что предоставляет высочайший комфорт при работе с устройством и повышает удобство для сотрудников при работе с большим объемом данных. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/wifi_1.png" style="text-align:center; margin-top:20px"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/congif1.jpg" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Набор интерфейсов</p>
                        <p style="line-height:normal">Все интерфейсные разъёмы расположены в нижней части устройства: разъём питания, 2 СОМ порта для передачи данных, VGA порт для подключения мониторов, PS/2 порты для подключения клавиатуры и мыши, LPT порт для подключения различных периферийных устройств, четыре разъёма USB порта (2 из них последняя версия стандарта USB 3.0), RJ порт для подключения локальной сети и два разъёма для передачи аудиосигнала.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        ...
                        <td>Дисплей:</td>
                        <td>12.1-дюймовый сенсорный экран</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Интерфейс:</td>
                        <td>6 USB <br>1 PS/2 клавиатура <br>1 PS/2 мышь <br> 1 LAN port<br>2 Serial ports<br>1 VGA port<br>1 Parallel port<br> 1 Audio Input / 1 Output</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM pos3072
