    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scanner/30.png">
                                <div class="thumb-image"> <img src="../images/scanner/30.png" id="target" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Стойка для сканера 6900</h1>
                <hr>
                <p class="code-products">Код товара: 2009</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">1 260 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Стандартная стойка для сканера штрих-кода 6900 предназначена для непрерывного сканирования, то есть в режиме “Hands-Free”. Она надежно закрепляется у основания сканера.</p><br>
                    ...
                    <button id="fly" class="add_item" data-id="29" data-title="<a href='https://softgroup.kz/stoika.php'>Стойка для сканера 6900</a>" data-price="1260" data-quantity="1" data-img="https://softgroup.kz/images/scanner/30.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <div class="models">
