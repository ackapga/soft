...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into thermalprinter5802
   ...
   else $res=mysqli_query($db,"insert into thermalprinter5802 (date, theme_id, login, message, rating)
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Принтер чеков Rongta 58E</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/58Ewith wm/1.jpg">
                                <div class="thumb-image" id="thumb-image"> <img src="../images/58Ewith wm/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/58Ewith wm/2.jpg">
                                <div class="thumb-image"> <img src="../images/58Ewith wm/2.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/58Ewith wm/3.jpg">
                                <div class="thumb-image"> <img src="../images/58Ewith wm/3.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Принтер чеков Rongta 58E</h1>
                <hr>
                <p class="code-products">Код товара: 5381</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">14 742 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>
                        <b>Принтер чеков Rongta 58 E</b> обладает скоростью печати 90 мм/сек. Термопринтер имеет компактные размеры корпуса и предназначен для печати на 58мм термоленте. Термопринтер чеков успешно используется в крупных торговых сетях,
                    ...
                    <button id="fly" class="add_item " data-id="5381" data-title="<a href='https://softgroup.kz/thermalprinter_58E.php'>Принтер чеков Rongta 58E</a>" data-price="14742" data-quantity="1" data-img="https://softgroup.kz/images/58Ewith wm/1.jpg" data-count="100500"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/58Ewith wm/3RM.png" style="width: 500px;"></div>
...
$res=mysqli_query($db,"SELECT * FROM thermalprinter5802
