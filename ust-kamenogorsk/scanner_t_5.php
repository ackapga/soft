...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scannert5
   ...
   else $res=mysqli_query($db,"insert into scannert5 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Сканер для считывания штрих кодов купить в Усть-Каменогорске по низким ценам - Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="сканер для считывания штрих кодов, купить, для кассы, Усть-Каменогорск, для магазина, цена, продажа." />
    <meta name="description" content="Высококачественный светодиодный сканер для считывания штрих кодов купить в Усть-Каменогорске. Широкий выбор сканеров для считывания штрих кода от Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scanner_t_5.php">Актау</a></li>
                            <li><a href="../aktobe/scanner_t_5.php">Актобе</a></li>
                            <li><a href="../scanner_t_5.php">Алматы</a></li>
                            <li><a href="../atyrau/scanner_t_5.php">Атырау</a></li>
                            <li><a href="../janaozen/scanner_t_5.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scanner_t_5.php">Жезказган</a></li>
                            <li><a href="../karaganda/scanner_t_5.php">Караганда</a></li>
                            <li><a href="../kokshetau/scanner_t_5.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scanner_t_5.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scanner_t_5.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scanner_t_5.php">Астана</a></li>
                            <li><a href="../pavlodar/scanner_t_5.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scanner_t_5.php">Петропавловск</a></li>
                            <li><a href="../semei/scanner_t_5.php">Семей</a></li>
                            <li><a href="../taldykorgan/scanner_t_5.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scanner_t_5.php">Тараз</a></li>
                            <li><a href="../turkestan/scanner_t_5.php">Туркестан</a></li>
                            <li><a href="../uralsk/scanner_t_5.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scanner_t_5.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scanner_t_5.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scanner/3.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/3.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/33.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/33.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/333.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/333.jpg" id="target" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Сканер для считывания штрих кодов T5</h1>
                <hr>
                <p class="code-products">Код товара: 2002</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">15 120 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Светодиодный сканер для считывания штрих кодов</b> T5 может считывать любые штрих коды. Главным преимуществом сканера T5 является - считывание штрих-кодов прямо с экрана смартфона или монитора компьютера.</p>
                    <h3><b>Вид сканера для считывания штрих кодов:</b></h3>
                    <p><i class="fa fa-check"></i> По типу считывающего элемента – светодиодный</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scanner_t_5.php'>Сканер штрих кода T5</a>" data-price="15120" data-quantity="1" data-img="https://softgroup.kz/images/scanner/3.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scanner/shtrih.png"></div>
                ...
                <div class="bootstrap-tab-text-grid">
                    <div class="container">
                        ...
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Cчитывание штрих-кодов с экрана</p>
...
$res=mysqli_query($db,"SELECT * FROM scannert5
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h2>Причины купить сканера для считывания штрих кодов:</h2>
                    <hr>
                </div>
