...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Принтер этикеток купить в Усть-Каменогорске | Принтер для печати этикеток шириной 76 мм</title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="Принтер этикеток, с термопечатью, на термоленте, для кассы, для печати, шириной 76 мм, Усть-Каменогорск, купить, цена, продажа." />
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                ...
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/3120TL/2.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TL/2.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3120TL/4.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TL/4.jpg" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3120TL/1.jpg">
                                    <div class="thumb-image"> <img src="../images/3120TL/1.jpg" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Принтер этикеток 3120TL</h1>
                    <hr>
                    <p class="code-products">Код товара: 1821</p>
                    ...
                    <div class="description">
                        <p>Высокопроизводительный принтер 3120TL со скоростью 127 мм/сек с разрешением 203 dpi имеет превосходные технические характеристики для печати этикеток шириной 76 мм. Данный принетер является безупречным решением для организации
                        ...
                        <button id="fly" class="add_item" data-id="1821" data-title="<a href='https://softgroup.kz/label_3120tl.php'>Принтер этикеток 3120TL</a>" data-price="44100" data-quantity="1" data-img="https://softgroup.kz/images/3120TL/2.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
            ...
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container ">
                        <div style="text-align:center; margin-top:0px ">
                            <img src="../images/3120TL/4.png " style="text-align:center; margin-top:10px; width: 65%; ">
                        </div>
                        <div class="wthree_text_info ">
                            <h2>Высокая скорость печати принтера этикеток</h2>
                        </div>
                        <p style="line-height:normal ">Принтер этикеток позволяет печатать на ленте шириной от 23 до 80мм, скорость печати принтера составляет 203мм/сек, разрешение печати - 203dpi</p>
                ...
                <div class="container ">
                    <div style="text-align:center; margin-top:0px ">
                        <img src="../images/3120TL/sep.png " style="text-align:center; margin-top:10px; width: 45%; "></div>
                    <p class="wthree_text_info " style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0 ">Функция автоотделение </p>
                    <p style="line-height:normal ">Данная функция  используется для автоматического отделения этикеток от бумажной подложки. В режиме автоотделение принтер печатает следующую этикетку как только предыдущая этикетка будет убрана оператором. Такой подход печати может обеспечить экономию времени для вашего бизнеса.</p>
                    <div class="clearfix "> </div>
                </div>
            </div>
            ...
            <div class="bootstrap-tab-text-grid " style="background-color: #fff; padding-bottom:20px ">
                <div class="container ">
                    <div style="text-align:center; margin-top:0px ">
                        <img src="../images/3120TL/usb.png " style="text-align:center; width: 45%; "></div>
...
for ($i=0; $i<=count($tag[$up])-1; $i++) {
 ...
 echo str_replace("<br />","<br>",nl2br($tag[$up][$i][1])).'</div>'; if (isset($tag[ $tag[$up][$i][0] ])) parents($tag[$up][$i][0],20); echo '</div>
        </div>'; } } $res=mysqli_query($db,"SELECT * FROM label3120 WHERE theme_id='".$theme_id."' ORDER BY id"); $number=mysqli_num_rows($res); if ($number>0) { echo '
