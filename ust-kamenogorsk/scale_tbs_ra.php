...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scaletbsra
   ...
   else $res=mysqli_query($db,"insert into scaletbsra (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы товарные ТВ-S_RA с регистрацией товароучетных операций купить в Усть-Каменогорске</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="масса к, электронные, ТВ-S_RA, с регистрацией товароучетных операций, товарные, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Весы с регистрацией товароучетных операций купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_tbs_ra.php">Актау</a></li>
                            <li><a href="../aktobe/scale_tbs_ra.php">Актобе</a></li>
                            <li><a href="../scale_tbs_ra.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_tbs_ra.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_tbs_ra.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_tbs_ra.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_tbs_ra.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_tbs_ra.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_tbs_ra.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_tbs_ra.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_tbs_ra.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_tbs_ra.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_tbs_ra.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_tbs_ra.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_tbs_ra.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_tbs_ra.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_tbs_ra.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_tbs_ra.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_tbs_ra.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_tbs_ra.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
            <h1>Весы с регистрацией товароучетных операций</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы товарные ТВ-S_AB с влагозащищенным терминалом</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/91.jpg">
                                <div class="thumb-image"> <img src="../images/scale/91.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/911.jpg">
                                <div class="thumb-image"> <img src="../images/scale/911.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/9111.jpg">
                                <div class="thumb-image"> <img src="../images/scale/9111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы товарные ТВ-S_RA с регистрацией товароучетных операций</h2>
                <hr>
                <p class="code-products">Код товара: 5017</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">96 285 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Напольные товарные весы с вертикальной стойкой. Возможна работа в счетном режиме. Обеспечена возможность подключения к весам сканера штрихкодов и дозатора. Весы регистрируют товароучетные операции (прием, отпуск, списание, инвентаризация). Легко интегрируются в системы учета, в том числе в режиме весового терминала сбора данных. Обмен информацией с внешними устройствами реализован по интерфейсам Ethernet и RS-232, а также с помощью USB-flash накопителя.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_tbs_ra.php'>Весы  товарные ТВ-S_RA с регистрацией товароучетных операций</a>" data-price="96285" data-quantity="1" data-img="https://softgroup.kz/images/scale/91.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg15.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel8.png"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>USB-flash накопителя, сканера штрихкодов, дозатора и др.: USB тип А, DB9-MА/вилка (интерфейс RS-232), TJ1A-4P4C;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> - кронштейн крепления терминала на стене - 1шт, кронштейн крепления терминала на стойке ST4D - 1шт, сетевой адаптер- 1 шт.;</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM scaletbsra
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить весы товароучетные у нас</h3>
                    <hr>
                </div>
