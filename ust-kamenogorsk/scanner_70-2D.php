...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner70-2D
   ...
   else $res=mysqli_query($db,"insert into scanner70-2D (date, theme_id, login, message, rating)
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                ...
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/70-2D/1.jpg">
                                    <div class="thumb-image"> <img src="../images/70-2D/1.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/70-2D/2.jpg">
                                    <div class="thumb-image"> <img src="../images/70-2D/2.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/70-2D/3.jpg">
                                    <div class="thumb-image"> <img src="../images/70-2D/3.jpg" id="target" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Стационарный сканер штрих кодов 70-2D</h1>
                    <hr>
                    <p class="code-products">Код товара: 4908</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">44 100 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Стационарный сканер штрих кода 70-2D настольного типа использует несколько десятков лазерных лучей. Благодаря этой функции кассиру не требуется специальным образом ориентировать штрих-код перед сканером, одна из сканирующих линий
                            обязательно его пересечёт в любом положении. Имиджевый сканер штрих кодов максимально удобен и эффективен в работе. Также данный модель настольного сканера легко справляется с большим потоком клиентов и может сканировать 3600
                            строк скана в минуту.
                        </p>
                        <br>
                        ...
                        <button id="fly" class="add_item" data-id="4908" data-title="<a href='https://softgroup.kz/scanner_70-2D.php'>Сканер штрих кода 70-2D</a>" data-price="44100" data-quantity="1" data-img="https://softgroup.kz/images/template.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                    </div>
                </div>
            </div>
            <div class="clearfix"> </div>
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grids">
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/70-2D/1o.png" style="width: 40%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/70-2D/2o.png" style="width: 40%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/70-2D/3o.png" style="width: 40%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/70-2D/4.png" style="width: 40%;"></div>
...
$res=mysqli_query($db,"SELECT * FROM scanner70-2D
