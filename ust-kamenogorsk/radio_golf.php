...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into radio_golf
   ...
   else $res=mysqli_query($db,"insert into radio_golf (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Радиочастотная бирка Golf купить в Усть-Каменогорске | Антикражные системы </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Радиочастотная бирка, Golf, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить радиочастотные бирки Golf в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/radio_golf.php">Актау</a></li>
                            <li><a href="../aktobe/radio_golf.php">Актобе</a></li>
                            <li><a href="../radio_golf.php">Алматы</a></li>
                            <li><a href="../atyrau/radio_golf.php">Атырау</a></li>
                            <li><a href="../janaozen/radio_golf.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/radio_golf.php">Жезказган</a></li>
                            <li><a href="../karaganda/radio_golf.php">Караганда</a></li>
                            <li><a href="../kokshetau/radio_golf.php">Кокшетау</a></li>
                            <li><a href="../kostanai/radio_golf.php">Костанай</a></li>
                            <li><a href="../kyzylorda/radio_golf.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/radio_golf.php">Астана</a></li>
                            <li><a href="../pavlodar/radio_golf.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/radio_golf.php">Петропавловск</a></li>
                            <li><a href="../semei/radio_golf.php">Семей</a></li>
                            <li><a href="../taldykorgan/radio_golf.php">Талдыкорган</a></li>
                            <li><a href="../taraz/radio_golf.php">Тараз</a></li>
                            <li><a href="../turkestan/radio_golf.php">Туркестан</a></li>
                            <li><a href="../uralsk/radio_golf.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/radio_golf.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/radio_golf.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Радиочастотная бирка Golf</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/8.png">
                                <div class="thumb-image"> <img src="../images/eas/8.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/88.jpg">
                                <div class="thumb-image"> <img src="../images/eas/88.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/888.jpg">
                                <div class="thumb-image"> <img src="../images/eas/888.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Радиочастотная бирка Golf</h2>
                <hr>
                <p class="code-products">Код товара: 9032</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">84 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Радиочастотная бирка Golf</b>  - cамая популярная бирка. Используется в магазинах одежды и имеет высокую надежность. Благодаря особой форме его практически невозможно снять без специальных средств, не испортив защищенный товар. Бирка состоит из 2-х половинок и легко крепится на одежду, при этом не мешая покупателям в примерочной. Защитный датчик надёжно крепится на товаре, не оставляя возможности снять датчик без специального съемного устройства. Датчик Golf tag 45 мм снимается при помощи универсального магнитного съёмника антикражных датчиков. Также данный датчик работает со всеми видами радиочастотных противокражных ворот.
                    ...
                    <button id="fly" class="add_item" data-id="82" data-title="<a href='https://softgroup.kz/radio_golf.php'>Радиочастотная бирка Golf</a>" data-price="84" data-quantity="1" data-img="https://softgroup.kz/images/eas/8.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
<div class="responsive_tabs_agileits">
                    ...
                    <div class="container">
                        <div class="models" style="margin-top:50px">
                         ...
                         <div style="text-align:center">
                            <img src="../images/eas/p16.png"></div>
							 <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Крепление радиочастотной бирки</p>
                        <p style="line-height:normal; margin-bottom:20px"> Бирка состоит из 2-х половинок и легко крепится на одежду, при этом не мешая покупателям в примерочной.  Благодаря особой форме его практически невозможно снять без специальных средств, не испортив защищенный товар. </p> 
                       <div class="clearfix"> </div>
				...
				<div class="bootstrap-tab-text-grid">
                    ...
                    <div class="container"> 
						 ...
						 <div style="text-align:center;">
							...
							<p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0"><a href="puller_universal.php">Снятие радиочастотной бирки Golf</a></p>
                        <p style="line-height:normal">Защитный датчик надёжно крепится на товаре, не оставляя возможности снять датчик без специального съемного устройства. Датчик Golf tag 45 мм снимается при помощи универсального магнитного съёмника антикражных датчиков. </p>
				 ...
				 <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;  margin:20px 0 10px 0"><div class="container">
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика радиочастотной бирки Golf</p>
                <hr>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM radio_golf
