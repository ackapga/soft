...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner1695
   ...
   else $res=mysqli_query($db,"insert into scanner1695 (date, theme_id, login, message, rating)
...
<title>Сканер штрих кода для пунктах продаж, для кассы купить в Усть-Каменогорске </title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="для пунктах продаж, для кассы, сканер штрих кода, штрих кодов, кассовый аппарат, кассовое оборудование, кассовый терминал, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
<!--//tags -->
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
	     ...
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/scanner/4.jpg">
							<div class="thumb-image"> <img src="../images/scanner/4.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/scanner/44.jpg">
							<div class="thumb-image"> <img src="../images/scanner/44.jpg"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/scanner/444.jpg">
							<div class="thumb-image"> <img src="../images/scanner/444.jpg"  class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Сканер штрих кода 1695</h3>
					<hr>
					<p class="code-products">Код товара: 2005</p>
					<p><span class="item_price">20 860  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p><b>Ручной лазерный сканер штрих-кода</b> позволяет выполнять любые задачи сканирования. Сканер штрих-кода 1695 активно используется в пунктах продаж, для считывания типичных линейных штрих-кодов на этикетках, а также сложные штрих-коды с дисплеев мобильных устройств и карт лояльности.</p>
					...
					<button id ="fly" class="add_item" data-id="10" data-title="<a href='scanner_1695.php'>Сканер штрих кода 1695</a>"  data-price="20860" data-quantity="1" data-img="../images/scanner/4.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
		      </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
    ...
    <tbody>  
		...
		<tr>
            <td>Интерфейс:</td>
             <td>RS-232, клавиатурный клин, USB</td>
        </tr>
		<tr>
           
            <td>Режимы сканирования:</td>
            <td>считывания за 1 проход</td>
        </tr>
		<tr>
           
            <td>Стандартное разрешение:</td>
            <td>0.10, PCS=0.825</td>
        </tr>
		<tr>
           
            <td>Расстояние считывания:</td>
            <td>от 10 до 820 мм</td>
        </tr>
		 <tr>
...
$res=mysqli_query($db,"SELECT * FROM scanner1695
...
?>
			...
			<div class="ll"><h3 class="wthree_text_info">Похожие <span>товары</span></h3></div>
					 <div class="col-md-3 product-men single">
					   ...
					   <div class="col-md-3 product-men single">
								<div class="men-pro-item">
									<a href="scanner_8120.php">	<div class="men-thumb-item"><img src="../images/scanner/2.jpg" alt="" class="pro-image-front">
