...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors1000
   ...
   else $res=mysqli_query($db,"insert into dors1000 (date, theme_id, login, message, rating)
...
<head>
    ...
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1000 M3, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1000 M3 инфракрасные купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_1000.php">Актау</a></li>
                            <li><a href="../aktobe/dors_1000.php">Актобе</a></li>
                            <li><a href="../dors_1000.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_1000.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_1000.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_1000.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_1000.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_1000.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_1000.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_1000.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_1000.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_1000.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_1000.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_1000.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_1000.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_1000.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_1000.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_1000.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_1000.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_1000.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детектор банкнот Dors 1000</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Инфракрасные детекторы банкнот DORS 1000 M3</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/4.jpg">
                                <div class="thumb-image"> <img src="../images/detector/4.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/44.jpg">
                                <div class="thumb-image"> <img src="../images/detector/44.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/444.jpg">
                                <div class="thumb-image"> <img src="../images/detector/444.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Инфракрасные детекторы банкнот DORS 1000 M3</h2>
                <hr>
                <p class="code-products">Код товара: 9004</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">33 854 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Профессиональный инфракрасный детектор DORS 1000 М3 предназначен для визуального контроля подлинности банкнот различных валют, документов, акцизных марок и других ценных бумаг, изготовленных на защищенных бланках. </p>
                    <p>• жидкокристаллический монитор с широким углом обзора и антибликовым покрытием, гарантирующий отсутствие нагрузки на зрение при рассматривании мелких и малоконтрастных изображений;
                        <br>• широкая просмотровая зона, позволяющая проводить визуальный контроль как одной банкноты, так и банкнот, разложенных «веером», обеспечивая быструю и качественную детекцию подлинности;
                        <br>• проведение контроля возможно при любом освещении в помещении, благодаря встроенной в устройство ИК-подсветке;
                        <br>• устойчивая конструкция при небольших габаритах устройства.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_1000.php'>Инфракрасные детекторы банкнот DORS 1000 M3</a>" data-price="33854" data-quantity="1" data-img="https://softgroup.kz/images/detector/4.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Виды контроля:</td>
                        <td>Инфракрасный контроль </td>
                    </tr>
                    <tr>
                        <td>Монитор:</td>
                        <td>ЖК-монитор с диагональю 10,92 см (4,3 дюйма)</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM dors1000
