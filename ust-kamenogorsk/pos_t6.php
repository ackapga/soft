...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into post6
   ...
   else $res=mysqli_query($db,"insert into post6 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Кассовый компьютер купить в Усть-Каменогорске | Кассовый моноблок для автоматизации</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="кассовый компьютер, кассовый моноблок, Усть-Каменогорск, для автоматизации, купить, цена, продажа." />
    <meta name="description" content="Кассовый компьютер купить в Усть-Каменогорске — моноблок (с сенсорным или обычным экраном) со встроенным дисплеем для автоматизации от компании Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/pos_t6.php">Актау</a></li>
                            <li><a href="../aktobe/pos_t6.php">Актобе</a></li>
                            <li><a href="../pos_t6.php">Алматы</a></li>
                            <li><a href="../atyrau/pos_t6.php">Атырау</a></li>
                            <li><a href="../janaozen/pos_t6.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/pos_t6.php">Жезказган</a></li>
                            <li><a href="../karaganda/pos_t6.php">Караганда</a></li>
                            <li><a href="../kokshetau/pos_t6.php">Кокшетау</a></li>
                            <li><a href="../kostanai/pos_t6.php">Костанай</a></li>
                            <li><a href="../kyzylorda/pos_t6.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_t6.php">Астана</a></li>
                            <li><a href="../pavlodar/pos_t6.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/pos_t6.php">Петропавловск</a></li>
                            <li><a href="../semei/pos_t6.php">Семей</a></li>
                            <li><a href="../taldykorgan/pos_t6.php">Талдыкорган</a></li>
                            <li><a href="../taraz/pos_t6.php">Тараз</a></li>
                            <li><a href="../turkestan/pos_t6.php">Туркестан</a></li>
                            <li><a href="../uralsk/pos_t6.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/pos_t6.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/pos_t6.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/p2.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/p2.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/4.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/4.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/44.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/44.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Кассовый компьютер T6</h1>
                <hr>
                <p class="code-products">Код товара: 1009</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">205 380 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>15,6-дюймовый <b>кассовый компьютер</b> Touch LVDS с высокой чувствительностью и широким экраном отвечает всем современным требованиям. Модель имеет превосходный дизайн. А также имеет дисплей для клиента с двумя линиями.</p>
                    <br>
                    <h3><b>В состав кассового моноблока входит:</b></h3>
                    <p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800;</p>
                    <p><i class="fa fa-check"></i> Сенсорный экран кассира с 15,6-дюймовым диагональю экрана;</p>
                    <p><i class="fa fa-check"></i> Дисплей покупателя: 2 строки, 40 символов.</p>
                    <img src="../images/monitor/icon3.png">
                    <div> <button id="fly" class="add_item" data-id="9" data-title="<a href='https://softgroup.kz/pos_t6.php'>Кассовый компьютер T6</a>" data-price="205380" data-quantity="1" data-img="https://softgroup.kz/images/monitor/p2.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/vfd3.png" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/monitor/d4.png" style="text-align:center; margin-top:20px"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/congif2.jpg" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Набор интерфейсов</p>
                        <p style="line-height:normal">Все интерфейсные разъёмы расположены в нижней части устройства: разъём питания, СОМ порт для передачи данных, VGA порт для подключения мониторов, PS/2 порты для подключения клавиатуры и мыши LPT порт для подключения различных периферийных устройств, четыре разъёма USB порта (2 из них последняя версия стандарта USB 3.0), RJ порт для подключения локальной сети и два разъёма для передачи аудиосигнала.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/sensor4.jpg" style="text-align:center; "></div>
                        <div class="wthree_text_info">
                            <h2>Чувствительный кассовый компьютер с сенсорным экраном</h2>
                        </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Интерфейс:</td>
                        <td>6 USB <br> 1 Parallel port<br> 1 PS/2 клавиатура <br> 1 PS/2 мышь<br> 1 LAN port<br>1-2 Serial port<br>1 VGA port<br> 1 Audio Input / 1 Output</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM post6
