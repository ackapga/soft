...
$rating=htmlspecialchars($_POST["rating"]);
    ...
    $res=mysqli_query($db,"insert into acoustomagnetic_deactivator
    ...
    else $res=mysqli_query($db,"insert into acoustomagnetic_deactivator (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Акустомагнитный деактиватор купить в Усть-Каменогорске | Противокражные системы акустомагнитные купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Акустомагнитный деактиватор, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить акустомагнитный деактиватор для магазина в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных противокражных систем.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/acoustomagnetic_deactivator.php">Актау</a></li>
                            <li><a href="../aktobe/acoustomagnetic_deactivator.php">Актобе</a></li>
                            <li><a href="../acoustomagnetic_deactivator.php">Алматы</a></li>
                            <li><a href="../atyrau/acoustomagnetic_deactivator.php">Атырау</a></li>
                            <li><a href="../janaozen/acoustomagnetic_deactivator.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/acoustomagnetic_deactivator.php">Жезказган</a></li>
                            <li><a href="../karaganda/acoustomagnetic_deactivator.php">Караганда</a></li>
                            <li><a href="../kokshetau/acoustomagnetic_deactivator.php">Кокшетау</a></li>
                            <li><a href="../kostanai/acoustomagnetic_deactivator.php">Костанай</a></li>
                            <li><a href="../kyzylorda/acoustomagnetic_deactivator.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/acoustomagnetic_deactivator.php">Астана</a></li>
                            <li><a href="../pavlodar/acoustomagnetic_deactivator.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/acoustomagnetic_deactivator.php">Петропавловск</a></li>
                            <li><a href="../semei/acoustomagnetic_deactivator.php">Семей</a></li>
                            <li><a href="../taldykorgan/acoustomagnetic_deactivator.php">Талдыкорган</a></li>
                            <li><a href="../taraz/acoustomagnetic_deactivator.php">Тараз</a></li>
                            <li><a href="../turkestan/acoustomagnetic_deactivator.php">Туркестан</a></li>
                            <li><a href="../uralsk/acoustomagnetic_deactivator.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/acoustomagnetic_deactivator.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/acoustomagnetic_deactivator.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Акустомагнитный деактиватор в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Акустомагнитный деактиватор</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/5.png">
                                <div class="thumb-image"> <img src="../images/eas/5.png" id="target" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Акустомагнитный деактиватор</h2>
                <hr>
                <p class="code-products">Код товара: 9042</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">63 795 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Акустомагнитный деактиватор</b> предназначен для снятия защитных свойств (деактивации) акустомагнитных этикеток, для бесконтактного размагничивания. Используются в кассовой зоне сотрудниками магазина для деактивации акустомагнитных этикеток на проданном товаре.
</p>
                    <br>
                    <h3><b>Преимущества акустомагнитных этикеток:</b></h3>
					<p><i class="fa fa-check"></i>  деактиватор этикеток легко устанавливается на любом кассовом столе;</p>
					<p><i class="fa fa-check"></i>  занимает мало места (габаритные размеры 20*15 см);</p>
					<p><i class="fa fa-check"></i> для использования деактиватора не требуется подключения к сети питания;</p>
                    ...
                    <button id="fly" class="add_item" data-id="84" data-title="<a href='https://softgroup.kz/acoustomagnetic_deactivator.php'>Акустомагнитный деактиватор</a>" data-price="63795" data-quantity="1" data-img="https://softgroup.kz/images/eas/5.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика акустомагнитного деактиватора</p>
                <hr>
            </div>
            <table class="zui-table zui-table-zebra zui-table-horizontal">
               <tbody>
                    ...
                    <tr>
                        <td>Мощность:</td>
                        <td>220 В переменного тока / ± 10%</td>
                    </tr>
                    <tr>
                        <td>Размер:</td>
                        <td>20 * 15 см</td>
...
$res=mysqli_query($db,"SELECT * FROM acoustomagnetic_deactivator
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить акустомагнитного деактиватора у нас:</h3>
                    <hr>
                </div>
