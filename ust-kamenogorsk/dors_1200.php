...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors1200
   ...
   else $res=mysqli_query($db,"insert into dors1200 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детектор банкнот инфракрасный Dors 1200 M1 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1200 M1, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1200 M1 инфракрасные купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_1200.php">Актау</a></li>
                            <li><a href="../aktobe/dors_1200.php">Актобе</a></li>
                            <li><a href="../dors_1200.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_1200.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_1200.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_1200.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_1200.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_1200.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_1200.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_1200.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_1200.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_1200.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_1200.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_1200.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_1200.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_1200.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_1200.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_1200.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_1200.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_1200.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детектор банкнот инфракрасный Dors</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Инфракрасные детекторы банкнот DORS 1200 М1</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/7.jpg">
                                <div class="thumb-image"> <img src="../images/detector/7.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/77.jpg">
                                <div class="thumb-image"> <img src="../images/detector/77.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/777.jpg">
                                <div class="thumb-image"> <img src="../images/detector/777.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Инфракрасные детекторы банкнот DORS 1200 М1</h2>
                <hr>
                <p class="code-products">Код товара: 9007</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">61 993 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Универсальный просмотровый детектор DORS 1200 M1 предназначен для комплексного визуального контроля подлинности банкнот различных валют и другой защищенной полиграфической продукции. </p>

                    <p>• Семь видов контроля в базовой комплектации, до 11 видов контроля при оснащении опциональными выносными приборами
                        <br>• Важной особенностью детектора является возможность проведения одновременно с Инфракрасным контролем (на выбор пользователя):
                        <br>Ультрафиолетового контроля (ИК+УФ)
                        <br> Контроля в белом проходящем свете (ИК+Контроль на просвет)
                        <br>Контроля в белом отраженном свете (ИК+Контроль в белом отраженном свете)
                        <br>• Любой режим контроля может быть активирован одним нажатием на соответствующую кнопку на панели управления
                    </p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_1200.php'>Инфракрасные детекторы банкнот DORS 1200 М1</a>" data-price="61993" data-quantity="1" data-img="https://softgroup.kz/images/detector/7.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>многодиапазонная ИК (ИК-светодиоды, 800–1000 нм), 2 УФ-лампы 4 Вт (365 нм), косопадающая белая (светодиод ДС) </td>
                    </tr>
                    <tr>
                        <td>Нижняя подсветка: </td>
                        <td>белая лампа 4 Вт</td>
                    </tr>
                    <tr>
                        <td>Измерительная линейка: </td>
                        <td>на матовом стекле предметного стола
                            Подключение дополнительных устройств: DORS 1010 или DORS 1020, DORS 10 и DORS 15 (2 разьема)</td>
                    </tr>
                    <tr>

                        <td>Потребляемая мощность: </td>
                        <td> не более 22 Вт</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры (ШхГхВ):</td>
                        <td>234х152х224 мм</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM dors1200
...
?>
            <div class="w3_agile_latest_arrivals">
                ...
                <div class="col-md-3 product-men single">
                    <div class="men-pro-item">
                        <a href="thermalprinter_8030.php">
                            <div class="men-thumb-item"><img src="../images/thermalprinter/2.jpg" alt="" class="pro-image-front">
