...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner9120
   ...
   else $res=mysqli_query($db,"insert into scanner9120 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Многоплоскостной сканер штрих кодов в Усть-Каменогорске | Купить многоплоскостной сканер штрих кодов </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="многоплоскостной сканер штрих кодов, купить, usb, лазерный, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить многоплоскостной сканер штрих кодов в Усть-Каменогорске по низким ценам. Широкий выбор высококачественных сканеров штрих кода от Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scanner_9120.php">Актау</a></li>
                            <li><a href="../aktobe/scanner_9120.php">Актобе</a></li>
                            <li><a href="../scanner_9120.php">Алматы</a></li>
                            <li><a href="../atyrau/scanner_9120.php">Атырау</a></li>
                            <li><a href="../janaozen/scanner_9120.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scanner_9120.php">Жезказган</a></li>
                            <li><a href="../karaganda/scanner_9120.php">Караганда</a></li>
                            <li><a href="../kokshetau/scanner_9120.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scanner_9120.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scanner_9120.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scanner_9120.php">Астана</a></li>
                            <li><a href="../pavlodar/scanner_9120.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scanner_9120.php">Петропавловск</a></li>
                            <li><a href="../semei/scanner_9120.php">Семей</a></li>
                            <li><a href="../taldykorgan/scanner_9120.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scanner_9120.php">Тараз</a></li>
                            <li><a href="../turkestan/scanner_9120.php">Туркестан</a></li>
                            <li><a href="../uralsk/scanner_9120.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scanner_9120.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scanner_9120.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scanner/10.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/10.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/101.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/101.jpg" id="target" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Многоплоскостной сканер штрих кодов 9120</h1>
                <hr>
                <p class="code-products">Код товара: 2007</p>
                <p><span class="item_price">46 350 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Многоплоскостной сканер штрих кодов максимально удобен и эффективен в работе. Сканер предназначен для предприятий розничной торговли, желающих иметь недорогое и эстетичное сканирующее устройство.</p>
                    <br>
                    <h3><b>Вид многоплоскостного сканера штрих кода:</b></h3>
                    ...
                    <button id="fly" class="add_item" data-id="27" data-title="<a href='https://softgroup.kz/scanner_9120.php'>Сканер штрих кода 9120</a>" data-price="46350" data-quantity="1" data-img="https://softgroup.kz/images/scanner/10.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scanner/shtrih6.png"></div>
                ...
                <div class="bootstrap-tab-text-grid">
                    ...
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/scanner/multiplane3.png"></div>
...
$res=mysqli_query($db,"SELECT * FROM scanner9120
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h2>Причины купить многоплоскостного сканера у нас:</h2>
                    <hr>
                </div>
