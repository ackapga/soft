...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into magner100
   ...
   else $res=mysqli_query($db,"insert into magner100 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Счетчик банкнот графический Magner 100 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="счетчики банкнот, графические, Magner, 100?, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Счетчики банкнот графические Magner 100 купить в Усть-Каменогорске по низким ценам. Огромный выбор счетчиков для банкнот от компании Softgroup">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/magner_100.php">Актау</a></li>
                            <li><a href="../aktobe/magner_100.php">Актобе</a></li>
                            <li><a href="../magner_100.php">Алматы</a></li>
                            <li><a href="../atyrau/magner_100.php">Атырау</a></li>
                            <li><a href="../janaozen/magner_100.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/magner_100.php">Жезказган</a></li>
                            <li><a href="../karaganda/magner_100.php">Караганда</a></li>
                            <li><a href="../kokshetau/magner_100.php">Кокшетау</a></li>
                            <li><a href="../kostanai/magner_100.php">Костанай</a></li>
                            <li><a href="../kyzylorda/magner_100.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/magner_100.php">Астана</a></li>
                            <li><a href="../pavlodar/magner_100.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/magner_100.php">Петропавловск</a></li>
                            <li><a href="../semei/magner_100.php">Семей</a></li>
                            <li><a href="../taldykorgan/magner_100.php">Талдыкорган</a></li>
                            <li><a href="../taraz/magner_100.php">Тараз</a></li>
                            <li><a href="../turkestan/magner_100.php">Туркестан</a></li>
                            <li><a href="../uralsk/magner_100.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/magner_100.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/magner_100.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Счетчики банкнот графические Magner 100</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/schetchiki/9.png">
                                <div class="thumb-image"> <img src="../images/schetchiki/9.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/99.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/99.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/schetchiki/999.jpg">
                                <div class="thumb-image"> <img src="../images/schetchiki/999.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Счетчики банкнот графические Magner 100</h2>
                <hr>
                <p class="code-products">Код товара: 8009</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">708 158 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Интеллектуальный мультивалютный счётчик банкнот Magner 100 Digital предназначен для пересчёта и проверки подлинности тенге, долларов и евро с определением номинала и ориентации. </p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/magner_100.php'>Счетчики банкнот графические Magner 100</a>" data-price="708158" data-quantity="1" data-img="https://softgroup.kz/images/schetchiki/9.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>1000 банкнот в минуту с детекцией, 1100 банкнот в минуту</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Детекция:</td>
                        <td>цифровая ИК, магнитные датчики, УФ, датчик цвета, оптическая плотность банкнот, по размеру</td>
                    </tr>
                    <tr>
                        <td>Особенности:</td>
                        <td>возможность вывода итогов операционного дня на компьютер</td>
                    </tr>
                    <tr>

                        <td>Опции:</td>
                        <td>выносной дисплей, чековый принтер</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM magner100
