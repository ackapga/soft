...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scaletm30
   ...
   else $res=mysqli_query($db,"insert into scaletm30 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы с печатью этикеток TM-30A купить в Усть-Каменогорске от компании Softgroup</title>
    <!--/tags -->
    ...
    <meta name="description" content="Электронные весы с печатью этикеток купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить электронные весы с печатью в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_tm30.php">Актау</a></li>
                            <li><a href="../aktobe/scale_tm30.php">Актобе</a></li>
                            <li><a href="../scale_tm30.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_tm30.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_tm30.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_tm30.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_tm30.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_tm30.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_tm30.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_tm30.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_tm30.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_tm30.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_tm30.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_tm30.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_tm30.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_tm30.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_tm30.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_tm30.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_tm30.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_tm30.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                ...
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            ...
                            <li data-thumb="../images/scale/111.jpg">
                                <div class="thumb-image"> <img src="../images/scale/111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <div class="description">
                    <p><b>Электронные торговые весы</b> со стойкой TM30A предназначены для взвешивания и расчёта стоимости товара по измеренному весу и указанной цене за килограмм. Весы отлично применяются в различных сферах обслуживания, розничной и оптовой торговле.</p>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Диапазон взвешивания</p>
                        <p style="line-height:normal">Главным преимуществом оборудования является высокая точность измерений. Максимальный предел взвешивания - 30 кг. Устройства широко применяются в быту, в сфере продаж (подходят для магазинов любого формата), на предприятиях общественного питания, на складах, в фармацевтических компаниях и т. д. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/scale/p1.png" style="text-align:center; margin-top:20px"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/d1.png" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/s1.png" style="text-align:center; margin-top:20px"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>30x40мм, 37x50мм, 40x50мм, 40x60мм</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Дисплей:</td>
                        <td>тара (4 символ), вес (5 символ), цена за ед.изм (6 символ), итог (7 символ) </td>
                    </tr>
                    <tr>

                        <td>Интерфейс:</td>
                        <td>USB+Serial+LAN+RJ11</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM scaletm30
