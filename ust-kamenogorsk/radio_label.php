...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into radio_label
   ...
   else $res=mysqli_query($db,"insert into radio_label (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Самоклеющиеся радиочастотные защитные этикетки купить в Усть-Каменогорске | Антикражные системы </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Радиочастотная этикетка? рулон, для магазина, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Купить Радиочастотная  этикетка рулон в Усть-Каменогорске по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/radio_label.php">Актау</a></li>
                            <li><a href="../aktobe/radio_label.php">Актобе</a></li>
                            <li><a href="../radio_label.php">Алматы</a></li>
                            <li><a href="../atyrau/radio_label.php">Атырау</a></li>
                            <li><a href="../janaozen/radio_label.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/radio_label.php">Жезказган</a></li>
                            <li><a href="../karaganda/radio_label.php">Караганда</a></li>
                            <li><a href="../kokshetau/radio_label.php">Кокшетау</a></li>
                            <li><a href="../kostanai/radio_label.php">Костанай</a></li>
                            <li><a href="../kyzylorda/radio_label.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/radio_label.php">Астана</a></li>
                            <li><a href="../pavlodar/radio_label.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/radio_label.php">Петропавловск</a></li>
                            <li><a href="../semei/radio_label.php">Семей</a></li>
                            <li><a href="../taldykorgan/radio_label.php">Талдыкорган</a></li>
                            <li><a href="../taraz/radio_label.php">Тараз</a></li>
                            <li><a href="../turkestan/radio_label.php">Туркестан</a></li>
                            <li><a href="../uralsk/radio_label.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/radio_label.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/radio_label.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Радиочастотная  этикетка в Усть-Каменогорске</h1>
            <!--//w3_short-->
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Самоклеющиеся радиочастотные защитные этикетки</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/eas/10.jpg">
                                <div class="thumb-image"> <img src="../images/eas/10.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/eas/101.jpg">
                                <div class="thumb-image"> <img src="../images/eas/101.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Самоклеющиеся радиочастотные защитные этикетки</h2>
                <hr>
                <p class="code-products">Код товара: 9036</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">6380 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Самоклеющиеся радиочастотные защитные этикетки</b>  с ложным штрихкодом 40х40 мм служат для защиты любого типа товара: одежда, обувь, мелкая бытовая техника и аксессуары. На этикетке нанесен ложный штрих код, похожий товарный код. Для большей скрытности может быть наклеена под ценником на товаре.
</p>
                    <br>
                    <h3><b>Преимущества самоклеющихся этикеток:</b></h3>
                    ...
                    <button id="fly" class="add_item" data-id="85" data-title="<a href='https://softgroup.kz/radio_label.php'>Самоклеющиеся радиочастотные защитные этикетки</a>" data-price="6380" data-quantity="1" data-img="https://softgroup.kz/images/eas/10.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        ...
        <div class="container">
            <div class="models" style="margin-top:70px">
                <p>Характеристика радиочастотных этикеток</p>
                <hr>
            </div>
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>В рулоне:</td>
                        <td> 1 000 шт: (Продается рулоном) </td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM radio_label
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить радиочастотной этикетки у нас:</h3>
                    <hr>
                </div>
