        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                ...
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/2408D/1.png">
                                    <div class="thumb-image"> <img src="../images/2408D/1.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/2408D/2.png">
                                    <div class="thumb-image"> <img src="../images/2408D/2.png" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/2408D/3.png">
                                    <div class="thumb-image"> <img src="../images/2408D/3.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Принтер этикеток 2408D</h1>
                    <hr>
                    <p class="code-products">Код товара: 4940</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">45 360 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p> <b>Высокопроизводительный принтер 2408D </b> со скоростью 203мм/сек с разрешением 203 dpi имеет превосходные технические характеристики для печати этикеток шириной 120 мм. Данный принетер является отличным решением для розничной
                            торговли, маркировки полок, а также для сервисов доставки.</p>
                        <p><i class="fa fa-check"></i> автоматическая калибровка бумаги</p>
                        <p><i class="fa fa-check"></i> Поддерживает утилиту принтера Windows, утилиту принтера Android и SDK</p>
                        <p><i class="fa fa-check"></i> низкий уровень шума</p>
                        <p><i class="fa fa-check"></i> имеет интерфейс USB</p>
                        <p><i class="fa fa-check"></i> Скорость печати до 203мм/секунду</p>
                        <button id="fly" class="add_item" data-id="4940" data-title="<a href='https://softgroup.kz/label_2408d.php'>Принтер этикеток 2408D</a>" data-price="45360" data-quantity="1" data-img="https://softgroup.kz/images/2408D/1.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
            ...
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    <div class="container">
                        ...
                        <div style="text-align:center; margin-top:10px">
                            <img src="../images/2408D/speed.png" style="text-align:center;  margin-top:10px; width: 65%;">
                        </div>
                        <div class="wthree_text_info">
                            <h2>Высокая скорость печати принтера этикеток</h2>
                        </div>
                        <p style="line-height:normal">Принтер этикеток позволяет печатать на ленте шириной от 25 до 120мм, скорость печати принтера составляет 203мм/сек, разрешение печати - 203dpi</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style=" padding-bottom:40px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/2408D/usb.png" style="text-align:center; margin-top:10px; width: 75%;"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0">Удобный интерфейс подключения</p>
                        <p style="line-height:normal; text-align: center;">Эта модель принтера этикеток легко подключается к системе. Он имеет порт подключения для USB и Ethernet.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px; background-color: #e5f6f8;">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/2408D/1.png" style="width: 40%;">
            ...
            <div class="container">
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            <td>Емкость рулона этикеток:</td>
                            <td>127 мм (5 дюймов) OD</td>
                        </tr>
                        <tr>
                            <td>Цвет:</td>
                            <td>черный</td>
