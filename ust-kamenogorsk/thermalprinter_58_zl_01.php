...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into thermalprinter58zl01
   ...
   else $res=mysqli_query($db,"insert into thermalprinter58zl01 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Термопринтер купить в Усть-Каменогорске - Доступные цены на термопринтеры для печати чеков </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="термопринтер, купить, для печати, для чеков, чековый, кассовый, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Купить термопринтер в Усть-Каменогорске по доступным ценам. Осуществляем продажу термопринтера для печати чеков в широком ассортименте от Softgroup">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/thermalprinter_58_zl_01.php">Актау</a></li>
                            <li><a href="../aktobe/thermalprinter_58_zl_01.php">Актобе</a></li>
                            <li><a href="../thermalprinter_58_zl_01.php">Алматы</a></li>
                            <li><a href="../atyrau/thermalprinter_58_zl_01.php">Атырау</a></li>
                            <li><a href="../janaozen/thermalprinter_58_zl_01.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/thermalprinter_58_zl_01.php">Жезказган</a></li>
                            <li><a href="../karaganda/thermalprinter_58_zl_01.php">Караганда</a></li>
                            <li><a href="../kokshetau/thermalprinter_58_zl_01.php">Кокшетау</a></li>
                            <li><a href="../kostanai/thermalprinter_58_zl_01.php">Костанай</a></li>
                            <li><a href="../kyzylorda/thermalprinter_58_zl_01.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/thermalprinter_58_zl_01.php">Астана</a></li>
                            <li><a href="../pavlodar/thermalprinter_58_zl_01.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/thermalprinter_58_zl_01.php">Петропавловск</a></li>
                            <li><a href="../semei/thermalprinter_58_zl_01.php">Семей</a></li>
                            <li><a href="../taldykorgan/thermalprinter_58_zl_01.php">Талдыкорган</a></li>
                            <li><a href="../taraz/thermalprinter_58_zl_01.php">Тараз</a></li>
                            <li><a href="../turkestan/thermalprinter_58_zl_01.php">Туркестан</a></li>
                            <li><a href="../uralsk/thermalprinter_58_zl_01.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/thermalprinter_58_zl_01.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/thermalprinter_58_zl_01.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/thermalprinter/3.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/3.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/33.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/33.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/thermalprinter/333.jpg">
                                <div class="thumb-image"> <img src="../images/thermalprinter/333.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Термопринтер 58ZL01</h1>
                <hr>
                <p class="code-products">Код товара: 3003</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">16 995 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Термопринтер</b> 58ZL01 с уникальной конструкцией предназначен для печати на 58мм термоленте. Принтер чеков 58ZL01 – современный термопринтер, обладающий прекрасными техническими характеристиками и многофункциональными возможностями.</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/thermalprinter_58_zl_01.php'>Принтер чеков 58ZL01</a>" data-price="16995" data-quantity="1" data-img="https://softgroup.kz/images/thermalprinter/3.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
        </div>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/thermalprinter/58_1.png"></div>
                    <div class="wthree_text_info">
                        <h2>Высокая скорость печати термопринтера</h2>
                    </div>
            ...
            <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                <div class="container">
                    <div style="text-align:center; margin-top:0px">
                        <img src="../images/thermalprinter/auto2.png" style="text-align:center; margin-top:10px"></div>
...
$res=mysqli_query($db,"SELECT * FROM thermalprinter58zl01
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить термопринтера у нас:</h3>
                    <hr>
                </div>
