...
<head>
    ...
    <title>Монитор кассира купить в Усть-Каменогорске | Широкий выбор Pos-мониторов для кассы</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="монитор кассира, для кассы, pos мониторы, купить, Усть-Каменогорск, цена, продажа." />
    <meta name="description" content="Сенсорный монитор кассира в Усть-Каменогорске по выгодной цене от компании Softgroup. Высококачественный монитор кассира предназначен для автоматизации">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/pos_t8.php">Актау</a></li>
                            <li><a href="../aktobe/pos_t8.php">Актобе</a></li>
                            <li><a href="../pos_t8.php">Алматы</a></li>
                            <li><a href="../atyrau/pos_t8.php">Атырау</a></li>
                            <li><a href="../janaozen/pos_t8.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/pos_t8.php">Жезказган</a></li>
                            <li><a href="../karaganda/pos_t8.php">Караганда</a></li>
                            <li><a href="../kokshetau/pos_t8.php">Кокшетау</a></li>
                            <li><a href="../kostanai/pos_t8.php">Костанай</a></li>
                            <li><a href="../kyzylorda/pos_t8.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_t8.php">Астана</a></li>
                            <li><a href="../pavlodar/pos_t8.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/pos_t8.php">Петропавловск</a></li>
                            <li><a href="../semei/pos_t8.php">Семей</a></li>
                            <li><a href="../taldykorgan/pos_t8.php">Талдыкорган</a></li>
                            <li><a href="../taraz/pos_t8.php">Тараз</a></li>
                            <li><a href="../turkestan/pos_t8.php">Туркестан</a></li>
                            <li><a href="../uralsk/pos_t8.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/pos_t8.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/pos_t8.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Монитор кассира Т8, черный </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/21.png">
                                <div class="thumb-image"> <img src="../images/monitor/21.png" id="target" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Монитор кассира Т8, черный </h1>
                <hr>
                <p class="code-products">Код товара: 1004</p>
                ...
                <div class="description">
                    <p><b>Монитор кассира</b> черного цвета с 15,6-дюймовой диагональю экрана с высокой чувствительностью является главным отличием и достоинством. Модель имеет жесткий диск типа SSD 32 ГБ. Дисплей покупателя имеет возможность показывать клиенту то, что он заказывает.</p>
                    <br>
                    ...
                    <div> <button id="fly" class="add_item" data-id="4" data-title="<a href='https://softgroup.kz/pos_t8.php'>Монитор кассира Т8, черный</a>" data-price="163800" data-quantity="1" data-img="https://softgroup.kz/images/monitor/21.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
