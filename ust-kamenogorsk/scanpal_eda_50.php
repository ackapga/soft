...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanpal50
   ...
   else $res=mysqli_query($db,"insert into scanpal50 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>ТСД терминал сбора данных купить в Усть-Каменогорске | Сенсорный ТСД Honeywell EDA50</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Honeywell ScanPal EDA50, терминал сбора данных, тсд, для склада, тсд терминал, сбора, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Высококачественный ТСД терминал сбора данных Honeywell с системой Android по низким ценам от Softgroup. ТСД терминал сбора купить в Усть-Каменогорске.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scanpal_eda_50.php">Актау</a></li>
                            <li><a href="../aktobe/scanpal_eda_50.php">Актобе</a></li>
                            <li><a href="../scanpal_eda_50.php">Алматы</a></li>
                            <li><a href="../atyrau/scanpal_eda_50.php">Атырау</a></li>
                            <li><a href="../janaozen/scanpal_eda_50.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scanpal_eda_50.php">Жезказган</a></li>
                            <li><a href="../karaganda/scanpal_eda_50.php">Караганда</a></li>
                            <li><a href="../kokshetau/scanpal_eda_50.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scanpal_eda_50.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scanpal_eda_50.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scanpal_eda_50.php">Астана</a></li>
                            <li><a href="../pavlodar/scanpal_eda_50.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scanpal_eda_50.php">Петропавловск</a></li>
                            <li><a href="../semei/scanpal_eda_50.php">Семей</a></li>
                            <li><a href="../taldykorgan/scanpal_eda_50.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scanpal_eda_50.php">Тараз</a></li>
                            <li><a href="../turkestan/scanpal_eda_50.php">Туркестан</a></li>
                            <li><a href="../uralsk/scanpal_eda_50.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scanpal_eda_50.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scanpal_eda_50.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li><a href="terminal.html">Терминалы сбора данных</a><i>/</i></li>
                        <li>Терминал сбора данных Honeywell ScanPal EDA50</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/terminal/1.png">
                                <div class="thumb-image"> <img src="../images/terminal/1.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/terminal/11.jpg">
                                <div class="thumb-image"> <img src="../images/terminal/11.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/terminal/111.jpg">
                                <div class="thumb-image"> <img src="../images/terminal/111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>ТСД терминал Honeywell ScanPal EDA50</h1>
                <hr>
                <p class="code-products">Код товара: 7001</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">231 650 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scanpal_eda_50.php'>Терминал сбора данных Honeywell ScanPal EDA50</a>" data-price="231650" data-quantity="1" data-img="https://softgroup.kz/images/terminal/1.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center;">
                            <img src="../images/terminal/sensor.png">

                        </div>

                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Сенсорный экран с распознаванием нескольких касаний</p>
                        <p style="line-height:normal"> Емкостный сенсорный экран упростит сбор данных и обеспечит еще большую легкость использования.
                            Терминал идеально подходит для использования в сложных условиях, так как легко читается как в помещении, так и под открытым небом.</p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            ...
                            <img src="../images/terminal/scanner.jpg" style="text-align:center; "></div>

                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">HI2D:имидж-сканер двухмерных штрих-кодов нескольких касаний</p>
                        <p style="line-height:normal"> К Встроенный фотосканер считывает линейные и
                            двумерные штрихкоды и превосходно распознает загрязненные
                            и блеклые штрихкоды. Устройство идеально подходит для мобильных сотрудников
                            первой линии, которым приходится часто сканировать
                            штрихкоды при решении таких задач, как контроль при
                            доставке посылок и выездных продажах, управление
                            складскими запасами. </p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/terminal/android.png">

                        </div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Самая популярная в мире мобильная платформа, предназначенная для организаций</p>
                        <p style="line-height:normal"> Поддержка самой
                            популярной операционной системы <b>Android</b> и процессор,
                            разработанный с учетом потребностей мобильных сотрудников,
                            взаимодействующих с клиентами, а также большой объем
                            памяти и передовые средства сбора данных позволяют
                            использовать это устройство для решения множества задач. </p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/terminal/rabota.jpg">

                        </div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Бесперебойная работа на протяжении полной рабочей смены</p>
                        <p style="line-height:normal"> Интеллектуальная технология управления аккумулятором обеспечивает бесперебойную работу ScanPal EDA50 на протяжении полной рабочей смены. Это достигается за счет интеллектуального управления аккумулятором. </p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/terminal/udar1.png">

                        </div>

                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Выдерживает многократные падения</p>
                        <p style="line-height:normal"> терминалы сбора данных обладают повышенной ударопрочностью и устойчивостью к воздействию внешней среды. Выдерживает многократные падения с
                            высоты 1,2 м на бетонную поверхность, по 2 удара
                            на 6 сторон, всего 12 падений при нормальной
                            температуре</p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:10px ">
                            <img src="../images/terminal/dyum.jpg">

                        </div>
                        <h2 class="wthree_text_info">Яркий цветной дисплей ТСД терминала</h2>
                        <p style="line-height:normal"> Терминал сбора данных с диагональю
                            10,2 см (4") и
                            стеклом Corning
                            Gorilla® позволяет
                            просматривать
                            ...
                            на одной странице,
                            при этом цифровая
                            клавиатура настолько
                            компактна, что
                            устройство помещается
                            в кармане.</p>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:80px">
                            <img src="../images/terminal/camera2.png">

                        </div>
                        <div>
                            <div class="clearfix"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Цветная камера</p>
                            <p style="line-height:normal">Терминал сбора данных оснащен 5-мегапиксельной цветной камерой. Камера с
                                автофокусировкой и светодиодной вспышкой позволяет использовать ее как для фото.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        <tr>
                            <td>Дисплей: </td>
                            <td>5” цветной дисплей с сенсорной панелью и подсветкой</td>
                        </tr>
                        <tr>
                            <td>Разрешение:</td>
                            <td>1280х720</td>
                        ...
                        <tr>
                            ...
                            <td>2ГБ RAM 8 GB Flash</td>
                        </tr>
                        <tr>

                            <td>Тип сканера:</td>
                            <td>HI2D:имидж-сканер двухмерных штрих-кодов</td>
                        </tr>
...
$res=mysqli_query($db,"SELECT * FROM scanpal50
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить ТСД терминал у нас:</h3>
                    <hr>
                </div>
