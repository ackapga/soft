...
if ($respponse->success){    //отправлен комментарий
   ...
   else $res=mysqli_query($db,"insert into scaleth11 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы MK_ТН11 купить в Усть-Каменогорске | Товарные напольные весы</title>
    <!--/tags -->
    ...
    <meta name="description" content="Весы MK_ТН11 купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные товарные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_th_11.php">Актау</a></li>
                            <li><a href="../aktobe/scale_th_11.php">Актобе</a></li>
                            <li><a href="../scale_th_11.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_th_11.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_th_11.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_th_11.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_th_11.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_th_11.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_th_11.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_th_11.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_th_11.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_th_11.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_th_11.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_th_11.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_th_11.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_th_11.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_th_11.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_th_11.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_th_11.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_th_11.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/7.jpg">
                                <div class="thumb-image"> <img src="../images/scale/7.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/77.jpg">
                                <div class="thumb-image"> <img src="../images/scale/77.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/777.jpg">
                                <div class="thumb-image"> <img src="../images/scale/777.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">54 458 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Весы предназначены для измерений массы товаров при торговых операциях. Поддерживается возможность суммирования стоимости покупки и расчета сдачи. Встроенный аккумулятор обеспечивает автономную работу весов до 115 часов. Двухсторонняя индикация на складной стойке.</p>
                    <p>Дополнительные возможности:
                        <br>• расчет суммарной стоимости товара и сдачи
                        <br>• расчет стоимости штучного товара
                        <br>• память на 16 значений цены товара
                        <br>Установка массы тары:
                        <br>• нажатием кнопки «T»<p>
                            ...
                            <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_th_11.php'>Весы  торговые MK_TH11</a>" data-price="54458" data-quantity="1" data-img="https://softgroup.kz/images/scale/7.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg8.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel4.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/d3.png" style="text-align:center; "></div>
...
$res=mysqli_query($db,"SELECT * FROM scaleth11
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить товарные напольные весы у нас</h3>
                    <hr>
                </div>
