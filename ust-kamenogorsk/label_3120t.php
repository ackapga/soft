    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/label/1.jpg">
                                <div class="thumb-image"> <img src="../images/label/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/label/11.jpg">
                                <div class="thumb-image"> <img src="../images/label/11.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/label/111.jpg">
                                <div class="thumb-image"> <img src="../images/label/111.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Принтер этикеток 3120T</h1>
                <hr>
                <p class="code-products">Код товара: 4001</p>
                ...
                <div class="description">
                    <p>Легкий и удобный <b>принтер этикеток</b> со скоростью 127мм/сек с разрешением 203 dpi имеет превосходные технические характеристики для печати этикеток шириной 76 мм. Принтер этикеток 3120T имеет функции: автоматической калибровки бумаги и функцию контроля температуры. </p>
                    ...
                    <button id="fly" class="add_item" data-id="26" data-title="<a href='https://softgroup.kz/label_3120t.php'>Принтер этикеток 3120T</a>" data-price="45360" data-quantity="1" data-img="https://softgroup.kz/images/label/1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
        </div>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <div style="text-align:center; margin-top:10px">
                        <img src="../images/label/80.png"></div>
                    <div class="wthree_text_info">
                        <h2>Высокая скорость печати принтера этикеток</h2>
                    </div>
                    <p style="line-height:normal">Принтер этикеток позволяет печатать на ленте шириной от 25 до 76мм, скорость печати принтера составляет 127мм/с, разрешение печати - 203dpi</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
            ...
            <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                <div class="container">
                    <div style="text-align:center; margin-top:0px">
                        <img src="../images/label/auto.png" style="text-align:center; margin-top:10px"></div>
