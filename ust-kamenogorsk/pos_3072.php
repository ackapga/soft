...
<head>
    ...
    <title>POS монитор купить | Монитор с сенсорным экраном белого цвета для кассы</title>
    <!--/tags -->
    ...
    <meta name="description" content="Купить сенсорный монитор по выгодной цене от компании Softgroup. Широкий выбор продукции Pos-мониторов с сенсорным экраном белого цвета">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/pos_3072.php">Актау</a></li>
                            <li><a href="../aktobe/pos_3072.php">Актобе</a></li>
                            <li><a href="../pos_3072.php">Алматы</a></li>
                            <li><a href="../atyrau/pos_3072.php">Атырау</a></li>
                            <li><a href="../janaozen/pos_3072.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/pos_3072.php">Жезказган</a></li>
                            <li><a href="../karaganda/pos_3072.php">Караганда</a></li>
                            <li><a href="../kokshetau/pos_3072.php">Кокшетау</a></li>
                            <li><a href="../kostanai/pos_3072.php">Костанай</a></li>
                            <li><a href="../kyzylorda/pos_3072.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/pos_3072.php">Астана</a></li>
                            <li><a href="../pavlodar/pos_3072.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/pos_3072.php">Петропавловск</a></li>
                            <li><a href="../semei/pos_3072.php">Семей</a></li>
                            <li><a href="../taldykorgan/pos_3072.php">Талдыкорган</a></li>
                            <li><a href="../taraz/pos_3072.php">Тараз</a></li>
                            <li><a href="../turkestan/pos_3072.php">Туркестан</a></li>
                            <li><a href="../uralsk/pos_3072.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/pos_3072.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/pos_3072.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Сенсорный монитор 3072, белый</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/p4.png">
                                <div class="thumb-image"> <img src="../images/monitor/p4.png" id="target" class="img-responsive"> </div>
                            <li data-thumb="../images/monitor/6.jpeg">
                                <div class="thumb-image"> <img src="../images/monitor/6.jpg" class="img-responsive"> </div>
                            <li data-thumb="../images/monitor/66.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/66.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Сенсорный монитор 3072, белый</h1>
                <hr>
                <p class="code-products">Код товара: 1001</p>
                ...
                <div class="description">
                    <p><b>Сенсорный монитор</b> 3072 белый имеет новый компактный дизайн, сенсорный монитор с высокой чувствительностью. Идеально подойдет для автоматизации любой торговли: супермаркетов, магазинов, кафе или же аптек.</p>
                    <br>
                    ...
                    <div><button id="fly" class="add_item" data-id="1" data-title="<a href='https://softgroup.kz/pos_3072.php'>Сенсорный монитор 3072</a>" data-price="163800" data-quantity="1" data-img="https://softgroup.kz/images/monitor/p4.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/vfd1.jpg" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/monitor/sensor1.png" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/d1.png" style="text-align:center; margin-top:20px"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/wifi.png" style="text-align:center; margin-top:20px"></div>
