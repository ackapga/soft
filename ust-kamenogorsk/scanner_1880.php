...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner1880
   ...
   else $res=mysqli_query($db,"insert into scanner1880 (date, theme_id, login, message, rating)
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scanner/7.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/7.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/77.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/77.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/777.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/777.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Беспроводной сканер штрих кода 1880</h1>
                <hr>
                <p class="code-products">Код товара: 2004</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">20 160 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Беспроводной сканер штрих кода с подставкой</b> обладает высокой производительностью. Ударопрочный сканер имеет возможность работать "на расстоянии". Может использоваться непрерывно в течение более 20 часов без зарядки. Главным преимуществом сканера является - автоматическое хранение на расстоянии.</p>
                    <br>
                    ...
                    <button id="fly" class="add_item" data-id="24" data-title="<a href='https://softgroup.kz/scanner_1880.php'>Сканер штрих кода 1880</a>" data-price="20160" data-quantity="1" data-img="https://softgroup.kz/images/scanner/1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-top:20px; margin-top:20px">
                    ...
                    <div class="container">
                        ...
                        <p style="line-height:normal">Стойка для сканера штрих-кода 1880 предназначена для непрерывного сканирования, то есть в режиме “Hands-Free”. Она надежно закрепляется у основания сканера.</p>
                        <div class="clearfix"> </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        ...
                        <td>200 ± 5 скан/сек</td>
                    </tr>
                    <tr>
                        <td>Точность сканирования:</td>
                        <td>0,10 мм (шт. 0,9)</td>
                    </tr>
                    <tr>

                        <td>Объем памяти:</td>
                        <td>4M, модель инвентаря может хранить 30000 штрих-кодов</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> Угол 30 ° Угол возвышения 65 ° Угол отклонения 55 °</td>
                    </tr>
                    <tr>

                        <td>Контрастность печати с отражением</td>
                        <td>не менее 30%</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scanner1880
