...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dors60
   ...
   else $res=mysqli_query($db,"insert into dors60 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Детектор банкнот ультрафиолетовый Dors 60 купить в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, ультрафиолетовые, dors, 60, Усть-Каменогорск, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 60 ультрафиолетовые купить в Усть-Каменогорске по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/dors_60.php">Актау</a></li>
                            <li><a href="../aktobe/dors_60.php">Актобе</a></li>
                            <li><a href="../dors_60.php">Алматы</a></li>
                            <li><a href="../atyrau/dors_60.php">Атырау</a></li>
                            <li><a href="../janaozen/dors_60.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/dors_60.php">Жезказган</a></li>
                            <li><a href="../karaganda/dors_60.php">Караганда</a></li>
                            <li><a href="../kokshetau/dors_60.php">Кокшетау</a></li>
                            <li><a href="../kostanai/dors_60.php">Костанай</a></li>
                            <li><a href="../kyzylorda/dors_60.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/dors_60.php">Астана</a></li>
                            <li><a href="../pavlodar/dors_60.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/dors_60.php">Петропавловск</a></li>
                            <li><a href="../semei/dors_60.php">Семей</a></li>
                            <li><a href="../taldykorgan/dors_60.php">Талдыкорган</a></li>
                            <li><a href="../taraz/dors_60.php">Тараз</a></li>
                            <li><a href="../turkestan/dors_60.php">Туркестан</a></li>
                            <li><a href="../uralsk/dors_60.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/dors_60.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/dors_60.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="nomer"><a href="tel:87012667700">8(701) <span>266-77-00</span></a></div>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <h1>Детектор банкнот ультрафиолетовый Dors</h1>
        </div>
    </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Ультрафиолетовые детекторы банкнот DORS 60</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/detector/2.jpg">
                                <div class="thumb-image"> <img src="../images/detector/2.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/22.jpg">
                                <div class="thumb-image"> <img src="../images/detector/22.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/detector/222.jpg">
                                <div class="thumb-image"> <img src="../images/detector/222.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Ультрафиолетовые детекторы банкнот DORS 60</h2>
                <hr>
                <p class="code-products">Код товара: 9002</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">8 315 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Ультрафиолетовый просмотровый детектор DOR 60 применяется для визуального контроля подлинности банкнот различных валют, ценных бумаг, документов, акцизных и специальных марок по наличию и расположению защитных элементов, люминесцирующих в ультрафиолетовом свете. </p>
                    <p>• отказоустойчивый электронный балласт обеспечивает высокую эффективность и надежность работы ультрафиолетовых ламп.
                        <br>• мощный источник ультрафиолетового света (суммарная мощность 8 Вт);
                        <br>• компактные размеры и уникальная возможность крепления к стене позволяют удобно разместить детектор в кассовом узле любой конструкции;
                        <br>• благодаря отсутствию нижней панели прибор может быть установлен точно над исследуемым фрагментом, что особенно удобно при контроле ценных бумаг и документов больших размеров;</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/dors_60.php'>Ультрафиолетовые детекторы банкнот DORS 60</a>" data-price="8315" data-quantity="1" data-img="https://softgroup.kz/images/detector/2.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
            <div class="clearfix"> </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Виды контроля:</td>
                        <td>Ультрафиолетовый контроль</td>
                    </tr>
                    <tr>
                        <td>Верхняя подсветка:</td>
                        <td>2 УФ-лампа 4 Вт (365 нм)</td>
                    </tr>
                    <tr>
                        <td>Потребляемая мощность:</td>
                        <td> не более 14 Вт</td>
                    </tr>
                    <tr>

                        <td>Габаритные размеры (ШхГхВ):</td>
                        <td>190х101х128 мм</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM dors60
