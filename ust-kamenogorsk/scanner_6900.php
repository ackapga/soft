...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scanner6900
   ...
   else $res=mysqli_query($db,"insert into scanner6900 (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Сканер штрих кодов в Усть-Каменогорске | Купить ручные сканеры штрих кодов - Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="ручные сканеры, сканер штрих кодов, для кассы, для магазина, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Купить высококачественный ручной сканер штрих кодов в Усть-Каменогорске. Широкий выбор ассортимента ручных сканеров по доступным ценам от Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scanner_6900.php">Актау</a></li>
                            <li><a href="../aktobe/scanner_6900.php">Актобе</a></li>
                            <li><a href="../scanner_6900.php">Алматы</a></li>
                            <li><a href="../atyrau/scanner_6900.php">Атырау</a></li>
                            <li><a href="../janaozen/scanner_6900.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scanner_6900.php">Жезказган</a></li>
                            <li><a href="../karaganda/scanner_6900.php">Караганда</a></li>
                            <li><a href="../kokshetau/scanner_6900.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scanner_6900.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scanner_6900.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scanner_6900.php">Астана</a></li>
                            <li><a href="../pavlodar/scanner_6900.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scanner_6900.php">Петропавловск</a></li>
                            <li><a href="../semei/scanner_6900.php">Семей</a></li>
                            <li><a href="../taldykorgan/scanner_6900.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scanner_6900.php">Тараз</a></li>
                            <li><a href="../turkestan/scanner_6900.php">Туркестан</a></li>
                            <li><a href="../uralsk/scanner_6900.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scanner_6900.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scanner_6900.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scanner/11.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/11.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/111.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/111.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scanner/1.jpg">
                                <div class="thumb-image"> <img src="../images/scanner/1.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Сканер штрих кода 6900</h1>
                <hr>
                <p class="code-products">Код товара: 2001</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">11 840 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p><b>Сканер штрих кода</b> с подставкой обладает высоким уровнем обслуживания. Кнопка сканирования выдерживает не менее 100 нажатий в сек., поэтому может применяться в различных магазинах, супермаркетах, аптеках или же в любой торговли.</p><br>
                    <br>
                    <h3><b>Вид сканера штрих-кода:</b></h3>
                    ...
                    <button id="fly" class="add_item" data-id="21" data-title="<a href='https://softgroup.kz/scanner_6900.php'>Сканер штрих кода 6900</a>" data-price="11840" data-quantity="1" data-img="https://softgroup.kz/images/scanner/1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scanner/shtrih1.png"></div>
                ...
                <div class="bootstrap-tab-text-grid">
                    <div class="container">
                        <div style="text-align:center">
                            <img src="../images/scanner/podstavka.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Стойка для сканера</p>
                        <p style="line-height:normal">Можно дополнительно приобрести стойку для сканера штрих-кода 6900. Стойка предназначена для непрерывного сканирования, то есть в режиме “Hands-Free”. Она надежно закрепляется у основания сканера.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
            </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>видимый (от 650 до 670 нм)</td>
                    </tr>
                    <tr>
...
$res=mysqli_query($db,"SELECT * FROM scanner6900
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h2>Причины купить сканер штрих-кода у нас:</h2>
                    <hr>
                </div>
