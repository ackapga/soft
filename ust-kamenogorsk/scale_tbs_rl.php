...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scaletbsrl
   ...
   else $res=mysqli_query($db,"insert into scaletbsrl (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы торговые с печатью этикеток TB-S_RL1 купить в Усть-Каменогорске от компании Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы с печатью этикеток, масса к, электронные, TB-S_RL1, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Весы торговые с печатью этикеток купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_tbs_rl.php">Актау</a></li>
                            <li><a href="../aktobe/scale_tbs_rl.php">Актобе</a></li>
                            <li><a href="../scale_tbs_rl.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_tbs_rl.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_tbs_rl.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_tbs_rl.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_tbs_rl.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_tbs_rl.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_tbs_rl.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_tbs_rl.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_tbs_rl.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_tbs_rl.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_tbs_rl.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_tbs_rl.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_tbs_rl.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_tbs_rl.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_tbs_rl.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_tbs_rl.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_tbs_rl.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_tbs_rl.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Весы торговые с печатью этикеток TB-S_RL1</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/50.jpg">
                                <div class="thumb-image"> <img src="../images/scale/50.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/505.jpg">
                                <div class="thumb-image"> <img src="../images/scale/505.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/5055.jpg">
                                <div class="thumb-image"> <img src="../images/scale/5055.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h2>Весы торговые с печатью этикеток TB-S_RL1</h2>
                <hr>
                <p class="code-products">Код товара: 5013</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">180 881 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Весы состоят из модуля взвешивающего и терминала, которые соединены между собой кабелем. Грузоприемная платформа может быть размещена на полу или на столе. В комплект поставки входят два кронштейна, с помощью которых терминал можно прикрепить либо непосредственно к модулю ТВ-S, либо закрепить его на стене. Весы предназначены для маркировки и учета весовых, штучных и счетных товаров. Память на 20 000 товаров. Весы печатают как простые этикетки с автоматически настраиваемым форматом, так и этикетки любой сложности. Весы поддерживают печать 8 форматов штрихкодов, регистрируют товароучетные операции (прием, отпуск, списание, инвентаризация).</p>
                    ...
                    <button id="fly" class="add_item" data-id="22" data-title="<a href='https://softgroup.kz/scale_tbs_rl.php'>Весы   торговые с печатью этикеток TB-S_RL1</a>" data-price="180881" data-quantity="1" data-img="https://softgroup.kz/images/scale/50.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg5.png"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Диапазон взвешивания</p>
                        <p style="line-height:normal">Главным преимуществом оборудования является высокая точность измерений. Максимальный предел взвешивания - 200 кг. Устройства широко применяются в быту, в сфере продаж (подходят для магазинов любого формата), на предприятиях общественного питания, на складах, в фармацевтических компаниях и т. д. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/scale/p5.png" style="text-align:center; margin-top:20px"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> - кабель удлинительный (5 м)- 1шт;</td>
                    </tr>
                </tbody>
            </table>
            <br>
            <p style="font-size:1.2em; margin-bottom:10px;"><b>Весовой терминал с печатью этикеток RL:</b></p>
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>В комплекте поставки: </td>
                        <td> - кронштейн крепления терминала на стене-1 шт., крепление терминала к модулю взвешивающему ТВ-S-1шт., сетевой адаптер- 1шт.</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM scaletbsrl
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить торговые весы с печатью этикеток у нас</h3>
                    <hr>
                </div>
