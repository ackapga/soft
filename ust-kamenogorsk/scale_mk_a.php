...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into scalemka
   ...
   else $res=mysqli_query($db,"insert into scalemka (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Весы настольные MK_A купить по доступным ценам в Усть-Каменогорске от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы настольные, масса к, электронные, MK_A, MK-A, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Весы настольные Масса-К MK_A купить в Усть-Каменогорске. Огромный выбор электронных весов. Купить высококачественные настольные весы в Усть-Каменогорске.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/scale_mk_a.php">Актау</a></li>
                            <li><a href="../aktobe/scale_mk_a.php">Актобе</a></li>
                            <li><a href="../scale_mk_a.php">Алматы</a></li>
                            <li><a href="../atyrau/scale_mk_a.php">Атырау</a></li>
                            <li><a href="../janaozen/scale_mk_a.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/scale_mk_a.php">Жезказган</a></li>
                            <li><a href="../karaganda/scale_mk_a.php">Караганда</a></li>
                            <li><a href="../kokshetau/scale_mk_a.php">Кокшетау</a></li>
                            <li><a href="../kostanai/scale_mk_a.php">Костанай</a></li>
                            <li><a href="../kyzylorda/scale_mk_a.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/scale_mk_a.php">Астана</a></li>
                            <li><a href="../pavlodar/scale_mk_a.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/scale_mk_a.php">Петропавловск</a></li>
                            <li><a href="../semei/scale_mk_a.php">Семей</a></li>
                            <li><a href="../taldykorgan/scale_mk_a.php">Талдыкорган</a></li>
                            <li><a href="../taraz/scale_mk_a.php">Тараз</a></li>
                            <li><a href="../turkestan/scale_mk_a.php">Туркестан</a></li>
                            <li><a href="../uralsk/scale_mk_a.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/scale_mk_a.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/scale_mk_a.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/scale/3.jpg">
                                <div class="thumb-image"> <img src="../images/scale/3.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/33.jpg">
                                <div class="thumb-image"> <img src="../images/scale/33.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/scale/333.jpg">
                                <div class="thumb-image"> <img src="../images/scale/333.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/scale/kg7.png"></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/scale/panel3.png"></div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>сетевой адаптер - 1шт, кабель USB 2.0 USB A (m) – USB B (m) длиной 1,5 м - 1шт;</td>
                    </tr>

                    <tr>
                        <td>Возможность подключения по Wi-Fi: </td>
                        <td>да;</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM scalemka
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить настольные весы у нас</h3>
                    <hr>
                </div>
