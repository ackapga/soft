...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into display_white
   ...
   else $res=mysqli_query($db,"insert into display_white (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Дисплей покупателя в Усть-Каменогорске - Купить дисплеи покупателя белого цвета</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="дисплей покупателя, купить, цена, продажа." />
    <meta name="description" content="Дисплей покупателя белого цвета купить в Усть-Каменогорске по низким ценам. Огромный выбор дисплея покупателя для рекламной информации в виде бегущей строки.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/display_white.php">Актау</a></li>
                            <li><a href="../aktobe/display_white.php">Актобе</a></li>
                            <li><a href="../display_white.php">Алматы</a></li>
                            <li><a href="../atyrau/display_white.php">Атырау</a></li>
                            <li><a href="../janaozen/display_white.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/display_white.php">Жезказган</a></li>
                            <li><a href="../karaganda/display_white.php">Караганда</a></li>
                            <li><a href="../kokshetau/display_white.php">Кокшетау</a></li>
                            <li><a href="../kostanai/display_white.php">Костанай</a></li>
                            <li><a href="../kyzylorda/display_white.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/display_white.php">Астана</a></li>
                            <li><a href="../pavlodar/display_white.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/display_white.php">Петропавловск</a></li>
                            <li><a href="../semei/display_white.php">Семей</a></li>
                            <li><a href="../taldykorgan/display_white.php">Талдыкорган</a></li>
                            <li><a href="../taraz/display_white.php">Тараз</a></li>
                            <li><a href="../turkestan/display_white.php">Туркестан</a></li>
                            <li><a href="../uralsk/display_white.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/display_white.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/display_white.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/26.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/26.jpg" id="target" class="img-responsive"> </div>
                            </li>
...
$res=mysqli_query($db,"SELECT * FROM display_white
