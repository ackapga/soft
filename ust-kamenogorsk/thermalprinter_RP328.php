...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into thermalprinterRP
   ...
   else $res=mysqli_query($db,"insert into thermalprinterRP (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Принтер чеков купить в Усть-Каменогорске - Доступные цены на принтеры товарных чеков </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="принтер чеков, принтер товарных чеков, Усть-Каменогорск, купить, цена, продажа." />
    <meta name="description" content="Купить принтер чеков в Усть-Каменогорске по доступным ценам. Осуществляем продажу принтера чеков для магазина в широком ассортименте от Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="../aktau/thermalprinter_5802.php">Актау</a></li>
                            <li><a href="../aktobe/thermalprinter_5802.php">Актобе</a></li>
                            <li><a href="../thermalprinter_5802.php">Алматы</a></li>
                            <li><a href="../atyrau/thermalprinter_5802.php">Атырау</a></li>
                            <li><a href="../janaozen/thermalprinter_5802.php">Жанаозен</a></li>
                            <li><a href="../jezkazgan/thermalprinter_5802.php">Жезказган</a></li>
                            <li><a href="../karaganda/thermalprinter_5802.php">Караганда</a></li>
                            <li><a href="../kokshetau/thermalprinter_5802.php">Кокшетау</a></li>
                            <li><a href="../kostanai/thermalprinter_5802.php">Костанай</a></li>
                            <li><a href="../kyzylorda/thermalprinter_5802.php">Кызылорда</a></li>
                        </ul>
                        <ul class="dlya_left">
                            <li><a href="../astana/thermalprinter_5802.php">Астана</a></li>
                            <li><a href="../pavlodar/thermalprinter_5802.php">Павлодар</a></li>
                            <li><a href="../petropavlovsk/thermalprinter_5802.php">Петропавловск</a></li>
                            <li><a href="../semei/thermalprinter_5802.php">Семей</a></li>
                            <li><a href="../taldykorgan/thermalprinter_5802.php">Талдыкорган</a></li>
                            <li><a href="../taraz/thermalprinter_5802.php">Тараз</a></li>
                            <li><a href="../turkestan/thermalprinter_5802.php">Туркестан</a></li>
                            <li><a href="../uralsk/thermalprinter_5802.php">Уральск</a></li>
                            <li><a href="../ust-kamenogorsk/thermalprinter_5802.php">Усть-Каменогорск</a></li>
                            <li><a href="../shymkent/thermalprinter_5802.php">Шымкент</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Принтер чеков Rongta RP 328</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/RP328/1.jpg">
                                <div class="thumb-image" id="thumb-image"> <img src="../images/RP328/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/RP328/2.jpg">
                                <div class="thumb-image"> <img src="../images/RP328/2.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/RP328/3RM.png">
                                <div class="thumb-image"> <img src="../images/RP328/3RM.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Принтер чеков Rongta RP 328</h1>
                <hr>
                <p class="code-products">Код товара: 5384</p>
                ...
                <div class="description">
                    <p> <b>Принтер чеков Rongta RP 328</b> обладает скоростью печати 250 мм/сек. Термопринтер имеет компактные размеры корпуса и предназначен для печати на 80мм термоленте. Термопринтер чеков успешно используется в крупных торговых сетях,
                        гостиницах и ресторанах, интернет-магазинах с большим клиентским потоком.
                    </p>
                    ...
                    <button id="fly" class="add_item " data-id="5384" data-title="<a href='https://softgroup.kz/thermalprinter_RP328.php'>Принтер чеков Rongta RP 328</a>" data-price="35280" data-quantity="1" data-img="https://softgroup.kz/images/template.jpg" data-count="100500"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:20px">
                <div class="container">
                    ...
                    <div style="text-align:center;">
                        <img src="../images/RP328/3RM.png" style="width: 500px;"></div>
                    <div class="wthree_text_info">
                        <h2>Высокая скорость печати принтера чеков</h2>
                    </div>
                    <p style="line-height:normal">Принтер чеков оборудованный специальным автоотрезчиком имеет компактные размеры корпуса и предназначен для печати на 58мм термоленте. Благодаря продуманному дизайну не занимает много места, никаких лишних проводов на рабочем месте,
                        предельно компактно и удобно.</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
            ...
            <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                <div class="container">
                    <div style="text-align:center; margin-top:0px">
                        <img src="../images/thermalprinter/auto.png" style="text-align:center; margin-top:10px"></div>
                    <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:20px 0 10px 0">Подключение к денежному ящику</p>
                    <p style="line-height:normal">Наличие порта для денежного ящика позволяет включать принтер в состав полноценных POS-комплексов. Принтер чеков подключается к денежному ящику и автоматически открывается при оплате заказа. Автоматическое открывание ускоряет процесс
                        расчета кассира с людьми.</p>
                    <div class="clearfix"> </div>
                </div>
            </div>
            <!-- /new_arrivals -->
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> постоянного тока 12В, 2А</td>
                    </tr>
                    <tr>

                        <td>Диаметр рулона бумага:</td>
                        <td>Φ 83mm</td>
                    </tr>
                    <tr>
...
for ($i=0; $i<=count($tag[$up])-1; $i++) {
 ...
 echo '<div style="float:left; margin-right:5px; font-size:16px!important; color:#2a4f5e;"><b>'.$tag[$up][$i][3].'</b></div>'; echo '
                <div style="text-align:right; float:none"> '.date("d.m.Y в H:i ", $tag[$up][$i][4]).'</div>
            </div>'; echo '
            <div style="float:none; display:none;"> '.$tag[$up][$i][2].' </div>'; if ($tag[$up][$i][2]==5) echo '<img src="../images/five.png">'; elseif ($tag[$up][$i][2]==4){ echo '<img src="../images/four.png">'; } elseif ($tag[$up][$i][2]==3) { echo '<img src="../images/three.png">'; } elseif ($tag[$up][$i][2]==2)
            { echo '<img src="../images/two.png">'; } else echo '<img src="../images/one.png">'; echo '
            <div style="clear:both; "></div>'; echo '
            <div class="comm_body" style="float:none!important; margin:15px 0 20px 0;">'; if ($sum
                <0) echo '<u class="sp_link">Показать/скрыть</u><div class="comm_text">'; else echo '<div style="word-wrap:break-word; float:none!important;">'; echo str_replace( "<br />", "<br>",nl2br($tag[$up][$i][1])). '</div>'; if (isset($tag[
                    $tag[$up][$i][0] ])) parents($tag[$up][$i][0],20); echo '</div></div>'; } } $res=mysqli_query($db, "SELECT * FROM thermalprinterRP
    WHERE theme_id='".$theme_id. "' ORDER BY id"); $number=mysqli_num_rows($res); if ($number>0) { echo '
    ...
    <div class="coupons">
        <div class="coupons-grids text-center">
            <div class="w3layouts_mail_grid">
                <div class="models">
                    <h3>Причины купить принтер чеков у нас:</h3>
                    <hr>
                </div>
