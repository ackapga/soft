...
<head>
   ...
   <title>Системный блок Core i5 || Системные блоки от Softgroup</title>
    <!--/tags -->
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/block-sistemy/block-3/ava.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-3/ava.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/block-sistemy/block-3/2.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-3/2.png" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/block-sistemy/block-3/3.png">
                                <div class="thumb-image"> <img src="../images/block-sistemy/block-3/3.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Системный блок Core i5</h1>
                <hr>
                <!-- <p class="code-products">Код товара: 4491</p> -->
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">176 700 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Системный блок с корпусом X-Game XC-370 имеет процессор Intel Core i5-9400. В качестве материнской платы используется Gigabyte H310M H, Socket LGA1151 с усиленной системой питания. В комплект с блоком входит охлаждающий кулер DEEPCOOL
                        THETA20. Оперативная память состовляет 4GB. Твердотельный Накопитель SSD обладает емкостью 240 Гб.</p>
                    <br>
                    <h3><b>Системный блок состоит из:</b></h3>
                    <p><i class="fa fa-check"></i> Процессор: Core i5-9400 (6 ядер, 6 потоков, ГГц: 2.9, 9 Мб Кэша);</p>
                    <p><i class="fa fa-check"></i> Материнская плата: Gigabyte H310M H, Socket LGA1151, Слоты: 2 x DDR4, SATA III: 4;</p>
                    <p><i class="fa fa-check"></i> Твердотельный Накопитель SSD: 240GB Mcpoint MC240 SATA3;</p>
                    <div><button id="fly" class="add_item" data-id="2138" data-title="<a href='https://softgroup.kz/Sistemnyy-blok-Core-i5.php'>Системный блок Core i5</a>" data-price="176700" data-quantity="1" data-img="https://softgroup.kz/images/block-sistemy/block-3/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/block-sistemy/block-3/3.png" style="width: 30% !important;">
                        </div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Процессор Intel Core i5-9400</p>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:20px">
                    <div class="container">
                        ...
                        <p style="line-height:normal">Благодаря Smart Fan 5 пользователи могут быть уверены в том, что их игровой ПК будет функционировать в наиболее благоприятном температурном режиме без ущерба для производительности. Благодаря термодатчикам, размещенным на материнской
                            плате, средствами Smart Fan 5 можно контролировать работу каждого вентилятора. Кроме того, Smart Fan 5 - это еще и большее количество гибридных разъемов для подключения вентиляторов, которые поддерживают режимы работы PWM и
                            Voltage, обеспечивая максимальное удобство обслуживания установленной жидкостной системы охлаждения. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:20px">
                    <div class="container">
                        ...
                        <p style="line-height:normal">Процессорный кулер Theta 20 PWM от Deepcool предназначен для эффективного охлаждения процессоров Intel LGA 115X с разъемом до 95 Вт TDP. Благодаря направленному вниз потоку воздуха этот процессорный кулер также может отводить тепло
                            от вашей памяти и материнской платы для снижения общей температуры. Для дополнительной безопасности он использует заднюю панель, чтобы она была правильно установлена.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/block-sistemy/block-3/ssd.png" style="text-align:center; width: 30%;">
                        </div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Твердотельный Накопитель SSD:</p>
                        <p style="line-height:normal">Получите скорость 240GB Mcpoint MC240 SATA3 SSD и вдохните новую жизнь в настольный ПК с твердотельным накопителем от Inland Professional. Благодаря быстрому и надежному твердотельному накопителю Inland Professional вы получите
                            более быструю загрузку и завершение работы, а также более быстрый отклик приложений и скорость передачи данных по сравнению с обычным жестким диском.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #fff;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        ...
                        <p style="line-height:normal">Олицетворяет в себе стильный дизайн в сочетании с широкими функциональными возможностями. Строгий в то же время продвинутый дизайн лицевой панели стилизованный под металл, этот корпус украсит любое помещение. С фронтальной стороны
                            расположена панель ввода/вывода: разъёмы 2 аудио, 2 USB-порта. Присутствует перфорированная боковая панель для охлаждения комплектующих компьютера c возможностью установки 1*12см кулеров для дополнительного охлаждения, а также
                            продумана конструкция для создания воздушных потоков в кейсе. Структура корпуса позволяет устанавливать в него полноразмерную графическую карту до 300 мм. Дополнительно в новой серии усилены боковые панели с помощью рёбер жёсткости.
                            что создаёт ещё более жёсткую структуру для кейса в целом.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        <td>Процессор:</td>
                        <td> Core i5-9400 (6 ядер, 6 потоков, ГГц: 2.9, 9 Мб Кэша) </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>240GB Mcpoint MC240 SATA3</td>
                    </tr>
                    <tr>
                        <td>Корпус:</td>
                        <td>X-Game XC-370</td>
