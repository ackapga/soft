...
<head>
    ...
    <title>Весы торговые с печатью этикеток TB-S_RL1 купить в Алматы от компании Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы с печатью этикеток, масса к, электронные, TB-S_RL1, алматы, купить, цена, продажа." />
    <meta name="description" content="Весы торговые с печатью этикеток купить в Алматы. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Алматы.">
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">252 000 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="5013"
                            data-title="<a href='https://softgroup.kz/scale_tbs_rl.php'>Весы торговые с печатью этикеток TB-S_RL1</a>"
                            data-price="252000" data-quantity="1" data-img="https://softgroup.kz/images/scale/50.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
