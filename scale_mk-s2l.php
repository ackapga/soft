...
<head>
    ...
    <title>Весы с печатью этикеток MK_S2L(12)</title>
    <!--/tags -->
...
<div class="banner-bootom-w3-agileits">
    <div class="container">
        ...
        <div class="services-breadcrumb">
            <div class="agile_inner_breadcrumb">
                <ul class="w3_short">
                    ...
                    <li>Весы с печатью этикеток MK_S2L(12)</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-8 single-right-left simpleCart_shelfItem">
            <h1>Весы с печатью этикеток MK_S2L(12)</h1>
            <hr>
            <!-- <p class="code-products">Код товара: XXXX</p>-->
            <p><span class="item-price-indicator">Цена: </span><span class="item_price">306 000 тг. </span></p>
            <div class="rating1">
            ...
            <div class="description">
                <p>МК-SL(12) - это полностью автоматизированные весы с печатью этикеток для самообслуживания.
                    Они используются на розничных точках и продуктовых магазинах, они так же могут печатать этикетки, содержащие информацию о весе и цене товара,
                    что делает процесс покупки быстрым и удобным для клиентов.
                    Весы оснащены встроенной системой автоматической юстировки гири при изменении
                    окружающей температуры или через заданный временной промежуток,
                    что особенно важно в условиях постоянно меняющейся окружающей среды.
                    Эти весы имеют яркий и крупный ЖК-дисплей с высокой контрастностью,
                    что облегчает чтение информации как операторами, так и покупателями.
                    Операторы магазинов могут легко настроить весы в соответствии со своими требованиями
                    через специальное меню управления, которое имеет простой и интуитивно понятный интерфейс.</p>
                <hr>
                ...
                <div>
                    <button id="fly" class="add_item" data-id="0004"
                            data-title="<a href='https://softgroup.kz/scale_mk-s2l.php'>Весы с печатью этикеток MK_S2L(12)</a>"
                            data-price="306000"
                            data-quantity="1"
                            data-img="images/scale/mk-s2l-1.jpg">
        ...
        <div class="bootstrap-tab-text-grids">
            ...
            <div class="bootstrap-tab-text-grid" style="padding-bottom:20px;background-color: #fff;">
                <div class="container">
                    ...
                    <p style="line-height:normal; text-align: center">
                        Главное преимущество это два интегрированных дисплея.
                        Первый дисплей сенсорный расположен удобно сверху весов для быстрого и легкого доступа,
                        а второй - на задней панели для удобства клиента.
                    </p>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="bootstrap-tab-text-grid" style="padding-bottom:20px;background-color: #e5f6f8;">
                <div class="container">
                    ...
                    <p style="line-height:normal;text-align: center">
                        Весы имеют встроенные шаблоны печати этикеток, которые автоматически настраиваются под размер
                        этикетки в рулоне, установленном в весах. Весы совместимы с 1С, также интегрируются в другие системы товарного
                        учета, подключаются к различным кассам и кассовым программам.
                        Штрихкоды EAN 13, можно разместить несколько штрихкодов и рисунков на одной этикетке.
                        Возможно редактировать этикетки в графическом редакторе этикеток.
                    </p>
                    <div class="clearfix"></div>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div class="wthree_text_info">
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">
                            Сенсорный экран</p>
                        <p style="line-height:normal; text-align: center">
                            Весы оснащенные большим сенсорным экраном, производства компании Масса-К, выпускаются с верхними
                            пределами взвешивания 6, 15 и 32 кг.
                            <br>
                            Служит для отображения различной информации (наименование товара, стоимость товара, сумма чека,
                            сумма сдачи, и т.п.), предназначенной для обслуживаемого на кассовом узле клиента.
                        </p>
                        <div class="clearfix"></div>
                    </div>
                </div>
