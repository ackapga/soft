    ...
    <div class="container">
        ...
        <div class="col-md-8 single-right-left simpleCart_shelfItem">
            ...
            <div class="description">
                ...
                <p><i class="fa fa-check"></i> Широкие возможности настройки персональной клавиатуры поиска товаров</p>
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:20px">
                <div class="container">
                    ...
                    <p style="line-height:normal; text-align: center">
                        ...
                        этикетки в рулоне,
                        установленном в весах. Весы совместимы с 1С, также интегрируются в другие системы товарного
                        учета,
                        подключаются к различным кассам и кассовым программам.
