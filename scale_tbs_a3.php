...
if ($respponse->success) {    //отправлен комментарий
    ...
    if ($mess_login != '' and $user_text != '') {
        if (is_numeric($_POST["parent_id"]) and is_numeric($_POST["f_parent"]))
            $res = mysqli_query($db, "insert into scaletbsa3
    ...
    '" . $time . "','" . $theme_id . "','" . $mess_login . "','" . $user_text . "', '" . $rating . "')");
        else $res = mysqli_query($db, "insert into scaletbsa3 (date, theme_id, login, message, rating)
        ...
        <div class="fond">
            ...
            <div id="box_2" class="mymagicoverbox_fenetre">
                <div class="mymagicoverbox_fenetreinterieur">
                    <ul>
                        <li><a href="aktau/scale_tbs_a3.php">Актау</a></li>
                        <li><a href="aktobe/scale_tbs_a3.php">Актобе</a></li>
                        <li><a href="scale_tbs_a3.php">Алматы</a></li>
                        <li><a href="atyrau/scale_tbs_a3.php">Атырау</a></li>
                        <li><a href="janaozen/scale_tbs_a3.php">Жанаозен</a></li>
                        <li><a href="jezkazgan/scale_tbs_a3.php">Жезказган</a></li>
                        <li><a href="karaganda/scale_tbs_a3.php">Караганда</a></li>
                        <li><a href="kokshetau/scale_tbs_a3.php">Кокшетау</a></li>
                        <li><a href="kostanai/scale_tbs_a3.php">Костанай</a></li>
                        <li><a href="kyzylorda/scale_tbs_a3.php">Кызылорда</a></li>
                    </ul>
                    <ul class="dlya_left">
                        <li><a href="astana/scale_tbs_a3.php">Астана</a></li>
                        <li><a href="pavlodar/scale_tbs_a3.php">Павлодар</a></li>
                        <li><a href="petropavlovsk/scale_tbs_a3.php">Петропавловск</a></li>
                        <li><a href="semei/scale_tbs_a3.php">Семей</a></li>
                        <li><a href="taldykorgan/scale_tbs_a3.php">Талдыкорган</a></li>
                        <li><a href="taraz/scale_tbs_a3.php">Тараз</a></li>
                        <li><a href="turkestan/scale_tbs_a3.php">Туркестан</a></li>
                        <li><a href="uralsk/scale_tbs_a3.php">Уральск</a></li>
                        <li><a href="ust-kamenogorsk/scale_tbs_a3.php">Усть-Каменогорск</a></li>
                        <li><a href="shymkent/scale_tbs_a3.php">Шымкент</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="flexslider">
                    <ul class="slides">
                        ...
                        <li data-thumb="images/scale/tb-m_a3-2.jpg">
                            <div class="thumb-image"><img src="images/scale/tb-m_a3-2.jpg" class="img-responsive"></div>
                        </li>
                        <li data-thumb="images/scale/tb-m_a3-3.jpg">
                            <div class="thumb-image"><img src="images/scale/tb-m_a3-3.jpg" class="img-responsive"></div>
                        </li>
                    </ul>
                    <div class="clearfix"></div>
                </div>
        ...
        <div class="bootstrap-tab-text-grids">
            ...
            <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                <div class="container">
                    ...
                    <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Стойка
                        для дисплея. </p>
                    <p style="line-height:normal">В силу своей конструктивной особенности, в весах предполагается
                        наличие стойки для дисплея покупателя. Она соединяет платформу с дисплеем.</p>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
...
<div class="container">
    ...
    $res = mysqli_query($db, "SELECT * FROM scaletbsa3
