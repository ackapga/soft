...
<script src='https://www.google.com/recaptcha/api.js'></script>
    <title>Монитор 21.5″ SAMSUNG LS22 || Мониторы от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Монитор, купить, SAMSUNG LS22, экран, Актау, астана, казахстан, цена, продажа." />
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Монитор 21.5″ SAMSUNG LS22</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/perif/first/ava.png">
                                <div class="thumb-image"> <img src="../images/perif/first/ava.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/perif/first/2.png">
                                <div class="thumb-image"> <img src="../images/perif/first/2.png" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/perif/first/3.png">
                                <div class="thumb-image"> <img src="../images/perif/first/3.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Монитор 21.5″ SAMSUNG LS22</h1>
                <hr>
                <!-- <p class="code-products">Код товара: 4491</p>  -->
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">59 300 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <div><button id="fly" class="add_item" data-id="7410" data-title="<a href='https://softgroup.kz/Monitor-SAMSUNG-LS22.php'>Монитор 21.5″ SAMSUNG LS22</a>" data-price="59300" data-quantity="1" data-img="https://softgroup.kz/images/perif/first/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
