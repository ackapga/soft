        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Резистивный Моноблок R 10</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/r10/avaa.png">
                                    <div class="thumb-image"> <img src="../images/r10/avaa.png" id="target" class="img-responsive"> </div>
                                </li>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Резистивный Моноблок R 10</h1>
                    <hr>
                    <p class="code-products">Код товара: 5158</p>
                    ...
                    <div class="description">
                        <p>15-дюймовый Резистивный моноблок R 10 — это коммерческое решение для предприятий любого масштаба, работающих в сфере торговли, в ресторанном и гостиничном бизнесе. Служат долго и идеально справляются с задачами автоматизации обслуживания
                        ...
                        <div><button id="fly" class="add_item" data-id="5158" data-title="<a href='https://softgroup.kz/pos_r10.php'>Резистивный Моноблок R 10</a>" data-price="130000" data-quantity="1" data-img="https://softgroup.kz/images/r10/avaa.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
