...
<head>
    ...
    <title>Электронные весы MK_ТН21 купить по доступным ценам в Актау от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы настольные, масса к, электронные, MK_ТН21, MK-ТН21, Актау, купить, цена, продажа." />
    <meta name="description" content="Электронные весы MK_ТН21 купить в Актау. Огромный выбор электронных весов для торговли. Купить высококачественные весы Масса-К в Актау.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="scale_mk_th.php">Актау</a></li>
