...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dlm516
   ...
   else $res=mysqli_query($db,"insert into dlm516 (date, theme_id, login, message, rating)
...
<head>
        ...
        <title>Мышь Delux, DLM-516 OGB || Мышка от Softgroup</title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="Компьютерная мышка , купить, Delux,  DLM-516 OGB, экран, Актау, астана, казахстан, цена, продажа." />
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                ...
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/perif/six/ava.png">
                                    <div class="thumb-image"> <img src="../images/perif/six/ava.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/perif/six/2.png">
                                    <div class="thumb-image"> <img src="../images/perif/six/2.png" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/perif/six/3.png">
                                    <div class="thumb-image"> <img src="../images/perif/six/3.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Мышь Delux, DLM-516 OGB </h1>
                    <hr>
                    <!-- <p class="code-products">Код товара: 4491</p> -->
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price"> 3216 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Беспроводная оптическая мышь, легка и удобна в повседневной работе за компьютером и ноутбуком. Эргономичный дизайн мыши позволяет комфортно работать правой рукой. Отличительной особенностью данной серии мышей является мини-приёмник,
                            который по своим размерам не больше монеты.</p>
                        <br>
                        <h3><b>Особенности:</b></h3>
                        <p><i class="fa fa-check"></i> Производитель: Delux</p>
                        <p><i class="fa fa-check"></i> Тип подключения: Беспроводной</p>
                        <p><i class="fa fa-check"></i> Количество кнопок, включая колесико кнопку: 6</p>
                        <!-- <img src="../images/monitor/icon.png" style="float:none"> -->
                        <div><button id="fly" class="add_item" data-id="9662" data-title="<a href='https://softgroup.kz/Mysh'-Delux-DLM-516-OGB.php'>Мышь Delux, DLM-516 OGB  </a>" data-price="3216" data-quantity="1" data-img="https://softgroup.kz/images/perif/six/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/perif/six/img1.png" style="width: 40%;">
                            </div>
            ...
            <div class="container">
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            <td>Разрешение:</td>
                            <td>800, 1000, 1200, 1600</td>
                        </tr>
                        <tr>
                            <td>Ресурс колёсика:</td>
                            <td> 200 000 циклов нажатия</td>
                        </tr>
                        <tr>
                            <td>Ресурс кнопки:</td>
                            <td> 3 000 000 циклов нажатия</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM dlm516
