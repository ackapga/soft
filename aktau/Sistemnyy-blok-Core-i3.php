...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        ...
        <meta name="keywords" content=" купить системный блок, AMD, CORE, купить, Актау, цена, продажа." />
        <meta name="description" content="Купить Системный блок  в Актау по низким ценам. Осуществляем продажу игровых системных блоков.">
        <!--//tags -->
        ...
        <div class="header-bot" id="home">
            ...
            <div class="header-bot_inner_wthreeinfo_header_mid">
                <div class="fond">
                    ...
                    <div iddiv="box_2" class="mymagicoverbox"> <i class="fa fa-map-marker" aria-hidden="true"></i> Актау<i class="fa fa-caret-down " aria-hidden="true"></i> </div>
                    <link href='https://fonts.googleapis.com/css?family=Roboto:100,400,300,500,700' rel='stylesheet' type='text/css'>
                    <div id="box_2" class="mymagicoverbox_fenetre">
                        <div class="mymagicoverbox_fenetreinterieur">
                            <ul>
                                <li><a href="pos_t3.php">Актау</a></li>
