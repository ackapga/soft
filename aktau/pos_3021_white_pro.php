    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Сенсорный Моноблок 3021 PRO, белый</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/3021_white/1pro.jpg">
                                <div class="thumb-image"> <img src="../images/3021_white/1pro.jpg" id="target" class="img-responsive"> </div>
                            </li>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Сенсорный Моноблок 3021 PRO, белый</h1>
                <hr>
                <p class="code-products">Код товара: 4493</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">154 980 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <div><button id="fly" class="add_item" data-id="12" data-title="<a href='https://softgroup.kz/pos_3021_white_pro.php'>Сенсорный Моноблок 3021 PRO, белый</a>" data-price="154980" data-quantity="1" data-img="https://softgroup.kz/images/avatars/3021_pro_white.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
