...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dlk6010ub
   ...
   else $res=mysqli_query($db,"insert into dlk6010ub (date, theme_id, login, message, rating)
...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Клавиатура, Delux, DLK-6010UB || Клавиатуры от Softgroup</title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="Клавиатура, купить, Delux, DLK-6010UB, экран, Актау, астана, казахстан, цена, продажа." />
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Клавиатура, Delux, DLK-6010UB</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/perif/third/ava.png">
                                    <div class="thumb-image"> <img src="../images/perif/third/ava.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/perif/third/2.png">
                                    <div class="thumb-image"> <img src="../images/perif/third/2.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Клавиатура, Delux, DLK-6010UB</h1>
                    <hr>
                    <!-- <p class="code-products">Код товара: 4491</p> -->
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price"> 2808 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Классическая клавиатура Delux DLK-6010 компактного дизайна, уменьшена благодаря оптимизации размеров рамки. Раскладка клавиатуры, разработанная специально для среднеазиатского региона, имеет красивый и ровный шрифт, нанесена при
                            помощи точного лазера и защищена от стирания УФ-покрытием. </p>
                        <br>
                        <h3><b>Особенности:</b></h3>
                        <p><i class="fa fa-check"></i> Бренд: Delux</p>
                        <p><i class="fa fa-check"></i> Размер: Ультратонкая, компактный </p>
                        <p><i class="fa fa-check"></i> Цвет: черный</p>
                        <!-- <img src="../images/monitor/icon.png" style="float:none"> -->
                        <div><button id="fly" class="add_item" data-id="7413" data-title="<a href='https://softgroup.kz/Klaviatura-Delux-DLK-6010UB.php'>Клавиатура, Delux, DLK-6010UB</a>" data-price="2808" data-quantity="1" data-img="https://softgroup.kz/images/perif/third/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
...
$res=mysqli_query($db,"SELECT * FROM dlk6010ub
