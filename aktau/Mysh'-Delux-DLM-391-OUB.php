...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dlm
   ...
   else $res=mysqli_query($db,"insert into dlm (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Мышь Delux, DLM-391 OUB | Мышка от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Компьютерная мышка , купить, Delux,  DLM-391 OUB, экран, Актау, астана, казахстан, цена, продажа." />
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/perif/fifth/ava.png">
                                <div class="thumb-image"> <img src="../images/perif/fifth/ava.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/perif/fifth/2.png">
                                <div class="thumb-image"> <img src="../images/perif/fifth/2.png" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/perif/fifth/3.png">
                                <div class="thumb-image"> <img src="../images/perif/fifth/3.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Мышь Delux, DLM-391 OUB</h1>
                <hr>
                <!-- <p class="code-products">Код товара: 4491</p> -->
                <p><span class="item-price-indicator">Цена: </span><span class="item_price"> 1776 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Проводная серия стильных мышей, благодаря своему низкопрофильному дизайну и абсолютно гладкой поверхности, дарит совершенно новые ощущения при работе на персональном компьютере. Первое благоприятное впечатление вы получаете от их эстетичного
                        внешнего вида и элегантного дизайна. Она удобно ложится в руку.</p>
                    <br>
                    <h3><b>Особенности:</b></h3>
                    <p><i class="fa fa-check"></i> Производитель: Delux</p>
                    <p><i class="fa fa-check"></i> Тип подключения: Проводной</p>
                    <p><i class="fa fa-check"></i> Максимальное разрешение, DPI: 1000</p>
                    <!-- <img src="../images/monitor/icon.png" style="float:none"> -->
                    <div><button id="fly" class="add_item" data-id="7854" data-title="<a href='https://softgroup.kz/Mysh'-Delux-DLM-391-OUB.php'>Мышь Delux, DLM-391 OUB</a>" data-price="1776" data-quantity="1" data-img="https://softgroup.kz/images/perif/fifth/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                    <div class="container">
                        ...
                        <p style="line-height:normal">Каучуковое колесо прокрутки обеспечивает точность и не допускает скольжения пальца. Оптический сенсор 1000 dpi обеспечивает четкость движения и высокую скорость перемещения курсора во время работы на широкоформатном мониторе. Данная
                            мышь - для всех кто предпочитает чувство стиля и лёгкость в работе.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
            </div>
...
$res=mysqli_query($db,"SELECT * FROM dlm
