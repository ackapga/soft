    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li>Сенсорный Моноблок 3021, черный</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/3021_black/1.jpg">
                                <div class="thumb-image"> <img src="../images/3021_black/1.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/3021_black/2.jpg">
                                <div class="thumb-image"> <img src="../images/3021_black/2.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/3021_black/3.jpg">
                                <div class="thumb-image"> <img src="../images/3021_black/3.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Сенсорный Моноблок 3021, черный</h1>
                <hr>
                <p class="code-products">Код товара: 4492</p>
                ...
                <div class="description">
                    ...
                    <img src="../images/monitor/icon3.png" style="float:none">
                    <div><button id="fly" class="add_item" data-id="13" data-title="<a href='https://softgroup.kz/pos_3021_black.php'>Сенсорный Моноблок 3021, черный</a>" data-price="138600" data-quantity="1" data-img="https://softgroup.kz/images/avatars/3021_black.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/3021_black/black_white_wm.png" style="width: 80% !important;">
                        </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:20px">
                    <div class="container">
                        ...
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/3021_black/inch15.png" style="text-align:center; margin-top:20px; width: 30%">
                        </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/3021_black/interface2.jpg" style="text-align:center; width: 60%;">
                        </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/3021_black/wifi.png" style="text-align:center; margin-top:20px; width: 20%;"></div>
