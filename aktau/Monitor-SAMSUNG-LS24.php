...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into monitors
   ...
   else $res=mysqli_query($db,"insert into monitors (date, theme_id, login, message, rating)
...
<head>
    ...
    <title>Монитор 24″ SAMSUNG LS24 || Мониторы от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Монитор, купить, SAMSUNG LS24, экран, Актау, астана, казахстан, цена, продажа." />
    <meta name="description" content="Вы собираетесь приобрести бытовую технику или электронику? Интернет-магазин SoftGroup Тараз с радостью поможет вам. Тел. 8 (727) 344 9900. Гарантия качественного обслуживания. Бесплатная доставка.">
    <!--//tags -->
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            <div class="services-breadcrumb">
                <div class="agile_inner_breadcrumb">
                    ...
                    <ul class="w3_short">
                        ...
                        <li><a href="Monitor-i-periferiya.html">Монитор и периферия</a><i>/</i></li>
                        <li>Монитор 21.5″ SAMSUNG LS24</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/perif/second/ava.png">
                                <div class="thumb-image"> <img src="../images/perif/second/ava.png" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/perif/second/2.png">
                                <div class="thumb-image"> <img src="../images/perif/second/2.png" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/perif/second/3.png">
                                <div class="thumb-image"> <img src="../images/perif/second/3.png" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Монитор 21.5″ SAMSUNG LS24</h1>
                <hr>
                <!-- <p class="code-products">Код товара: 9631</p> -->
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">69 200 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Новейший LED FULL HD монитор от Samsung с толщиной 10 мм. Есть режим снижающий усталость глаз и обеспечивающий комфортный просмотр. Горизонтальный узор на задней панели прекрасно завершает композицию, придавая устройству стильный современный
                        вид.
                    </p>
                    <br>
                    <p><i class="fa fa-check"></i> Тонкий и стильный современный дизайн</p>
                    <p><i class="fa fa-check"></i> Безупречно плавный игровой процесс</p>
                    <p><i class="fa fa-check"></i> Разрешение 1920х1080</p>
                    <div><button id="fly" class="add_item" data-id="9630" data-title="<a href='https://softgroup.kz/Monitor-SAMSUNG-LS22.php'>Монитор 21.5″ SAMSUNG LS24</a>" data-price="69200" data-quantity="1" data-img="https://softgroup.kz/images/perif/second/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <div class="bootstrap-tab-text-grids">
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                    <div class="container">
                        ...
                        <div style="text-align:center">
                            <img src="../images/perif/first/first.webp" style="width: 80% !important;">
                        </div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Чрезвычайно тонкий и стильный современный дизайн</p>
                        <p style="line-height:normal">• Сверхтонкая панель: Чрезвычайно тонкая, толщиной 10 мм, как шариковая ручка, цельная панель — более чем в два раза тоньше стандартного монитора Samsung <br> • Простая округлая стойка: Простая округлая стойка элегантно дополняет
                            сверхтонкий дисплей <br> • Задняя панель с узором: Горизонтальный узор на задней панели прекрасно завершает композицию, придавая устройству стильный современный вид</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:20px">
                    <div class="container">
                        ...
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/perif/first/second.webp" style="text-align:center; margin-top:20px; width: 80%">
                        </div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Оптимизирован для комфортного просмотра</p>
                        <p style="line-height:normal">• Режим, снижающий усталость глаз: Снижая интенсивность голубого свечения, которое стимулирует сетчатку больше, чем другие цвета, этот режим снижает усталость глаз и обеспечивает комфортный просмотр <br> • Технология, снижающая
                            мерцание экрана: Эта технология Samsung минимизирует мерцание экрана, что позволяет работать и играть дольше и с большим комфортом.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:20px">
                    <div class="container">
                        ...
                        <div style="text-align:center;">
                            <img src="../images/perif/first/third.png" style="text-align:center; width: 90%; margin-top: 40px;"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Сверхширокий угол обзора для идеального изображения под любым углом</p>
                        <p style="line-height:normal">• Сверхширокий угол обзора 178 градусов: Расширенные 178-градусные вертикальный и горизонтальный углы обзора обеспечивают четкую картинку, откуда бы вы не смотрели
                            <br> • Вы удобно устроились, откинувшись на спинку кресла, или собрались вокруг монитора с друзьями — широкий угол обзора означает, что каждый насладится идеальным изображением, находясь в любом положении</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/perif/first/fourth.webp" style="text-align:center; width: 90%;"></div>
                        <div class="wthree_text_info">
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Экологичная технология от Samsung сокращает потребление энергии</p>
                        </div>
                        <p style="line-height:normal">• При автоматической настройке экологичная технология Samsung плавно меняет яркость, исходя из интенсивности свечения темных оттенков экрана, для сокращения потребления энергии до 10%
                            <br> • Яркость экрана также можно изменить вручную на 25% и 50% от максимальной</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    ...
                    <tr>
                        <td>Уровень статичной контрастности:</td>
                        <td>1000:1 (ст.), 700:1 (мин.) </td>
                    </tr>
                    <tr>
                        <td>Разрешение:</td>
                        <td> 1920 x 1080 </td>
...
$res=mysqli_query($db,"SELECT * FROM monitors
