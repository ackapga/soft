...
<head>
    ...
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1000 M3, Актау, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1000 M3 инфракрасные купить в Актау по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="dors_1000.php">Актау</a></li>
