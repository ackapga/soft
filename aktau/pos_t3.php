...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into post3
   ...
   else $res=mysqli_query($db,"insert into post3 (date, theme_id, login, message, rating)
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-333 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides">
                            <li data-thumb="../images/monitor/3.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/3.jpg" id="target" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/33.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/33.jpg" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="../images/monitor/333.jpg">
                                <div class="thumb-image"> <img src="../images/monitor/333.jpg" class="img-responsive"> </div>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                <h1>Сенсорный моноблок с дисплеем клиента T3</h1>
                <hr>
                <p class="code-products">Код товара: 1013</p>
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">205 000 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    <p>Сенсорный моноблок с дисплеем клиента 15 дюймовой диагональю экрана, с высокой чувствительностью. Модная панель на спине является главным отличием и достоинством данного моноблока. Экранная панель имеет возможность показывать клиенту, что он заказывает.</p>
                    <br>
                    ...
                    <p><i class="fa fa-check"></i> Экранная панель на спине.</p>
                    <img src="../images/monitor/icon.png" style="float:none">
                    <div><button id="fly" class="add_item" data-id="10" data-title="<a href='https://softgroup.kz/pos_t3.php'>Сенсорный моноблок T3</a>" data-price="205000" data-quantity="1" data-img="https://softgroup.kz/images/monitor/3.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                </div>
            </div>
            <div class="clearfix"> </div>
        ...
        <div class="responsive_tabs_agileits">
            <div class="bootstrap-tab-text-grids">
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                    ...
                    <div class="container">
                        ...
                        <div style="text-align:center;">
                            <img src="../images/monitor/vfd4.png" style="text-align:center; "></div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:0px">
                            <img src="../images/monitor/d6.png" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Яркий цветной дисплей</p>
                        <p style="line-height:normal">Сенсорный экран моноблока имеет диагональ 15 дюйма, что предоставляет высочайший комфорт при работе с устройством и повышает удобство для сотрудников при работе с большим объемом данных. </p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/congif3.jpg" style="text-align:center; margin-top:20px"></div>
                        <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Набор интерфейсов</p>
                        <p style="line-height:normal">Все интерфейсные разъёмы расположены в нижней части устройства: разъём питания, СОМ порт для передачи данных, VGA порт для подключения мониторов, HDMI порт для подсоединения устройств с лучшим качеством изображения, высокой скоростью передачи данных, PS/2 порты для подключения клавиатуры и мыши, четыре разъёма USB порта (2 из них последняя версия стандарта USB 3.0), RJ порт для подключения локальной сети и два разъёма для передачи аудиосигнала.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/sensor6.jpg" style="text-align:center; "></div>
                        <div class="wthree_text_info">
                            <h2>Чувствительный сенсорный моноблок с дисплеем клиента</h2>
                        </div>
                ...
                <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8;   border-top: 1px solid #eee; padding-bottom:20px">
                    <div class="container">
                        <div style="text-align:center; margin-top:50px">
                            <img src="../images/monitor/naklon2.png" style="text-align:center; margin-top:20px"></div>
...
$res=mysqli_query($db,"SELECT * FROM post3
