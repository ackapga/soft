...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into DLD-1505OGB
   ...
   else $res=mysqli_query($db,"insert into DLD-1505OGB (date, theme_id, login, message, rating)
...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Комплект Клавиатура + Мышь, Delux, DLD-1505OGB || Комплект Клавиатура + Мышь от Softgroup </title>
        <!--/tags -->
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Комплект Клавиатура + Мышь, Delux, DLD-1505OGB </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/perif/eight/ava.png">
                                    <div class="thumb-image"> <img src="../images/perif/eight/ava.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/perif/eight/2.png">
                                    <div class="thumb-image"> <img src="../images/perif/eight/2.png" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/perif/eight/3.png">
                                    <div class="thumb-image"> <img src="../images/perif/eight/3.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Комплект Клавиатура + Мышь, Delux, DLD-1505OGB </h1>
                    <hr>
                    <!-- <p class="code-products">Код товара: 4491</p> -->
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price"> 5940 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Беспроводной комплект: включающий в себя ультратонкую клавиатуру и компактную мышь. Отличительной особенностью, данной серии комплектов является компактный USB наноресивер. Раскладка клавиатуры, разработанная специально для среднеазиатского
                            региона, имеет красивый и ровный шрифт, нанесена при помощи точного лазера и защищена от стирания УФ-покрытием.</p>
                        <br>
                        <h3><b>Особенности:</b></h3>
                        <p><i class="fa fa-check"></i> Бренд: Delux</p>
                        <p><i class="fa fa-check"></i> Раскладка: Анг/Рус/Каз</p>
                        <p><i class="fa fa-check"></i> Интерфейс подключения: Беспроводной</p>
                        <!-- <img src="../images/monitor/icon.png" style="float:none"> -->
                        <div><button id="fly" class="add_item" data-id="7539" data-title="<a href='https://softgroup.kz/Mysh'-Delux-DLM-516-OGB.php'>Комплект Клавиатура + Мышь, Delux, DLD-1505OGB  </a>" data-price="5940" data-quantity="1" data-img="https://softgroup.kz/images/perif/eight/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
            ...
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grids">
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/perif/fourth/img1.png" style="width: 60% ;">
                            </div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px; ">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/perif/eight/img1.png" style="width: 40%;">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Комплектация:</p>
                            <p style="line-height:normal"> Отличительной особенностью данной серии мышей является мини-приёмник, который по своим размерам не больше монеты. Это особенно удобно при использовании мыши с портативными компьютерами. Радиосигнал на частоте 2,4 Гц обеспечивает
                                высокую скорость передачи данных и эффективную помехоустойчивость в радиусе 10 метров.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                </div>
...
$res=mysqli_query($db,"SELECT * FROM DLD-1505OGB
