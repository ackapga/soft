        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Сенсорный Моноблок 1701, черный</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/1701/ava.png">
                                    <div class="thumb-image"> <img src="../images/1701/ava.png" id="target" class="img-responsive"> </div>
                                </li>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Сенсорный Моноблок 1701, черный</h1>
                    <hr>
                    <p class="code-products">Код товара: 5150</p>
                    ...
                    <div class="description">
                        <p>15-дюймовый сенсорный моноблок 1701 — это коммерческое решение для предприятий любого масштаба, работающих в сфере торговли, в ресторанном и гостиничном бизнесе. Служат долго и идеально справляются с задачами автоматизации обслуживания
                        ...
                        <div><button id="fly" class="add_item" data-id="5150" data-title="<a href='https://softgroup.kz/pos_1701.php'>Сенсорный Моноблок 1701, черный</a>" data-price="130000" data-quantity="1" data-img="https://softgroup.kz/images/1701/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
