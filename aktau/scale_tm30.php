...
<head>
    ...
    <title>Весы с печатью этикеток TM-30A купить в Актау от компании Softgroup</title>
    <!--/tags -->
    ...
    <meta name="description" content="Электронные весы с печатью этикеток купить в Актау. Огромный выбор электронных весов. Купить электронные весы с печатью в Актау.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        <ul>
                            <li><a href="scale_tm30.php">Актау</a></li>
