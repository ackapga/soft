...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dld15050gb
   ...
   else $res=mysqli_query($db,"insert into dld15050gb (date, theme_id, login, message, rating)
...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Клавиатура, Delux, DLD-1505OGB || Клавиатуры от Softgroup</title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="Клавиатура, купить, Delux,  DLD-1505OGB, экран, Актау, астана, казахстан, цена, продажа." />
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Клавиатура, Delux, DLD-1505OGB</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/perif/fourth/ava.png">
                                    <div class="thumb-image"> <img src="../images/perif/fourth/ava.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/perif/fourth/2.png">
                                    <div class="thumb-image"> <img src="../images/perif/fourth/2.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Клавиатура, Delux, DLD-1505OGB</h1>
                    <hr>
                    ...
                    <div class="description">
                        <p>Отличительной особенностью, данной серии комплектов является компактный USB наноресивер. Раскладка клавиатуры, разработанная специально для среднеазиатского региона, имеет красивый и ровный шрифт, нанесена при помощи точного лазера
                            и защищена от стирания УФ-покрытием. Выполнена в трёхцветной палитре.</p>
                        <br>
                        <h3><b>Особенности:</b></h3>
                        <p><i class="fa fa-check"></i> Тип: Клавиатура;</p>
                        <p><i class="fa fa-check"></i> Бренд: Delux;</p>
                        <p><i class="fa fa-check"></i> Партномер: DLD-1505OGB;</p>
                        <!-- <img src="../images/monitor/icon.png" style="float:none"> -->
                        <div><button id="fly" class="add_item" data-id="8521" data-title="<a href='https://softgroup.kz/Klaviatura-Delux-DLD-1505OGB.php'>Клавиатура, Delux, DLD-1505OGB</a>" data-price="5940" data-quantity="1" data-img="https://softgroup.kz/images/perif/fourth/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
...
$res=mysqli_query($db,"SELECT * FROM dld15050gb
