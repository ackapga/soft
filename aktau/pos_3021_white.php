        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Сенсорный Моноблок 3021, белый</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/3021_white/1.jpg">
                                    <div class="thumb-image"> <img src="../images/3021_white/1.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3021_white/2.jpg">
                                    <div class="thumb-image"> <img src="../images/3021_white/2.jpg" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3021_white/3.jpg">
                                    <div class="thumb-image"> <img src="../images/3021_white/3.jpg" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Сенсорный Моноблок 3021, белый</h1>
                    <hr>
                    <p class="code-products">Код товара: 4491</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">138 600 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>15-дюймовый сенсорный моноблок 3021 — это коммерческое решение для предприятий любого масштаба, работающих в сфере торговли, в ресторанном и гостиничном бизнесе. Служат долго и идеально справляются с задачами автоматизации обслуживания
                        ...
                        <div><button id="fly" class="add_item" data-id="11" data-title="<a href='https://softgroup.kz/pos_3021_white.php'>Сенсорный Моноблок 3021, белый</a>" data-price="138600" data-quantity="1" data-img="https://softgroup.kz/images/avatars/3021_white.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grids">
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/3021_white/black_white_wm.png" style="width: 80% !important;">
                            </div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:20px">
                        <div class="container">
                            ...
                            <div style="text-align:center; margin-top:0px">
                                <img src="../images/3021_white/inch15.png" style="text-align:center; margin-top:20px; width: 30%">
                            </div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:20px">
                        <div class="container">
                            ...
                            <div style="text-align:center;">
                                <img src="../images/3021_white/client.png" style="text-align:center; width: 30%;"></div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
                        <div class="container">
                            <div style="text-align:center; margin-top:50px">
                                <img src="../images/3021_white/screen-touch.png" style="text-align:center; width: 30%;"></div>
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Интерфейс:</td>
                            <td>6 USB <br> 1 SERIAL <br> 1 VGA <br> 1 LAN <br> 1 Audio <br> 1 Input <br> 1 Output</td>
                        </tr>
                        <tr>
