...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Резистивный моноблок с двойным экраном. Цены на сенсорные моноблоки для торговли</title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="Резистивный моноблок с дисплеем, для клиента, клиента, двойной экран, Актау, астана, казахстан, купить, цена, продажа." />
        <meta name="description" content="Купить Резистивный моноблок с дисплеем покупателя по выгодной цене от компании Softgroup. Широкий ассортимент сенсорных моноблоков для автоматизации">
        <!--//tags -->
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Резистивный Моноблок R 10 PRO </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/r10/pro.png">
                                    <div class="thumb-image"> <img src="../images/r10/pro.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/r10/2.png">
                                    <div class="thumb-image"> <img src="../images/r10/2.png" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/r10/3.png">
                                    <div class="thumb-image"> <img src="../images/r10/3.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Резистивный Моноблок R 10 PRO</h1>
                    <hr>
                    <p class="code-products">Код товара: 5159</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">148 450 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>15-дюймовый Резистивный моноблок R 10 PRO — это коммерческое решение для предприятий любого масштаба, работающих в сфере торговли, в ресторанном и гостиничном бизнесе. Служат долго и идеально справляются с задачами автоматизации
                            обслуживания клиентов. Поддерживает все виды периферийных устройств. Имеет конструкцию без вентилятора, что обеспечивает низкий уровень шума.</p>
                        <br>
                        <h3><b>Резистивный моноблок с дисплеем клиента состоит из:</b></h3>
                        <p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800б, 2,41 Ггц;</p>
                        <p><i class="fa fa-check"></i> Резистивный экран кассира с 15 дюймовой диагональю экрана;</p>
                        <p><i class="fa fa-check"></i> Дисплей клиента: 1 строка, 8 символов.</p>
                        <img src="../images/monitor/icon.png" style="float:none">
                        <div><button id="fly" class="add_item" data-id="5159" data-title="<a href='https://softgroup.kz/pos_r10_pro.php'>Резистивный Моноблок R 10 PRO</a>" data-price="148450" data-quantity="1" data-img="https://softgroup.kz/images/r10/avaa.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grids">
                    ...
                    <div class="bootstrap-tab-text-grid" style="padding-bottom:20px; background-color: #e5f6f8;">
                        <div class="container">
                            ...
                            <p style="line-height:normal">Резистивный экран моноблока имеет диагональ 17 дюйма, что предоставляет высочайший комфорт при работе с устройством и повышает удобство для сотрудников при работе с большим объемом данных. </p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="padding-bottom:20px;background-color: #e5f6f8;">
                        <div class="container">
                            ...
                            <div class="wthree_text_info">
                                <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Чувствительный Резистивный моноблок с дисплеем клиента</p>
                            </div>
                            <p style="line-height:normal">Резистивный экран с высокой чувствительностью имеет высокую скорость отклика и мгновенно отреагирует на ваше нажатие. Резистивный экран позволяет сократить время обслуживания клиента: оператору на кассе не нужно делать лишних движений
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff;   border-top: 1px solid #eee; padding-bottom:20px">
                        <div class="container">
                            ...
                            <p style="line-height:normal">Все интерфейсные разъёмы расположены под монитором: разъём питания, 1 SERIAL/СОМ Port и 1 VGA Port для подключения мониторов, PS/2 порты для подключения клавиатуры и мыши, четыре разъёма USB порта (2 из них последняя версия
                                стандарта USB 3.0), RJ порт для подключения локальной сети и два разъёма для передачи аудиосигнала.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        <tr>
                            ...
                            <td>Дисплей:</td>
                            <td>15-дюймовый Резистивный экран</td>
                        </tr>
                        <tr>
