        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                ...
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/avatars/3068.jpg">
                                    <div class="thumb-image"> <img src="../images/avatars/3068.jpg" id="target" class="img-responsive"> </div>
                                </li>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Сенсорный Моноблок 3068</h1>
                    <hr>
                    <p class="code-products">Код товара: 4495</p>
                    ...
                    <div class="description">
                        <p>Сенсорный моноблок 3068 отличается от других моноблоков с размером дисплея. Диогональ экрана состовляет 17 дюймов. Модель имеет жесткий диск типа SSD 32 ГБ. Идеально подойдет для автоматизации любой торговли: супермаркетов, магазинов,
                            кафе или же аптек.</p>
                        <br>
                        ...
                        <div><button id="fly" class="add_item" data-id="15" data-title="<a href='https://softgroup.kz/pos_3068.php'>Сенсорный моноблок 3068</a>" data-price="163800" data-quantity="1" data-img="https://softgroup.kz/images/avatars/3068.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
					...
					<div class="bootstrap-tab-text-grid" style="padding-bottom:20px">
						<div class="container">
							...
							<div style="text-align:center; margin-top:0px">
								<img src="../images/3068/inch17.jpg" style="text-align:center; margin-top:20px; width: 25%">
							</div>
