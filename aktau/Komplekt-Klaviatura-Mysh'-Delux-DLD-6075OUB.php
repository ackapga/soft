...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into dld6075oub
   ...
   else $res=mysqli_query($db,"insert into dld6075oub (date, theme_id, login, message, rating)
...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        <title>Комплект Клавиатура + Мышь, Delux, DLD-6075OUB || Комплект Клавиатура + Мышь от Softgroup </title>
        <!--/tags -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="Комплект Клавиатура + Мышь, Delux, DLD-6075OUB, клавиатура, Актау, астана, казахстан, цена, продажа." />
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Комплект Клавиатура + Мышь, Delux, DLD-6075OUB </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/perif/seven/ava.png">
                                    <div class="thumb-image"> <img src="../images/perif/seven/ava.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/perif/seven/2.png">
                                    <div class="thumb-image"> <img src="../images/perif/seven/2.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Комплект Клавиатура + Мышь, Delux, DLD-6075OUB </h1>
                    <hr>
                    <!-- <p class="code-products">Код товара: 4491</p> -->
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price"> 4296 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Проводной комплект: включающий в себя ультратонкую клавиатуру и компактную мышь. Раскладка клавиатуры, разработанная специально для среднеазиатского региона, имеет красивый и ровный шрифт, нанесена при помощи точного лазера и защищена
                            от стирания УФ-покрытием.</p>
                        <br>
                        <h3><b>Особенности:</b></h3>
                        <p><i class="fa fa-check"></i> Раскладка: Анг/Рус/Каз</p>
                        <p><i class="fa fa-check"></i> Цвет: Чёрный</p>
                        <p><i class="fa fa-check"></i> Состав: Пластик</p>
                        <!-- <img src="../images/monitor/icon.png" style="float:none"> -->
                        <div><button id="fly" class="add_item" data-id="8439" data-title="<a href='https://softgroup.kz/Komplekt-Klaviatura-Mysh'-Delux-DLD-6075OUB.php'>Комплект Клавиатура + Мышь, Delux, DLD-6075OUB  </a>" data-price="4296" data-quantity="1"
                                data-img="https://softgroup.kz/images/perif/seven/ava.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
            ...
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grids">
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px; ">
                        <div class="container">
                            ...
                            <div style="text-align:center">
                                <img src="../images/perif/third/img1.png" style="width: 60% ;">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Современный дизайн</p>
                            <p style="line-height:normal">Выполнена в трёхцветной палитре. Английская раскладка белого цвета, русская - розового, казахская - синего. Современный дизайн клавиатуры с классической формой клавиш идеально подходит для повседневной работы за компьютером.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px; ">
                        <div class="container">
                            <div style="text-align:center">
                                <img src="../images/perif/fifth/img1.png" style="width: 40%;">
                            </div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Комплектация:</p>
                            <p style="line-height:normal">Каучуковое колесо прокрутки обеспечивает точность и не допускает скольжения пальца. Оптический сенсор 1000 dpi обеспечивает четкость движения и высокую скорость перемещения курсора во время работы на широкоформатном мониторе.
                                Данная мышь - для всех кто предпочитает чувство стиля и лёгкость в работе.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="zui-table zui-table-zebra zui-table-horizontal">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>104 стандартных</td>
                        </tr>
                        <tr>
                            <td>Количество нажатий на клавишу:</td>
                            <td>10 миллионов</td>
                        </tr>
                        <tr>
                            <td>Оптическое разрешение сенсора мыши:</td>
                            <td>1000 dpi</td>
                        </tr>
                    </tbody>
                </table>
...
$res=mysqli_query($db,"SELECT * FROM dld6075oub
