...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into pos3068
   ...
   else $res=mysqli_query($db,"insert into pos3068 (date, theme_id, login, message, rating)
...
<head>
    <script src='https://www.google.com/recaptcha/api.js'></script>
        ...
        <meta name="keywords" content="сенсорный моноблок с дисплеем, для клиента, клиента, двойной экран, Актау, астана, казахстан, купить, цена, продажа." />
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Сенсорный Моноблок 3068 PRO</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/avatars/3068_pro1.jpg">
                                    <div class="thumb-image"> <img src="../images/avatars/3068_pro1.jpg" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3068/2.jpg">
                                    <div class="thumb-image"> <img src="../images/3068/2.jpg" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/3068/3.jpg">
                                    <div class="thumb-image"> <img src="../images/3068/3.jpg" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Сенсорный Моноблок 3068 PRO</h1>
                    <hr>
                    <p class="code-products">Код товара: 4496</p>
                    <p><span class="item-price-indicator">Цена: </span><span class="item_price">176 400 тг. </span></p>
                    <div class="rating1">
                    ...
                    <div class="description">
                        <p>Сенсорный моноблок 3068 PRO отличается от других моноблоков с размером дисплея. Диогональ экрана состовляет 17 дюймов. Модель имеет жесткий диск типа SSD 64 ГБ. Идеально подойдет для автоматизации любой торговли: супермаркетов,
                            магазинов, кафе или же аптек.</p>
                        <br>
                        <h3><b>В состав моноблока входит:</b></h3>
                        <p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800.</p>
                        <p><i class="fa fa-check"></i> Сенсорный экран кассира с диагональю 17 дюймов.</p>
                        <p><i class="fa fa-check"></i> Дисплей клиента: 2 строки, 40 символов.</p>
                        <img src="../images/monitor/icon.png" style="float:none">
                        <div><button id="fly" class="add_item" data-id="16" data-title="<a href='https://softgroup.kz/pos_3068_pro.php'>Сенсорный моноблок 3068 PRO</a>" data-price="176400" data-quantity="1" data-img="https://softgroup.kz/images/avatars/3068_pro.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
                ...
                <div class="bootstrap-tab-text-grids">
					...
					<div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                        ...
                        <div class="container">
                            ...
                            <div style="text-align:center;">
                                <img src="../images/3068/inch17.jpg" style="text-align:center; width: 20%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Экран кассира</p>
                            <p style="line-height:normal">Сенсорный экран моноблока имеет диагональ 17 дюйма, что предоставляет высочайший комфорт при работе с устройством и повышает удобство для сотрудников при работе с большим объемом данных. Цвет данного моноблока черный.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    ...
                    <div class="bootstrap-tab-text-grid" style="background-color: #e5f6f8; padding-bottom:40px">
                        <div class="container">
                            ...
                            <div style="text-align:center;">
                                <img src="../images/3021_black/interface2.jpg" style="text-align:center; width: 60%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Набор интерфейсов</p>
                            <p style="line-height:normal">Все интерфейсные разъёмы расположены под монитором: разъём питания, VGA порт для подключения мониторов, СОМ порт для передачи данных, четыре разъёма USB порта (2 из них последняя версия стандарта USB 3.0), RJ порт для подключения
                                локальной сети и два разъёма для передачи аудиосигнала.</p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="bootstrap-tab-text-grid" style="background-color: #fff; padding-bottom:40px">
                        <div class="container">
                            ...
                            <div style="text-align:center;">
                                <img src="../images/3068/client_view.jpg" style="text-align:center; width: 60%;"></div>
                            <p class="wthree_text_info" style=" color:#ff9601; text-transform:none; margin:40px 0 10px 0">Дисплей клиента</p>
                            <p style="line-height:normal">Дисплей покупателя предназначен для отображения информации о приобретенных товарах, их стоимости и количестве. Транслирует общую сумму покупки, размер скидки, количество бонусных баллов.
                            </p>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
            ...
            <table class="zui-table zui-table-zebra zui-table-horizontal">
                <tbody>
                    <tr>
                        ...
                        <td>Дисплей:</td>
                        <td>17-дюймовый сенсорный экран</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Интерфейс:</td>
                        <td>6 USB <br> HDMI port <br> 1 LAN port<br>1 Serial port<br>1 VGA port<br> 1 Audio Input / 1 Output</td>
                    </tr>
                    <tr>

                        <td>Дисплей клиента:</td>
                        <td>VFD с 2 линиями, 40 цифр</td>
                    </tr>
...
$res=mysqli_query($db,"SELECT * FROM pos3068
