        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container">
                <div class="services-breadcrumb">
                    <div class="agile_inner_breadcrumb">
                        ...
                        <ul class="w3_short">
                            ...
                            <li>Сенсорный Моноблок 1702 PRO</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-333 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="../images/1702/pro.png">
                                    <div class="thumb-image"> <img src="../images/1702/pro.png" id="target" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/1702/2.png">
                                    <div class="thumb-image"> <img src="../images/1702/2.png" class="img-responsive"> </div>
                                </li>
                                <li data-thumb="../images/1702/3.png">
                                    <div class="thumb-image"> <img src="../images/1702/3.png" class="img-responsive"> </div>
                                </li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h1>Сенсорный Моноблок 1702</h1>
                    <hr>
                    <p class="code-products">Код товара: 5147</p>
                    ...
                    <div class="description">
                        <p>15-дюймовый сенсорный моноблок 1702 — это коммерческое решение для предприятий любого масштаба, работающих в сфере торговли, в ресторанном и гостиничном бизнесе. Служат долго и идеально справляются с задачами автоматизации обслуживания
                        ...
                        <div><button id="fly" class="add_item" data-id="5147" data-title="<a href='https://softgroup.kz/pos_1702_pro.php'>Сенсорный Моноблок 1702</a>" data-price="156090" data-quantity="1" data-img="https://softgroup.kz/images/1702/pro.png"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
                    </div>
                </div>
                <div class="clearfix"> </div>
            ...
            <div class="responsive_tabs_agileits">
                <div class="bootstrap-tab-text-grids">
                    ...
                    <div class="container">
                        ...
                        <p style="line-height:normal">Корпус сенсорного моноблока доступен в двух цветах на выбор: <b>черный .</b> Моноблок в корпусе белого цвета дополнит рабочий стол. Классический черный цвет корпуса отлично впишется в любую обстановку.</p>
                        <div class="clearfix"> </div>
                    </div>
                </div> -->
