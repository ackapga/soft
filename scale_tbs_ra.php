...
<head>
    ...
    <title>Весы товарные ТВ-S_RA с регистрацией товароучетных операций купить в Алматы</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="масса к, электронные, ТВ-S_RA, с регистрацией товароучетных операций, товарные, алматы, купить, цена, продажа." />
    <meta name="description" content="Весы с регистрацией товароучетных операций купить в Алматы. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Алматы.">
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="col-md-8 single-right-left simpleCart_shelfItem">
                ...
                <p><span class="item-price-indicator">Цена: </span><span class="item_price">137 500 тг. </span></p>
                <div class="rating1">
                ...
                <div class="description">
                    ...
                    <button id="fly" class="add_item" data-id="5017"
                            data-title="<a href='https://softgroup.kz/scale_tbs_ra.php'>Весы товарные ТВ-S_RA с регистрацией товароучетных операций</a>"
                            data-price="137500" data-quantity="1" data-img="https://softgroup.kz/images/scale/91.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
