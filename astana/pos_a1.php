...
<title>Сенсорный экран с алюминиевым корпусом для кассы в Астана</title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="SoftGroup, сенсорный экран для кассы, Астана, астана, казахстан, купить, цена, продажа." />
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
	     ...
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/monitor/p5.jpg">
							<div class="thumb-image"> <img src="../images/monitor/p5.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/monitor/5.jpg">
							<div class="thumb-image"> <img src="../images/monitor/5.jpg"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/monitor/55.jpg">
							<div class="thumb-image"> <img src="../images/monitor/55.jpg"  class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Сенсорный экран A1</h3>
					<hr>
					<p class="code-products">Код товара: 1006</p>
					<p><span class="item_price">233 728  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p><b>Сенсорный экран</b> повышенной прочности отличается долговечностью, простотой очистки. Алюминиевый корпус оснащен антикоррозионным покрытием, что обеспечивает защиту от пыли, придает продукту современный дизайн.</p>
					<br>
					...
					<div> <button id ="fly" class="add_item" data-id="8" data-title="<a href='pos_a1.php'>Сенсорный моноблок A1</a>"  data-price="233728" data-quantity="1" data-img="../images/monitor/p5.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
		      </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
							...
							<div class="single_page_agile_its_w3ls">
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
											...
											<img src="../images/monitor/555.jpg">
