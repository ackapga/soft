...
<head>
    ...
    <title>Напольные весы ТВ-S_АB(RUEW)1 купить по доступным ценам в Астана от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы напольные, масса к, электронные, ТВ-S_АB(RUEW)1, товарные, Астана, купить, цена, продажа." />
    <meta name="description" content="Напольные весы ТВ-S_АB(RUEW)1 купить в Астана. Огромный выбор электронных весов для товаров. Купить высококачественные весы Масса-К в Астана.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="scale_tbs_ab.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/scale_tbs_ab.php">Тараз</a></li>
