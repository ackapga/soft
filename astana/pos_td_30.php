...
<title>Pos система розничной торговли в Астана</title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="SoftGroup, пос система, pos система, для розничной торговли, Астана, астана, казахстан, купить, цена, продажа." />
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
	     ...
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/monitor/10.jpg">
							<div class="thumb-image"> <img src="../images/monitor/10.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/monitor/102.png">
							<div class="thumb-image"> <img src="../images/monitor/102.png"  class="img-responsive"> </div>
						</li>	
						<li data-thumb="../images/monitor/101.jpg">
							<div class="thumb-image"> <img src="../images/monitor/101.jpg"  class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Pos-система TD-30</h3>
					<hr>
					<p class="code-products">Код товара: 1003</p>
					<p><span class="item_price">246 750  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p>  POS-решение представляет собой универсальное решение, в состав которого входит принтер чека 58 мм, моноблок 12-дюймовым экраном, pos клавиатура, дисплей покупателя. Pos-система имеет все необходимые настройки для подключения любой POS-периферии.</p>
					<br>
					...
					<p><i class="fa fa-check"></i> Принтер чека 80 мм с авторезом</p>
					<p><i class="fa fa-check"></i> Клавиатура KB-105F</p>
					<p><i class="fa fa-check"></i> Дисплей покупателя с 2 линиями, 40 символов</p>
					 <button id ="fly" class="add_item" data-id="5" data-title="<a href='pos_td_30.php'>Pos-система TD-30</a>"  data-price="246750" data-quantity="1" data-img="../images/monitor/10.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
		      </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
							...
							<div class="single_page_agile_its_w3ls">
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
											...
											<img src="../images/monitor/103.jpg">
