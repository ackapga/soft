...
<head>
    ...
    <title>Кассовый компьютер купить в Астана | Кассовый моноблок для автоматизации</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="кассовый компьютер, кассовый моноблок, Астана, для автоматизации, купить, цена, продажа." />
    <meta name="description" content="Кассовый компьютер купить в Астана — моноблок (с сенсорным или обычным экраном) со встроенным дисплеем для автоматизации от компании Softgroup">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="pos_t6.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/pos_t6.php">Тараз</a></li>
