...
<head>
    ...
    <title>Самоклеющиеся радиочастотные защитные этикетки купить в Астана | Антикражные системы </title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Радиочастотная этикетка? рулон, для магазина, купить, Астана, цена, продажа." />
    <meta name="description" content="Купить Радиочастотная  этикетка рулон в Астана по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем от SoftGroup.">
    <!--//tags -->
...
<!-- End Google Tag Manager (noscript) -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="radio_label.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/radio_label.php">Тараз</a></li>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Радиочастотная  этикетка в Астана</h1>
            <!--//w3_short-->
        </div>
    </div>
