...
<head>
    ...
    <title>Pos-система для кассы магазина купить в Астана | POS терминалы - Широкий выбор</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="Pos-система для магазина, pos терминалы, для магазина, для кассы, Астана, купить, цена, продажа." />
    <meta name="description" content="POS системы и POS терминалы для магазина купить в Астана по выгодным ценам от Softgroup. Широкий выбор продукции Pos систем для супермаркетов">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="pos_376.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/pos_376.php">Тараз</a></li>
