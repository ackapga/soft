...
<head>
    ...
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 1000 M3, Астана, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 1000 M3 инфракрасные купить в Астана по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="dors_1000.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/dors_1000.php">Тараз</a></li>
