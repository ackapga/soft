...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into pos3071
   ...
   else $res=mysqli_query($db,"insert into pos3071 (date, theme_id, login, message, rating)
...
<title>Pos система для кассы и автоматизации торговли</title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="SoftGroup, Pos система для кассы, автоматизации торговли Астана, астана, казахстан, купить, цена, продажа." />
<!--//tags -->
...
<div class="ban-top">
	<div class="container">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" active menu__item menu__item--current"><a class="menu__link" href="../products.html">Оборудование<span class="sr-only">(current)</span></a></li>
					 ...
					 <li class=" menu__item"><a class="menu__link" href="../uslugi.html">Программы</a></li><li class=" menu__item"><a class="menu__link" href="../reviews.php">Отзывы</a></li>
		...
		<div class="top_nav_right">
			<span id="open" class="glyphicon glyphicon-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge"><div class="label-place"></div></span></span>
		</div>
		<div class="clearfix"></div>
	</div>
</div>
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
	     ...
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/monitor/p1.jpg">
							<div class="thumb-image"> <img src="../images/monitor/p1.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/monitor/1.jpg">
							<div class="thumb-image"> <img src="../images/monitor/1.jpg"  class="img-responsive"> </div>
						</li>	
						<li data-thumb="../images/monitor/2.jpg">
							<div class="thumb-image"> <img src="../images/monitor/2.jpg"  class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Pos-система 3071</h3>
					<hr>
					<p class="code-products">Код товара: 1001</p>
					<p><span class="item_price">211 072  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p><b>Pos-система</b> 3071 предназначена для автоматизации супермаркетов, магазинов и других типов торговли. Она отличается тем что, имеет все необходимые оборудования для кассы: монитор, принтер чеков, денежный ящик, а также дисплей покупателя.</p>
					<br>
					<h4><b>В состав Pos системы входит следующие комплектующие:</b></h4>
					...
					<p><i class="fa fa-check"></i> Дисплей покупателя с 2 линиями, 40 символов</p>
					<p><i class="fa fa-check"></i> Денежный ящик с функцией блокировки, 5 отделениями для купюр и 4 для монет </p>
		     <button id ="fly" class="add_item" data-id="2" data-title="<a href='pos_3071.php'>Pos-система 3071</a>"  data-price="211072" data-quantity="1" data-img="../images/monitor/p1.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button>
			 </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
    ...
    <tbody>
		...
		<tr>
            <td>Интерфейс:</td>
            <td>6 USB <br>1 PS/2 клавиатура <br>1 PS/2 мышь <br> 1 LAN port<br>1 Serial port<br>1 VGA port<br>1 Parallel port<br> 1 Audio Input / 1 Output</td>
        </tr>
		<tr>
            <td>Дисплей клиента:</td>
            <td>VFD с 2 линиями, 40 символов</td>
        </tr>
		<tr>
            <td>Принтер чека:</td>
		...
		<tr>
            <td>Денежный ящик:</td>
            <td>5 отделения для купюр, 4 для монет с функцией блокировки</td>
        </tr>
		<tr>
...
$res=mysqli_query($db,"SELECT * FROM pos3071
			...
			<div class="ll"><h3 class="wthree_text_info">Похожие <span>товары</span></h3></div>
					  <div class="col-md-3 product-men single">
								<div class="men-pro-item">
									<a href="pos_t1.php"><div class="men-thumb-item">
										<img src="../images/p5.png" alt="" class="pro-image-front">
										<img src="../images/p5.png" alt="" class="pro-image-back">
									</div></a>
									<div class="item-info-product ">
										<h4><a href="pos_t1.php">Сенсорный Терминал Т1</a></h4>			
									</div>
								</div>
							</div>
                       <div class="col-md-3 product-men single">
					   ...
					   <div class="col-md-3 product-men single">
								<div class="men-pro-item">
									<a href="pos_t6.php"><div class="men-thumb-item"><img src="../images/p2.png" alt="" class="pro-image-front">
