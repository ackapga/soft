...
<head>
    ...
    <title>Весы с принтером этикеток ТВ-M_RP купить в Астана от компании Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="весы с принтером этикеток, масса к, электронные, ТВ-M_RP, Астана, купить, цена, продажа." />
    <meta name="description" content="Электронные весы с принтером этикеток купить в Астана. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Астана.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="scale_tb_m.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/scale_tb_m.php">Тараз</a></li>
