...
<head>
    ...
    <title>Антикражные системы в Астана | Антикражные ворота радиочастотные купить</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="антикражные системы, антикражные ворота, радиочастотные, для магазина, купить, Астана, цена, продажа." />
    <meta name="description" content="Купить антикражные ворота для магазина в Астана по низким ценам. У нас имеется широкий ассортимент высококачественных антикражных систем.">
    <!--//tags -->
...
<!-- End Google Tag Manager (noscript) -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="radio_frequency.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/radio_frequency.php">Тараз</a></li>
    ...
    <div class="page-head_agile_info_w3l">
        <div class="container">
            ...
            <!--/w3_short-->
  <h1>Антикражные системы в Астана</h1>
            <!--//w3_short-->
        </div>
    </div>
