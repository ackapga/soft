...
<head>
    ...
    <title>Весы товарные ТВ-S_RA с регистрацией товароучетных операций купить в Астана</title>
    <!--/tags -->
    ...
    <meta name="description" content="Весы с регистрацией товароучетных операций купить в Астана. Огромный выбор электронных весов. Купить высококачественные весы Масса-К в Астана.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="scale_tbs_ra.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/scale_tbs_ra.php">Тараз</a></li>
