...
<head>
    ...
    <title>Весы MK_ТН11 купить в Астана | Товарные напольные весы</title>
    <!--/tags -->
    ...
    <meta name="description" content="Весы MK_ТН11 купить в Астана. Огромный выбор электронных весов. Купить высококачественные товарные весы Масса-К в Астана.">
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="scale_th_11.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/scale_th_11.php">Тараз</a></li>
