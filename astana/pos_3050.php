...
if ($respponse->success){    //отправлен комментарий
    ...
    $res=mysqli_query($db,"insert into pos3050
   ...
   else $res=mysqli_query($db,"insert into pos3050 (date, theme_id, login, message, rating)
...
<title>Pos моноблок высокого качества водонепроницаемый в Астана. </title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Pos моноблок, водонепроницаемый, Астана, астана, казахстан, купить, цена, продажа." />
...
<div class="banner-bootom-w3-agileits">
	...
	<div class="services-breadcrumb">
						<div class="agile_inner_breadcrumb">
						   ...
						   <ul class="w3_short">
								...
								<li>Водонепроницаемый Pos моноблок 3050</li>
							</ul>
						 </div>
				</div>
	     <div class="col-md-333 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="../images/monitor/7.jpg">
							<div class="thumb-image"> <img src="../images/monitor/7.jpg"  id ="target"  class="img-responsive"> </div>
						</li>
						<li data-thumb="../images/monitor/77.jpg">
							<div class="thumb-image"> <img src="../images/monitor/77.jpg"  class="img-responsive"> </div>
						</li>	
						<li data-thumb="../images/monitor/777.gif">
							<div class="thumb-image"> <img src="../images/monitor/777.gif"  class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>Водонепроницаемый Pos моноблок 3050</h3>
					<hr>
					<p class="code-products">Код товара: 1008</p>
					<p><span class="item_price">189 400  тг. </span></p>
					<div class="rating1">
					...
					<div class="description">
						<p>Водонепроницаемый <b>Pos моноблок</b> 3050 с регулируемым экраном отлично подойдет для кассы. Pos моноблок с современными техническими характеристиками, совместим с любыми программными обеспечениями для автоматизации.</p>
					<br>
					<h4><b>В состав Pos моноблока входит следующие комплектующие:</b></h4>
					<p><i class="fa fa-check"></i> POS компьютер процессором Intel Celeron J1800</p>
					<p><i class="fa fa-check"></i> Монитор кассира с 15-дюймовым сенсорным экраном</p>
					<img src="../images/monitor/icon2.png">
					 <div><button id ="fly" class="add_item" data-id="6" data-title="<a href='pos_3050.php'>Водонепроницаемый сенсорный моноблок 3050</a>"  data-price="189400" data-quantity="1" data-img="../images/monitor/7.jpg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> В корзину</button></div>
		      </div></div>
	 			<div class="clearfix"> </div>
				<!-- /new_arrivals --> 
    ...
    <tbody>
		...
		<tr>
            ...
            <td>Интерфейс:</td>
            <td>6 USB <br>1 PS/2 клавиатура <br>1 PS/2 мышь <br> 1 LAN port<br>2 Serial ports<br>1 VGA port<br>1 Parallel port</td>
        </tr>
    </tbody>
</table></div>
						</div>
							...
							<div class="single_page_agile_its_w3ls">
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
											...
											<img src="../images/monitor/777.jpg">
...
$res=mysqli_query($db,"SELECT * FROM pos3050
