...
<head>
    ...
    <title>Pos системы в Астана | Цены на POS системы для автоматизации - Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="pos система, для автоматизации, Астана, купить, цена, продажа." />
    <meta name="description" content="Предлагаем вам купить POS систему со сканером и принтером чеков в Астана по низким ценам. POS системы в широком ассортименте от Softgroup.">
    <!--//tags -->
            ...
            <div class="fond">
                ...
                <div id="box_2" class="mymagicoverbox_fenetre">
                    <div class="mymagicoverbox_fenetreinterieur">
                        ...
                        <ul class="dlya_left">
                            <li><a href="pos_td_35.php">Астана</a></li>
                            ...
                            <li><a href="../taraz/taraz/pos_td_35.php">Тараз</a></li>
