...
function updateMetaTags($file, $location, $originalFile)
{
    ...
    switch ($location) {
        case 'astana':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Астана</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'shymkent':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Шымкент</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'aktau':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Актау</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'aktobe':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Актобе</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'atyrau':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Атырау</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'janaozen':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Жанаозен</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'jezkazgan':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Жезказган</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'karaganda':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Караганда</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'kokshetau':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Кокшетау</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'kostanai':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Костанай</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'kyzylorda':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Кызылорда</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'pavlodar':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Павлодар</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'petropavlovsk':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Петропавловск</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);

            $content = str_replace(
                '<p>Петропавловск:</p><span>',
                '<p>Алматы:</p><span>',
                $content);
            break;
        case 'semei':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Семей</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'taldykorgan':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Талдыкорган</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);

            $content = str_replace(
                '<p>Талдыкорган:</p><span>',
                '<p>Алматы:</p><span>',
                $content);
            break;
        case 'taraz':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Тараз</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'turkestan':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Туркестан</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'uralsk':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Уральск</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);
        ...
        case 'ust-kamenogorsk':
            ...
            $content = str_replace(
                '<li><a href="../' . $originalFile . '">Усть-Каменогорск</a></li>',
                '<li><a href="../' . $originalFile . '">Алматы</a></li>',
                $content);

            $content = str_replace(
                '<p>Усть-Каменогорск:</p><span>',
                '<p>Алматы:</p><span>',
                $content);
            break;
    }
