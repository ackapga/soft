...
<head>
    ...
    <title>Детектор банкнот автоматический Dors 230 купить в Алматы от Softgroup</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="детекторы банкнот, инфракрасные, dors, 230, алматы, астана, казахстан, купить, цена, продажа." />
    <meta name="description" content="Детекторы банкнот Dors 230 автоматические купить в Алматы по доступным ценам. Огромный выбор высококачественных детекторов банкнот.">
